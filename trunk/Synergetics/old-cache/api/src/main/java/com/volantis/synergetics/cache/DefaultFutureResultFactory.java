...
/**
 * Default implementation of the FutureResultFactory. This returns a
 * DataAccessor entity that returns null. This maintains deprecated the
 * behaviour of the old cache (lock, get, put, unlock).
 *
...
public class DefaultFutureResultFactory extends FutureResultFactory {
    ...
    /**
     * Return a new NullFutureResultObject.
     *
     * @param key        this pararmeter is ignored.
     * @param timeToLive used to set the timeout on the NullFutureResult (which
     *                   has no visible effect).
     * @return a new NullFutureResultObject.
     */
    protected ReadThroughFutureResult
        createCustomFutureResult(Object key, int timeToLive) {
        return new NullFutureResult(key, timeToLive);
    }
}
