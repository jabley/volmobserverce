...
/**
 * This is the NoOp implementation of a {@link MonitoringFactory}.
 */

public class NoOpMonitoringFactoryImpl implements MonitoringFactory {
    ...
    private static MonitoringFactory instance =
        new NoOpMonitoringFactoryImpl();


    // Protect our constructor.
    private NoOpMonitoringFactoryImpl() {
    }

    /**
     * Get the single instance of this factory.
     *
     * @return The instance of {@link NoOpMonitoringFactoryImpl}.
     */
    ...
    public MonitoredApplication createApplication(String appName) {
        return new NoOpMonitoredApplicationImpl(appName);
    }
    ...
    public MonitoredTransaction createTransaction(
        ...
        return new NoOpMonitoredTransactionImpl();
    }
