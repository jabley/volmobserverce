...
class MSSQLJSQLVendorFactory
        extends AbstractVendorFactory {

    public MSSQLJSQLVendorFactory() {
        super(JDBCRepositoryType.MSSQL_JSQL);
    }
    ...
    public String getDriverSpecificURL(MCSDriverConfiguration configuration)
        ...
        url = "jdbc:" + JDBCRepositoryType.MSSQL_JSQL.getSubProtocol()
                + "://" + host + ":" + port + "/database=" + source;
