...
public interface VendorFactory {
    ...
    InternalJDBCRepository createRepository(
            InternalJDBCRepositoryConfiguration configuration);

    DataSource createDriverDataSource(MCSDriverConfiguration configuration)
            throws RepositoryException;

    String getDriverSpecificURL(MCSDriverConfiguration configuration)
            throws RepositoryException;
}
