...
public class XMLRepositoryImpl
    extends AbstractRepository implements LocalXMLRepository {
    ...
    protected RepositoryConnection openConnection()
        ...
        return new XMLRepositoryConnectionImpl(this);
    }
    ...
    // --------------------------------------------------------------------------
    // XMLRepository specific methods
    // --------------------------------------------------------------------------
     ...
     *
     * @param dir
     * @throws com.volantis.mcs.repository.RepositoryException if one or more file or directory cannot be
     *                             deleted
     */
...
/*
 ...
 12-Jan-04	2304/8	tony	VBM:2003121708 fixed several accessor bugs and integrated migrate/accessor translations
