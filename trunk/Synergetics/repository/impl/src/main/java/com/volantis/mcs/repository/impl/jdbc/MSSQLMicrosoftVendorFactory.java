...
class MSSQLMicrosoftVendorFactory
        extends AbstractVendorFactory {

    public MSSQLMicrosoftVendorFactory() {
        super(JDBCRepositoryType.MSSQL_MS);
    }
    ...
    public String getDriverSpecificURL(MCSDriverConfiguration configuration)
        ...
        url = "jdbc:" + JDBCRepositoryType.MSSQL_MS.getSubProtocol() +
                ":sqlserver://" + host + ":" + port +
