...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/accessors/jdbc/UniqueStringEnumeration.java,v 1.4 2002/03/18 12:41:12 ianw Exp $
 * ----------------------------------------------------------------------------
...
public class UniqueStringEnumeration
  extends UniqueEnumeration {
  ...
  private static final String mark = "(c) Volantis Systems Ltd 2001.";
    ...
    private static final LogDispatcher logger = 
            LocalizationFactory.createLogger(UniqueStringEnumeration.class);

  public UniqueStringEnumeration (ResultSet rs) {
    super (rs);
  }
