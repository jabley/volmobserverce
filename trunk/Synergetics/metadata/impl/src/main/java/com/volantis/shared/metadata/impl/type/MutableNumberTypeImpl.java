...
/**
 * Implementation of {@link MutableNumberType}.
 */
final class MutableNumberTypeImpl
        extends NumberTypeImpl
        implements MutableNumberType {
     ...
     */
    public MutableNumberTypeImpl(NumberType type) {
        super(type);
    }
     ...
     */
    public MutableNumberTypeImpl() {
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.MUTABLE_NUMBER_TYPE;
    }
}
