...
/**
 * Implementation of {@link ImmutableListType}.
 */
final class ImmutableListTypeImpl
        extends ListTypeImpl
        implements ImmutableListType, Serializable,
        ImmutableMetaDataTypeVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = 3700725251362197086L;
     ...
     */
    public ImmutableListTypeImpl(ListType type) {
        super(type);
    }
     ...
     */
    protected ImmutableListTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_LIST_TYPE;
    }
}
