...
/**
 * Implementation of {@link com.volantis.shared.metadata.type.BooleanType}.
 */
abstract class BooleanTypeImpl extends SimpleTypeImpl implements BooleanType {
     ...
     */
    protected BooleanTypeImpl(BooleanType type) {
        super(type);
    }

    // Javadoc inherited.
    public ImmutableInhibitor createImmutable() {
        return new ImmutableBooleanTypeImpl(this);
    }

    // Javadoc inherited.
    public MutableInhibitor createMutable() {
        return new MutableBooleanTypeImpl(this);
    }

    // Javadoc inherited.
    public boolean equals(Object other) {
        return (other instanceof BooleanType) &&
            equalsSimpleType((BooleanType) other);
    }
