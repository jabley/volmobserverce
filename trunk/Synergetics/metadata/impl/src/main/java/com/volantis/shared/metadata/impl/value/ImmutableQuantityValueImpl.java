...
/**
 * Implementation of {@link ImmutableQuantityValue}.
 */
final class ImmutableQuantityValueImpl
        extends QuantityValueImpl
        implements ImmutableQuantityValue, Serializable,
        ImmutableMetaDataValueVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -3689560730809316159L;
     ...
     */
    public ImmutableQuantityValueImpl(QuantityValue value) {
        super(value);
    }
     ...
     */
    protected ImmutableQuantityValueImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_QUANTITY_VALUE;
    }
