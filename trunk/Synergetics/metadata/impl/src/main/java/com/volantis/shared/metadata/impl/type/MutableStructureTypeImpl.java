...
/**
 * Implementation of {@link MutableStructureType}.
 */
final class MutableStructureTypeImpl
        extends StructureTypeImpl
        implements MutableStructureType {
     ...
     */
    public MutableStructureTypeImpl(StructureType type) {
        super(type);
    }
     ...
     */
    public MutableStructureTypeImpl() {
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.MUTABLE_STRUCTURE_TYPE;
    }
