...
/**
 * Implementation of {@link ImmutableUnitTypeImpl}.
 */
final class ImmutableUnitTypeImpl
        extends UnitTypeImpl
        implements ImmutableUnitType, Serializable {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = 7977532339454306403L;
     ...
     */
    public ImmutableUnitTypeImpl(UnitType type) {
        super(type);
    }
     ...
     */
    protected ImmutableUnitTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_UNIT_TYPE;
    }
