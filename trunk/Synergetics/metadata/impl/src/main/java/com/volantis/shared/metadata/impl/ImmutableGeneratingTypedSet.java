...
/**
 * A {@link TypedSet} which in addition generates Immutable versions of each object which
 * is added to it.
 */
public class ImmutableGeneratingTypedSet
        extends TypedSet
     ...
     */
    static final long serialVersionUID = -2436734630938921274L;
     ...
     *        <code>Set</code>.
     */
    public ImmutableGeneratingTypedSet(Set set, Class allowableClass) {
        super(set, allowableClass);
    }

    /**
     * Helper method which ensures that an object is of the allowable class and if
     * necessary creates an Immutable version of this object.
