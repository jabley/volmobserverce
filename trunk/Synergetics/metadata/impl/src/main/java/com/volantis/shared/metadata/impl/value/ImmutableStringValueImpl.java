...
/**
 * Implementation of {@link ImmutableStringValue}.
 */
public final class ImmutableStringValueImpl
        extends StringValueImpl
        implements ImmutableStringValue, Serializable,
        ImmutableMetaDataValueVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -8808439050788099736L;
     ...
     */
    public ImmutableStringValueImpl(StringValue value) {
        super(value);
    }
     ...
     */
    protected ImmutableStringValueImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_STRING_VALUE;
    }
}
