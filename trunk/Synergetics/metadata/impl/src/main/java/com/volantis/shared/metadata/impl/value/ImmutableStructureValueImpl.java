...
/**
 * Implementation of {@link ImmutableStructureValue}.
 */
public final class ImmutableStructureValueImpl
        extends StructureValueImpl
        implements ImmutableStructureValue, Serializable,
     ...
     */
    public ImmutableStructureValueImpl(StructureValue value) {
        super(value);
    }
     ...
     */
    protected ImmutableStructureValueImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_STRUCTURE_VALUE;
    }
