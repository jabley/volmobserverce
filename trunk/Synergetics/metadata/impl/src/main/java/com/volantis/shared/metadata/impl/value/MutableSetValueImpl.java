...
/**
 * Implementation of {@link MutableSetValue}.
 */
final class MutableSetValueImpl
        extends SetValueImpl
        implements MutableSetValue {
     ...
     */
    public MutableSetValueImpl(SetValue value) {
        super(value);
    }
     ...
     */
    public MutableSetValueImpl() {
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.MUTABLE_SET_VALUE;
    }
