...
public class DefaultMetaDataValueFactory
        extends MetaDataValueFactory {

    public MutableBooleanValue createBooleanValue() {
        return new MutableBooleanValueImpl();
    }

    public MutableNumberValue createNumberValue() {
        return new MutableNumberValueImpl();
    }

    public MutableListValue createListValue() {
        return new MutableListValueImpl();
    }

    public MutableQuantityValue createQuantityValue() {
        return new MutableQuantityValueImpl();
    }

    public MutableStringValue createStringValue() {
        return new MutableStringValueImpl();
    }

    public MutableStructureValue createStructureValue() {
        return new MutableStructureValueImpl();
    }

    public MutableSetValue createSetValue() {
        return new MutableSetValueImpl();
    }

    public MutableChoiceValue createChoiceValue() {
