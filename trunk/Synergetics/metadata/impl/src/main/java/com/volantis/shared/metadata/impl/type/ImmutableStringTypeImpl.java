...
/**
 * Implementation of {@link ImmutableStringType}.
 */
final class ImmutableStringTypeImpl
        extends StringTypeImpl
        implements ImmutableStringType, Serializable,
        ImmutableMetaDataTypeVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -5485372128751123532L;
     ...
     */
    public ImmutableStringTypeImpl(StringType type) {
        super(type);
    }
     ...
     */
    protected ImmutableStringTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_STRING_TYPE;
    }
}
