...
/**
 * Abstract test case for {@link ConstraintImpl}.
 */
public abstract class ConstraintImplTestCaseAbstract extends MetaDataObjectImplTestCaseAbstract{

    /**
     * Constructor
     * @param name The name of this test case.
     */
    public ConstraintImplTestCaseAbstract(String name) throws Exception {
        super(name);
    }
