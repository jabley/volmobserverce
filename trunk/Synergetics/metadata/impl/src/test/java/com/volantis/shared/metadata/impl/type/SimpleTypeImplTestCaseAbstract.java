...
/**
 * Abstract test case for {@link com.volantis.shared.metadata.type.SimpleType}.
 */
public abstract class SimpleTypeImplTestCaseAbstract extends MetaDataTypeImplTestCaseAbstract {

    // Javadoc inherited.
    public SimpleTypeImplTestCaseAbstract(String name) throws Exception {
        super(name);
    }
