...
/**
 * Test case for {@link MinimumValueConstraintImpl}.
 */
public class MinimumValueConstraintImplTestCase
        extends RangeConstraintImplTestCaseAbstract {

    /**
     * Constructor
     * @param name The name of this test case.
     */
    public MinimumValueConstraintImplTestCase(String name) throws Exception {
        super(name);
    }
    ...
    protected ImmutableInhibitor getImmutableInhibitor() {
        return new ImmutableMinimumValueConstraintImpl();
    }
