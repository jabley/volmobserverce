...
/**
 * A mutable {@link EnumeratedConstraint}.
 *
 * <p>
 ...
 */
public interface MutableEnumeratedConstraint
        extends EnumeratedConstraint, MutableConstraint {

    /**
     * Get a mutable list of the allowable values.
     *
     ...
     * {@link SimpleValue}. If a user attempts to add a mutable instance to it
     * then the list will obtain an immutable instance and store that
     * instead.</p>
     *
     * @return A mutable list of the allowable values.
     */
