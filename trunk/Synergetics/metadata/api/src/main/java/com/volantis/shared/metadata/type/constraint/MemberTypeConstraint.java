...
/**
 * Constraint on the type of members allowed in a collection.
 *
 * <p>
 ...
 */
public interface MemberTypeConstraint
        extends Constraint {

    /**
     * Get the {@link ImmutableMetaDataType} of the members of
     * the collection.
     *
     * @return The {@link ImmutableMetaDataType} of the members. If null then this
     * collection is not constrained to take objects of a particular type.
     */
