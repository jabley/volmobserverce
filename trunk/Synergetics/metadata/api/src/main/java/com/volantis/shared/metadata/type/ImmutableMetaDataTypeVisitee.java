 ...
 * ImmutableMetadataTypeVisitor. Note that this is kept distinct from the
 ...
 *
 * @see com.volantis.shared.metadata.type.ImmutableMetaDataTypeVisitor
 */
public interface ImmutableMetaDataTypeVisitee {

    /**
     * Accept a visit request for an immutable metadata type visitor.
