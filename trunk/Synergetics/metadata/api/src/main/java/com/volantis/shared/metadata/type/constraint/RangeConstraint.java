...
/**
 * Base interface for all constraints that limit the range of a number value.
 *
 * <p>If this constraint is inclusive then the limit of this constraint is
 * within the range of allowable values, otherwise it is just outside.</p>
 *
 * <p>The default limit is an {@link Integer} with a value of 0.</p>
 *
 * <p>
