 ...
 */
public interface ChoiceType extends MetaDataType {
    /**
     * Returns a set of {@link ImmutableChoiceDefinition} objects.
     *
     ...
     * 
     * @return an unmodifiable set of {@link ImmutableChoiceDefinition} objects.
     */
    Set getChoiceDefinitions();
}
