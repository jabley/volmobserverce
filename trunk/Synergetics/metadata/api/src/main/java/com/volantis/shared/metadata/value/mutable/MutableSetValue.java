 ...
 */
public interface MutableSetValue
        extends SetValue, MutableCollectionValue {

    /**
     * Get a mutable set of {@link ImmutableMetaDataValue} instances.
     *
     ...
     * it then the set will obtain an immutable instance and store that
     * instead.</p>
     *
     * @return a mutable set of {@link ImmutableMetaDataValue} instances.
     */
