...
/**
 * A single choice definition within a choice type.
 * 
 * <p>
...
public interface ChoiceDefinition {
     ...
     *
     * <p>Choice names are valid Java Identifiers that may be optionally
     * prefixed with a namespace in the form of {&lt;namespace&gt;} where the
     * namespace can contain any characters apart from {}.</p>
     *
     * @return The name of the choice, may not be null.
     */
    String getName();
     ...
     * 
     * @return The type of the choice, may not be null.
     */
    ImmutableMetaDataType getType();
}
