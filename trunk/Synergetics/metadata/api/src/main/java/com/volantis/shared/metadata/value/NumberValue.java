 ...
 *
 * <p>To get the value of an instance of this as one of the built in simple
 * types, e.g. int, long, float, double, byte, short use the appropriate
 * method on the returned {@link Number}. e.g. to get it as an int use.</p>
 * <pre>
 *     NumberMetaDataValue v = ....;
 *     int i = v.getValueAsNumber().intValue();
 * </pre>
 *
 * <p>The default value is an {@link Integer} with a value of 0.</p>
 *
 * <p>
...
public interface NumberValue
     ...
     *
     * @return An unmodifiable Number value, may not be null.
     */
