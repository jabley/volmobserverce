...
/**
 * Implementation of {@link MutableUnitType}.
 */
final class MutableUnitTypeImpl
        extends UnitTypeImpl
        implements MutableUnitType {
     ...
     */
    public MutableUnitTypeImpl(UnitType type) {
        super(type);
    }
     ...
     */
    public MutableUnitTypeImpl() {
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.MUTABLE_UNIT_TYPE;
    }
}
