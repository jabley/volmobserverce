...
/**
 * Implementation of {@link com.volantis.shared.metadata.type.constraint.MinimumLengthConstraint}.
 */
abstract class MaximumLengthConstraintImpl extends ConstraintImpl
        implements MaximumLengthConstraint {
     ...
     */
    protected MaximumLengthConstraintImpl(
    ...
    public ImmutableInhibitor createImmutable() {
        return new ImmutableMaximumLengthConstraintImpl(this);
    }

    // javadoc inherited
    public MutableInhibitor createMutable() {
        return new MutableMaximumLengthConstraintImpl(this);
    }
    ...
    public boolean equals(final Object other) {
        return (other instanceof MaximumLengthConstraint) &&
            getLimit() == ((MaximumLengthConstraint) other).getLimit();
    }
