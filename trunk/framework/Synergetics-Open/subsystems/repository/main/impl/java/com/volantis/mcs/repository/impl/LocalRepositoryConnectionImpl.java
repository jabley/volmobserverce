...
import com.volantis.mcs.repository.AbstractRepositoryConnection;
 ...
 */
public abstract class LocalRepositoryConnectionImpl
        extends AbstractRepositoryConnection
 implements LocalRepositoryConnection {
     ...
     * @param repository
     */
    public LocalRepositoryConnectionImpl(Repository repository) {
        super(repository);
    }
