...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/utilities/Base64.java,v 1.3 2003/03/20 15:15:33 sumit Exp $
 * ----------------------------------------------------------------------------
 ...
 *
 * <p> Change Log: </p> <ul> <li>v1.3.6 - Fixed OutputStream.flush() so that
 * 'position' is reset.</li> <li>v1.3.5 - Added flag to turn on and off line
 * breaks. Fixed bug in input stream where last buffer being read, if not
 ...
 * I/O streams which were totally messed up.</li> </ul>
 *
 ...
 * well-wishing instead! Please visit <a href="http://iharder.net/xmlizable">http://iharder.net/xmlizable</a>
...
public class Base64 {
     ...
     */
    private final static int MAX_LINE_LENGTH = 9999;
    ...
    public static String encodeObject(java.io.Serializable serializableObject,
        ...
        try {
            ...
            b64os =
                new Base64.OutputStream(baos, Base64.ENCODE, breakLines);
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
        ...
        for (i = 0; i < len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) // White space, Equals sign or better
            {
                if (sbiDecode >= EQUALS_SIGN_ENC) {
                    ...
                    if (b4Posn > 3) {
                        outBuffPosn +=
                            decode4to3(b4, 0, outBuff, outBuffPosn);
                        b4Posn = 0;
    ...
    /**
     * An InputStream will read data from another {@link java.io.InputStream},
     * given in the constructor and encode/decode to/from Base64 notation on
     * the fly.
     *
     * @see com.volantis.synergetics.utilities.Base64
    ...
    public static class InputStream extends java.io.FilterInputStream {
         ...
         * @see com.volantis.synergetics.utilities.Base64#ENCODE
         * @see com.volantis.synergetics.utilities.Base64#DECODE
         * @since 1.3
         */
    ...
    /**
     * An OutputStream will write data to another {@link java.io.OutputStream},
     * given in the constructor, and encode/decode to/from Base64 notation on
     * the fly.
     *
     * @see com.volantis.synergetics.utilities.Base64
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
         ...
         * Constructs an OutputStream in either ENCODE or DECODE mode.
         *
         * @param out        the {@link java.io.OutputStream} to which data
         *                   will be written.
         * @param encode     Conversion direction
...
/*
 ...
 29-Sep-05	541/3	matthew	VBM:2005092809 mv Base64 from MCS to Synergetics

 29-Sep-05	541/1	matthew	VBM:2005092809 mv Base64 from MCS to Synergetics
