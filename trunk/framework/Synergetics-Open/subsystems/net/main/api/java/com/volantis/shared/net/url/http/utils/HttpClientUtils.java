...
public class HttpClientUtils {
    ...
    private static final Collection<String> HEADERS_WHICH_MAY_HAVE_MULTIPLE_VALUES = Arrays.asList(new String[]{
    		"accept",
    		"accept-charset",
    		"accept-encoding",
    		"accept-language",
     ...
     */
    public static List<String> getHeaderValueList(final Header header)
            throws HttpException {

        final List<String> result;
        if (!HEADERS_WHICH_MAY_HAVE_MULTIPLE_VALUES.contains(header.getName().toLowerCase())) {
