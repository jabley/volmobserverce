...
public interface DevicePolicyConstants {
     ...
     */
    public static final String X_ELEMENT_SUPPORTS_META_DESCRIPTION =
            "x-element.meta.property.description.support";

    /**
     * Indicates that the device supports the use of meta elements with
     * the "keywords" property.
     */
    public static final String X_ELEMENT_SUPPORTS_META_KEYWORDS =
            "x-element.meta.property.keywords.support";

    /**
     * Indicates that the device supports the use of meta elements with
     * the "author" property.
     */
    public static final String X_ELEMENT_SUPPORTS_META_AUTHOR =
            "x-element.meta.property.author.support";
    ...
    /**
     * Indicates what level of support the device has for a virtual viewport.
     * Can be 'none' or 'iphone-compatible'
     */
    public static final String X_BROWSER_VIEWPORT_VIRTUAL_SUPPORT =
            "x-browser.viewport.virtual.support";
