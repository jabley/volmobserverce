...
/**
 * This tests the DefaultIntPolicyValue class through implementing abstract
 * methods from the test hierarchy, and also for methods implemented directly
 * in this class.
 */
public class DefaultIntPolicyValueTestCase
    ...
    /**
     * Initialiase a new instance of this test case.
     */
    public DefaultIntPolicyValueTestCase() {
    }
     ...
     */
    public DefaultIntPolicyValueTestCase(String s) {
        super(s);
    }
    ...
    public void testCreationAndRetrieval() throws Exception {
        // +ve integer
        DefaultIntPolicyValue value = new DefaultIntPolicyValue(DEFAULT_VALUE);
        assertEquals("Integer values should match (1)",
                     new Integer(150),
                     value.getValueAsInteger());

        // -ve integer
        value = new DefaultIntPolicyValue("-" + DEFAULT_VALUE);
    ...
    public DefaultPolicyValue getTestInstance() {
        ...
        try {
            dipv = new DefaultIntPolicyValue(DEFAULT_VALUE);
