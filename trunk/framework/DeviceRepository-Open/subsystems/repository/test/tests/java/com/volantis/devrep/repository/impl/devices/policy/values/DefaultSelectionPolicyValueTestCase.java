...
/**
 * This tests the DefaultSelectionPolicyValue class through implementing abstract
 * methods from the test hierarchy, and also for methods implemented directly
 * in this class.
 */
public class DefaultSelectionPolicyValueTestCase
     ...
     */
    public DefaultSelectionPolicyValueTestCase() {
    }
     ...
     */
    public DefaultSelectionPolicyValueTestCase(String s) {
        super(s);
    }
    ...
    public void testCreationAndRetrieval() throws Exception {
        DefaultSelectionPolicyValue value =
                (DefaultSelectionPolicyValue) getTestInstance();
    ...
    public DefaultPolicyValue getTestInstance() {
        return new DefaultSelectionPolicyValue(TEST_STRING);
    }
