...
/**
 * This interface represents a Selection Policy Type.
 * 
 ...
 *
 * @deprecated Selections are defined as constraints on the allowable values
 * of any type so use {@link ImmutableStringType} with the appropriate
 * enumerated constraint instead.
 */
public interface SelectionPolicyType extends SimplePolicyType {
    
    /**
     * Gets the list of valid keywords for the selection.
     * 
     * @return an unmodifiable {@link List} of valid keywords
     */
