...
public class DefaultSeekableInputStream implements SeekableInputStream {
    ...
    /**
     * Indicates that the stream has already been closed. This allows us to
     * call {@link #close} aas often as wished
     */
    ...
    public void close() throws IOException {        
        if (!isClosed) {
            ...
            delegatee.close();
            // the line above should have done this but to be sure we do it
            // again. This is used to close HTTP connections and dispose of
            // used resources.
            if (null != closer) {
                closer.close();
            }
