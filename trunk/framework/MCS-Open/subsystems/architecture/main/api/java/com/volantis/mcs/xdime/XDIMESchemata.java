...
public class XDIMESchemata {
    ...
    /*
        TODO (AK):
        DISelect namespace should be referenced from Pipeline where it is
        defined/registered at the moment - it seems to imply proper dependency
        to be introduced. However, since select functions are to be moved to pipeline too
        this may not be neccessary and this constant is left for now as a temporary solution
     */
    /**
    ...
    /**
     * The DC namespace. Required when querying meta attribute values etc.
     */
