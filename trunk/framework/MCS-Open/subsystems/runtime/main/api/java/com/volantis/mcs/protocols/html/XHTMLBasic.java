 ...
 *                              separate part of the outpgut string instead of
...
import com.volantis.mcs.protocols.dissection.*;
...
import com.volantis.mcs.protocols.styles.DeviceAwareValueHandlerToPropertyAdapter;
...
public class XHTMLBasic extends DOMProtocol
    ...
    /**
     * This value specifies the type of script support.
     */
    protected String supportsScriptsType;

    /**
     * Does the protocol supports page events 
     */
    protected int supportedPageEvents;
    
    /**
     * Does the protocol supports focus events
     */
    protected int supportedFocusEvents;
    
    /**
     * Does the protocol supports form events
     */
    protected int supportedFormEvents;
    
    /**
     * Does the protocol supports field events
     */
    protected int supportedFieldEvents;
        
    
    /**
     * Collection of invalid form parents tag names
     */
    private static final Set invalidFormParents = Collections
            .unmodifiableSet(new TreeSet(String.CASE_INSENSITIVE_ORDER) {
                {
    ...
    protected PropertyHandler tableRowVerticalAlignHandler;
     ...
     */
    protected MenuModule shardLinkMenuModule;
    ...
    public void initialise () {
        ...
        supportsScriptsType
            = context.getDevicePolicyValue("x-element.script.supported");        
     ...
     */
    protected void addFieldEventAttributes (Element element,
     ...
     * @param attributes The attributes object which contains the events.
     */
    protected void addFocusEventAttributes (Element element,
                                  MCSAttributes attributes) throws ProtocolException {
    ...
    protected void addFormEventAttributes (Element element,
                                 MCSAttributes attributes) throws ProtocolException {
     ...
     * @param attributes The attributes object which contains the events.
     */
    protected void addPageEventAttributes (Element element,
                                 MCSAttributes attributes) throws ProtocolException {
...
//                }
    ...
    protected
        void closeDissectingPane(DOMOutputBuffer dom,
                                 DissectingPaneAttributes attributes) throws ProtocolException {
    ...
    public boolean isValidFormParent(String tagName) {
        return tagName != null && !invalidFormParents.contains(tagName);
    }
    ...
    protected final class ControlSelectionRenderer
        ...
        private HashMap optionCountByContainer;
        ...
        protected void writeOption(DOMOutputBuffer dom, SelectOption option)
            ...
            String containerName = getContainerName(option);
            boolean writeSeperator = (getOptionsCount(containerName) > 0);
            increaseOptionsCount(containerName);
        ...
        /**
         * Returns number of rendered options for container name
         * @param container name of container
         * @return options count
         */
        private int getOptionsCount(String container) {
            Integer count = (Integer) optionCountByContainer.get(container);
            return count == null ? 0 : count.intValue();
        }
        
        /**
         * adds one to the number of rendered options for pane name
         * @param container name of pane
         */
        private void increaseOptionsCount(String container) {
            optionCountByContainer.put(container, new Integer(getOptionsCount(container)+1));
        }
     ...
     */
    protected MenuModule getShardLinkMenuModule() {
    ...
    private MenuModuleRendererFactoryFilter
        ...
        return new ShardLinkMenuModuleRendererFactoryFilter();
    }
}