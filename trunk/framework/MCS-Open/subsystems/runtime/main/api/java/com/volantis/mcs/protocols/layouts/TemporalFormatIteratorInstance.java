...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/TemporalFormatIteratorInstance.java,v 1.3 2002/12/10 18:14:28 sumit Exp $
 * ----------------------------------------------------------------------------
 ...
 * ---------    --------------- -----------------------------------------------
 * 06-Nov-02    Sumit           VBM:2002111103 - Created
...
/**
 * Contains all the state associated with a TemporalFormatIterator in a 
 * particular MarinerPageContext.
 *
 * @mock.generate base="AbstractFormatIteratorInstance"
 */
public class TemporalFormatIteratorInstance
        extends AbstractFormatIteratorInstance {

    /**
     * Create a new <code>SegmentGridInstance</code>.
     */
    public TemporalFormatIteratorInstance(NDimensionalIndex index) {
        super(index);
    }
}
