...
import com.volantis.mcs.protocols.widgets.XHTMLFullWidgetModule;
...
public class XHTMLFull
     ...
     */
    protected XHTMLFullWidgetModule widgetModule = null;
     ...
     * should be created per request
     */
    protected TickerModule tickerModule = null;
     ...
     * should be created per request
     */
    protected GalleryModule galleryModule = null;
    ...
    public void initialise () {
        ...
        try {
            widgetModule = (XHTMLFullWidgetModule) Class
    ...
    protected void closeBody (DOMOutputBuffer dom,
        ...
        if (getMarinerPageContext().getRequiredScriptModules().isStartupRequired()) {
