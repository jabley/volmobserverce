...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/html/htmlversion3_2/HTML3_2UnabridgedTransformer.java,v 1.2 2003/01/15 12:42:10 philws Exp $
 * ----------------------------------------------------------------------------
...
/**
 * Provides HTML 3.2 protocol-specific DOM table optimization.
 */
public class HTML3_2UnabridgedTransformer extends UnabridgedTransformer {
     ...
     *                          transforming
     */
    public HTML3_2UnabridgedTransformer(TransformationConfiguration configuration) {
        super(new HTML3_2TransFactory(configuration));
    }
}
