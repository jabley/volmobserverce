...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/forms/ActionFieldType.java,v 1.4 2003/04/17 10:21:07 geoff Exp $
 * ----------------------------------------------------------------------------
 ...
 *                              type specific behaviour of an action field.
...
/**
 * This class defines the behaviour of action fields.
 */
public final class ActionFieldType
        implements FieldType {

    /**
     * The reference to the single allowable instance of this class.
     */
    private static final ActionFieldType singleton;

    // Initialise the static fields.
    static {
        // Always initialise to prevent a synchronization problem if we do it
        // lazily.
        singleton = new ActionFieldType();
    }
     ...
     */
    public static ActionFieldType getSingleton() {
        return singleton;
    }
    ...
    public void doField(
        ...
        protocol.doActionInput((XFActionAttributes) attributes);
    }
