...
/**
 * A format renderer that is used to render row iterator panes.
 */
public class RowIteratorPaneRenderer extends AbstractPaneRenderer {
    /**
     * Used for logging
     */
    private static final LogDispatcher logger =
            LocalizationFactory.createLogger(RowIteratorPaneRenderer.class);
