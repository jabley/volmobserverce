...
public class UpdateChecker implements Runnable {
    ...
    private static final LogDispatcher LOGGER =
        LocalizationFactory.createLogger(UpdateChecker.class);
    ...
    public void run() {
        ...
        try {
            ...
            // We check even if INFO log level is disabled,
            // because we want to be able to track installations
            ...
            // yes we really do want to catch everything so as not to annoy
            // users
            if (LOGGER.isDebugEnabled()) {
