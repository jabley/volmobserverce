...
public class DefaultViewportControlModule implements ViewportControlModule {
    static HashMap renderers = InitializeRenderers();

    private static HashMap InitializeRenderers() {
