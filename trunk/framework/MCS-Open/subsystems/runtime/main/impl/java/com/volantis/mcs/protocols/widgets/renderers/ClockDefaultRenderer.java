...
public abstract class ClockDefaultRenderer extends WidgetDefaultRenderer {
    ...
    /*
     * Single clock common module registration for all clock derrived renderers
     */
    public static final ScriptModule WIDGET_CLOCK_COMMON = createAndRegisterWidgetClock();
    ...
    private static ScriptModule createAndRegisterWidgetClock() {
        ...
        ScriptModule module = new ScriptModule("/vfc-clock-common.mscr", dependencies,
                15200, true);
