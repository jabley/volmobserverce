...
public abstract class ElementDefaultRenderer extends WidgetDefaultRenderer implements ElementRenderer {
    ...
    /*
     * Single ticker widget registration for all ticker derrived renderers
     */
    public static final ScriptModule WIDGET_TICKER = createAndRegisterWidgetTicker();

    private static ScriptModule createAndRegisterWidgetTicker() {
        ...
        ScriptModule module = new ScriptModule("/vfc-ticker.mscr", dependencies,
                28800, true);
