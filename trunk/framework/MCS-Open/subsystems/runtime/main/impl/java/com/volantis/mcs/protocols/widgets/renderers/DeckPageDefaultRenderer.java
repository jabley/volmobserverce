...
public class DeckPageDefaultRenderer extends WidgetDefaultRenderer {
    ...
    public void doRenderOpen(VolantisProtocol protocol,
        ...
        // only effect might appear in this element
        require(WidgetScriptModules.CE_BLINDUP, protocol, attributes);
        require(WidgetScriptModules.CE_SHAKE, protocol, attributes);
        require(WidgetScriptModules.CE_APPEAR, protocol, attributes);
        require(WidgetScriptModules.CE_BLINDDOWN, protocol, attributes);
        require(WidgetScriptModules.CE_DROPOUT, protocol, attributes);
        require(WidgetScriptModules.CE_FADE, protocol, attributes);
        require(WidgetScriptModules.CE_FOLD, protocol, attributes);
        require(WidgetScriptModules.CE_GROW, protocol, attributes);
        require(WidgetScriptModules.CE_PUFF, protocol, attributes);
        require(WidgetScriptModules.CE_SHRINK, protocol, attributes);
