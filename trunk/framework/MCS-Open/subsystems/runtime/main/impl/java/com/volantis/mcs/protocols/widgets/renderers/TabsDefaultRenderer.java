...
import com.volantis.mcs.protocols.highlight.HighlightInsertRule;
...
public class TabsDefaultRenderer extends WidgetDefaultRenderer implements
    ...
    private static ScriptModule createAndRegisterModule() {
        ...
        dependencies.add(HighlightInsertRule.MODULE);
        dependencies.add(WidgetScriptModules.BASE_COMMON);
        ScriptModule module = new ScriptModule("/vfc-tabs.mscr", dependencies,
                10100, true);
    ...
    public void renderTabClose(VolantisProtocol protocol,
        ...
        if ( ((TabAttributes)attributes).getLoadAttributes() != null ) {
