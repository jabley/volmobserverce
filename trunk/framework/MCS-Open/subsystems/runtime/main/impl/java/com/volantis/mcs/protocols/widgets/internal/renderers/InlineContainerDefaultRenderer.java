...
import com.volantis.mcs.protocols.widgets.internal.attributes.InlineContainerAttributes;
 ...
 */
public class InlineContainerDefaultRenderer extends WidgetDefaultRenderer {
    /**
    ...
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(InlineContainerDefaultRenderer.class);
    ...
    public void doRenderOpen(VolantisProtocol protocol,
        ...
        require(WidgetScriptModules.BASE_BB_CONTAINER, protocol, attributes);        
