...
public class ProtocolConfigurationTestCase extends TestCaseAbstract {
   ...
   /**
    ...
    protected void setExpectations(boolean supportsMarquee,
        ...
        // from DeviceCapabilityManagerBuilder#addTrElementCapabilities
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.TR_VERTICAL_ALIGN).returns("full").any();
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.TR_ATTRIBUTE_VALIGN).returns("full").any();
        ...
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.TD_VERTICAL_ALIGN).returns("full").any();
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.TD_ATTRIBUTE_VALIGN).returns("full").any();

        // from DeviceCapabilityManagerBuilder#addThElementCapabilities
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.TH_VERTICAL_ALIGN).returns("full").any();
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.TH_ATTRIBUTE_VALIGN).returns("full").any();
        ...
        // from DeviceCapabilityManagerBuilder#addVerticalAlignKeywordsCapabilities
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.VERTICAL_ALIGN_BOTTOM).returns("full").any();
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.VERTICAL_ALIGN_SUB).returns("full").any();
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.VERTICAL_ALIGN_SUPER).returns("full").any();
        device.expects.getPolicyValue(
                DeviceCapabilityConstants.VERTICAL_ALIGN_TOP).returns("full").any();
