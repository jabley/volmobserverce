...
public class StylerImpl
    ...
    /**
     * The style selection state required to trigger this styler, or null if
     * none is required.
     */
    protected final SelectionState styleSelectionState;
    ...
    public StylerImpl(
        ...
        this(source, priority, specificity, matcher, delta, null);
    }
    /**
     * Initialise.
     *
    ...
    public StylerImpl(
            Source source, Priority priority, Specificity specificity,
            Matcher matcher, StylesDelta delta, SelectionState state) {
        ...
        this.delta = delta;
        this.styleSelectionState = state;
    }
    ...
    public String getMatchableElement() {
        return matcher.getMatchableElement();
    }

    public String[] getMatchableClasses() {
        return matcher.getMatchableClasses();
    }

    public boolean isMatchAny() {
        return matcher.isMatchAny();
    }

    public String toString() {
        return (styleSelectionState == null ? "" : ("(Requires " +
                styleSelectionState + ")")) + String.valueOf(matcher) +
