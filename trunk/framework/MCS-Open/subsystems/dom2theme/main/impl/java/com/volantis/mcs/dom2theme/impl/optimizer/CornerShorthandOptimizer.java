...
/**
 * Optimizes a group of properties that specify the styles for various corners
 * of a box e.g. mcs-border-top-left-radius
 */

public class CornerShorthandOptimizer extends AbstractShorthandOptimizer {
