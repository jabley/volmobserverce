...
import com.volantis.mcs.dom2theme.impl.emulator.JavascriptStylesEmulator;
...
public class DefaultStyledDOMOptimizer
    ...
    /**
     * Javascript styles emulator. 
     */
    private final JavascriptStylesEmulator emulator;
    ...
    public DefaultStyledDOMOptimizer(
        ...
        emulator = new JavascriptStylesEmulator(context.getCSSVersion());
    }
    ...
    public void visit(final Element element) {
        ...
        if (!internalElement) {
            ...
            if (inputStyles == null) {
                ...
                // Emulate any styles (using attributes on the element) that are
