 ...
 * {@link com.volantis.mcs.dom2theme.impl.model.OutputStyles#iterate}.
 */
public abstract class OutputStylesIterateMethodAction
     ...
     *
     * @param iteratee the iteratee to process each mocked path.
     */
    public abstract void iterate(PseudoStylePathIteratee iteratee);
