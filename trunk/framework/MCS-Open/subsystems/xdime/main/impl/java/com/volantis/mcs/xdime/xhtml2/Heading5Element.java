...
/**
 * XHTML V2 Heading5 element object.
 */
public class Heading5Element extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(Heading5Element.class);
    /**
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenHeading5((HeadingAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseHeading5((HeadingAttributes)protocolAttributes);
    }
