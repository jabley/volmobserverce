 ...
 */
public class SetURLElement extends TickerResponseElement {

    public SetURLElement(XDIMEContextInternal context) {
        super(TickerResponseElements.SET_URL, context);
        
        protocolAttributes = new SetURLAttributes();
    }

    // Javadoc inherited
    public void callOpenOnModule(TickerResponseModule module) throws ProtocolException {
        module.openSetURL((SetURLAttributes) protocolAttributes);
    }

    // Javadoc inherited
    public void callCloseOnModule(TickerResponseModule module) throws ProtocolException {
        module.closeSetURL((SetURLAttributes) protocolAttributes);
    }
}
