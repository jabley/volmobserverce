...
/**
 * XHTML V2 UserInput element object.
 */
public class UserInputElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(UserInputElement.class);

    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(UserInputElement.class);

    public UserInputElement(XDIMEContextInternal context) {
        super(XHTML2Elements.KBD, context);

        protocolAttributes = new KeyboardAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenKeyboard((KeyboardAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseKeyboard((KeyboardAttributes)protocolAttributes);
    }
}
