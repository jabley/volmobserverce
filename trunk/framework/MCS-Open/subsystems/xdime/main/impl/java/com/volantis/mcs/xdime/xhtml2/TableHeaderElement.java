...
/**
 * XHTML V2 TableHeader element object.
 */
public class TableHeaderElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(TableHeaderElement.class);
    ...
    public TableHeaderElement(XDIMEContextInternal context) {
        super(XHTML2Elements.THEAD, context);

        protocolAttributes = new TableHeaderAttributes();
    }
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseTableHeader((TableHeaderAttributes)protocolAttributes);
    }
