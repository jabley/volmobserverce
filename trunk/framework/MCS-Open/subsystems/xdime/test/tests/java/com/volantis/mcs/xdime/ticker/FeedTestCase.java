 ...
 */
public class FeedTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(FeedAttributes.class);
        fakeFeedPoller();
    }

    protected String getElementName() {
        return TickerElements.FEED.getLocalName();
    }
