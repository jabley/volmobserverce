...
public class HTMLV4ObjectElementTestCase extends HTMLV4TestCaseAbstract {
    ...
    public void testObjectImplicitDeviceDependentImageTranscodeDefault()
        ...
        String transcodedImageSrc = "http://xxx/transcoded-image.jpg?v.width=999";

        volantisMock.expects.getMapUrlPrefix().returns("http://localhost:8080/map/map");
        ...
        marinerPageContextMock.expects.getSupportedImages().returns("").any();        
