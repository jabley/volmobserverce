 ...
 * element.
 */
public class ContentNotCompleteOneChild
     ...
     */
    public ContentNotCompleteOneChild(
            String element, String childNamespace, String child) {

        expected = "error - cvc-complex-type.2.4.b: The content of element '" +
                element + "' is not complete. One of '{\"" +
                childNamespace + "\":" + child + "}' is expected.\n";
    }
