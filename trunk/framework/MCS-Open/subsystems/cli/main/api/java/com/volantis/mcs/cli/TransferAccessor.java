...
public class TransferAccessor {
    ...
    protected final LocalRepositoryConnection connection;

    public TransferAccessor(LocalRepositoryConnection connection) {
    ...
    public boolean endTransaction() throws RepositoryException {
        return connection.endOperationSet();
    }

    public void abortTransaction() throws RepositoryException {
