...
/**
 * Tests the {@link NewGridFormatActionCommand}. Note that a test specific
 * version of the action command class is used to avoid the need for an
 * interactive dialog for obtaining grid dimensions.
 *
 * <p><strong>NOTE</strong>: this test case is closely modelled on the
 * {@link NewNonGridFormatActionCommandTestCase}.</p>
 */
public class NewGridFormatActionCommandTestCase
    ...
    protected FormatTypeBasedActionCommand createCommand(
            FormatType formatType, ODOMSelectionManager selManager) {
        /**
         * This anonymous specialization is used to allow the test to run
         * in a non-interactive manner.
         */
        return new NewGridFormatActionCommand(formatType, selManager, false) {
            /**
             * Ensures that the grid dimensions are returned without any
             * user interaction.
             */
...
/*
 ...
 21-Jan-04	2635/3	philws	VBM:2003121513 Implement the New Grid and non-Grid Action Commands
