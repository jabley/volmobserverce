...
public class SimpleXDIMERequestProcessor implements XDIMERequestProcessor {
    ...
    public SimpleXDIMERequestProcessor(
            ServletContext servletContext, List<String> xdimeMIMETypes) {
    ...
    public void processXDIME(final ServletContext servletContext,
        ...
        if (logger.isDebugEnabled()) {
            String xdimeContentValue =
                    (xdimeContent.getContentStyle() == ContentStyle.TEXT)
                            ? new String(xdimeContent.getAsCharArray())
                            : new String(xdimeContent.getAsByteArray());

            logger.debug("XDIME content to be processed: " +
                          xdimeContentValue);
        }        
