...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_cache1.jsp" styleClass="menu2">Page Cache Test</vt:a><vt:br/>
	<vt:a href="tt_include64klimit.jsp" styleClass="menu2">64k Limit Test</vt:a><vt:br/>
	<vt:a href="index.jsp" styleClass="menu2">Main Index</vt:a><vt:br/>
</vt:pane>

<vt:pane name="info">
<vt:p>
	Filename: tt_performance.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This section will test performance issues such as caching.
</vt:p>
</vt:pane>
