...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Chart">
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_chart.jsp <vt:br/>
...
<vt:p>
This is the 'Chart' Index page.
It contains links to test pages that cover the theme properties that are in the 'Chart' tab in style properties window in the GUI. Properties are:<vt:br/>
</vt:p>
