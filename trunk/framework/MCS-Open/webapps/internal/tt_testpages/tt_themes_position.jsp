...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Position">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_position.jsp" styleClass="menu2">Basic Position Properties</vt:a><vt:br/>
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_position.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Position' Index page.
It contains links to test pages that cover the theme properties that are in the 'Position' tab in style properties window in the GUI. Properties are:<vt:br/>
- Position<vt:br/>
- Clear<vt:br/>
- Float<vt:br/>
- Vertical Align<vt:br/>
</vt:p>
</vt:pane>
