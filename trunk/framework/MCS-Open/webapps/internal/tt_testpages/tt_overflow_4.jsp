...
<vt:canvas theme="tt_overflow_4" layoutName="standard" pageTitle="Themes: Format" >

<vt:pane name="main2">
<vt:p>
filename: tt_overflow_4.jsp<vt:br/><vt:br/>
theme: tt_overflow_4<vt:br/>
...
Test: canvas {overflow: auto}<vt:br/>
