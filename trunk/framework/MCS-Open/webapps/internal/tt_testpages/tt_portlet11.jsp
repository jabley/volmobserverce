...
<vt:canvas 	layoutName="tt_xfformfrag" theme="tt_xfform" type="portlet">

<vt:pane name="fileinfo">
  <vt:h1>XFForm Fragmentation Test 1</vt:h1>
  <vt:p>Filename: tt_xfform12.jsp<vt:br/>
  	Layout: tt_xfformfrag<vt:br/>
	Theme: tt_xfform
  </vt:p>
</vt:pane>
