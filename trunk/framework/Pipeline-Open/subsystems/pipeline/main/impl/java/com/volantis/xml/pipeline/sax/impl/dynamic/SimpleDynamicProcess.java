...
import com.volantis.xml.pipeline.sax.impl.operations.diselect.DISelectConditionalProcess;
...
import com.volantis.xml.pipeline.sax.dynamic.ErrorRecoveryException;
...
public class SimpleDynamicProcess
    ...
    public void startProcess() throws SAXException {
        ...
        passThroughControllers = new PassThroughController[3];
        passThroughControllers[0] = diSelectProcess;
        passThroughControllers[1] = dynamicRuleProcess;
    ...
    public void characters(char ch[], int start, int length) throws SAXException {
        ...
        } catch(ErrorRecoveryException e) {
            if(!getPipelineContext().inErrorRecoveryMode()) {
                throw new IllegalStateException("Error recovery exception thrown while not in error recovery mode.");
            }
        }
    }
     ...
     * @param parser
     */
    protected ExpressionProcess createExpressionProcess(ExpressionParser parser) {
        return new ExpressionProcess(parser);
    }
