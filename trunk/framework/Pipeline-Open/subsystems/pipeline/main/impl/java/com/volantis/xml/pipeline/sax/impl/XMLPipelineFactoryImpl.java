    ...
    private DynamicRuleConfigurator createRuleConfigurator() {
        ...
        return new DynamicRuleConfigurator() {
            ...
            public void configure(DynamicProcessConfiguration configuration) {
                ...
                // add the rules for URI driver processes
                URIDriverFactory.getDefaultInstance().
                        getRuleConfigurator().configure(configuration);

                // add the rules for picasa driver processes
                PicasaDriverFactory.getDefaultInstance().
                        getRuleConfigurator().configure(configuration);

                // add the rules for flickr driver processes
                FlickrDriverFactory.getDefaultInstance().
                        getRuleConfigurator().configure(configuration);

                // add the rules for google docs driver processes
                GoogleDocsDriverFactory.getDefaultInstance().
                        getRuleConfigurator().configure(configuration);                        
