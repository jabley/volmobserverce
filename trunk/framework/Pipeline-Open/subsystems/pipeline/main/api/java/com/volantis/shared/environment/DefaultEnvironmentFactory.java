...
/**
 * Default implementation of the <code>EnvironmentFactory<code>
 * abstract class
 */
public class DefaultEnvironmentFactory extends EnvironmentFactory {

    // javadoc inhertited
    public EnvironmentInteractionTracker createInteractionTracker() {
        return new SimpleEnvironmentInteractionTracker();
    }
}
