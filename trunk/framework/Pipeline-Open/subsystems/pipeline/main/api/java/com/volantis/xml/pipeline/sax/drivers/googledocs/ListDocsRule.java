...
public class ListDocsRule
    ...
    private static final LogDispatcher LOGGER =
            LocalizationFactory.createLogger(ListDocsRule.class);

    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
            LocalizationFactory.createExceptionLocalizer(ListDocsRule.class);
    ...
    /*
     * Identifier for the google docs service
     */
    private static String GOOGLE_DOCS_FEED_URL =
            "http://docs.google.com/feeds/documents/private/full";

    private static String GOOGLE_DOCS_FEED_URL_CATEGORY_PARAM =
            "?category=";
    private static String GOOGLE_DOCS_FEED_URL_QUERY_PARAM =
            "&q=";
    private static String GOOGLE_DOCS_FEED_URL_PAGE_SIZE_PARAM =
            "&max-results=";
    private static String GOOGLE_DOCS_FEED_URL_START_INDEX_PARAM =
            "&start-index=";
    ...
    protected String prepareRequestUrl(HashMap<String, String> atts) {
        ...
        addAttributeParam(requestUrl, GOOGLE_DOCS_FEED_URL_START_INDEX_PARAM, calculateStartIndex(atts.get(ATTRIBUTE_PAGE_INDEX),
                                                                                                  atts.get(ATTRIBUTE_PAGE_SIZE)));
