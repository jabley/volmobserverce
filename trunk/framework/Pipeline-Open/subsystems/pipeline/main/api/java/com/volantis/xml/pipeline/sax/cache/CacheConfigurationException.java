...
/**
 * This error class is used to indicate that there was a problem in
 * configuring a cache.
 */
public class CacheConfigurationException extends CacheProcessingException {
     ...
     */
    public CacheConfigurationException(String message, Locator locator,
                                       String cacheName) {
     ...
     * @param cacheName The name of the cache that we failed to find.
     */
    public CacheConfigurationException(String message, String publicId,
