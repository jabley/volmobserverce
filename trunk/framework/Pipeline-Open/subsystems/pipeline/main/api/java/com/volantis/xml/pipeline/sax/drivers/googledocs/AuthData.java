...
class AuthData {
    ...
    final static String GDOCS_USER_DATA = "gdocs_user_data";

    /**
     * Used for logging.
     */
    private static final LogDispatcher LOGGER =
            LocalizationFactory.createLogger(AuthData.class);

    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
            LocalizationFactory.createExceptionLocalizer(AuthData.class);
    /**
    ...
    AuthData(Attributes attributes) {
        ...
        setCaptchaTokenAndKey(attributes.getValue(AuthenticateRule.CAPTCHA_VALUE_ATTRIBUTE),
                              attributes.getValue(AuthenticateRule.CAPTCHA_KEY_ATTRIBUTE));
    }
    ...
    private static HashMap<String, AuthData> getCache(XMLPipelineContext context) {
        TokenConfiguration gtc = (TokenConfiguration)context.
                            getPipelineConfiguration().
                            retrieveConfiguration(TokenConfiguration.class);
    ...
    void setCaptchaTokenAndKey(String captchaToken, String captchaKey) {
        if ((captchaToken == null && captchaKey != null) ||
            (captchaToken != null && captchaKey == null)) {
