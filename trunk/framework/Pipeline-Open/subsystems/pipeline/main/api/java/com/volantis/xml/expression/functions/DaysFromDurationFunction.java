...
/**
 * Transforms duration into days.
 */
public class DaysFromDurationFunction extends BaseDurationFunction {

    /**
     * The name of the function.
     */
    public final static String NAME = "days-from-duration";

    /**
     * {@inheritDoc}
     */
    protected Value getValue(ExpressionFactory factory, DurationValue duration) {
        int result = Math.abs(duration.getDays());
        result += Math.abs(duration.getHours() / 24);
