 ...
 * ---------    --------------- -----------------------------------------------An AdapterProcess is an XMLProcess that
...
/**
 * Tagging interface for now. See if we can extract some common
 * functionality from implementing classes
 */
public interface OperationProcess extends XMLProcess {
}
