...
/**
 * See <a href="http://www.w3.org/TR/xquery-operators/#func-empty">fn:dateTime</a>.
 */
public class DateTimeFunction implements Function {
    ...
    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
        LocalizationFactory.createExceptionLocalizer(DateTimeFunction.class);
    ...
    public Value invoke(ExpressionContext expressionContext, Value[] values)
        ...
        if(values[0].getSequence() != Sequence.EMPTY) {
            String dateTime = values[0].stringValue().asJavaString();
            result = expressionContext.getFactory().createDateTimeValue(dateTime);
        }
        return result;
    }
}
