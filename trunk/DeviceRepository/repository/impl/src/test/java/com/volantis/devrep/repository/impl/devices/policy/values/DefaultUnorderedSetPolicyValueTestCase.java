...
/**
 * This tests all DefaultUnorderedSetPolicyValue classes.
 */
public class DefaultUnorderedSetPolicyValueTestCase
        extends DefaultSetPolicyValueTestAbstract {

    /**
     * Initialise a new instance of this test case.
     */
    public DefaultUnorderedSetPolicyValueTestCase() {
    }
     ...
     */
    public DefaultUnorderedSetPolicyValueTestCase(String s) {
        super(s);
    }
    ...
    public DefaultPolicyValue getTestInstance() {
        ...
        DefaultUnorderedSetPolicyValue duspv = null;
        try {
            duspv = new DefaultUnorderedSetPolicyValue(
    ...
    /**
     * Tests that an unordered set cannot be constructed from invalid values.
     */
    public void testInvalidSetValues() {
        try {
            DefaultUnorderedSetPolicyValue value =
                    new DefaultUnorderedSetPolicyValue(
