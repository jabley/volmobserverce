...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/accessors/jdbc/StringPairEnumeration.java,v 1.4 2002/03/18 12:41:12 ianw Exp $
 * ----------------------------------------------------------------------------
...
import com.volantis.mcs.accessors.jdbc.SQLResultSetEnumeration;
...
public class StringPairEnumeration
  ...
  private static final String mark = "(c) Volantis Systems Ltd 2001.";
    ...
    private static final LogDispatcher logger = 
            LocalizationFactory.createLogger(StringPairEnumeration.class);

  public StringPairEnumeration (ResultSet rs) {
    super (rs);
  }
