...
import com.volantis.mcs.devices.policy.values.RangePolicyValue;
...
/**
 * This class provides the default implementation of a Range Policy Value.
 */
public class DefaultRangePolicyValue
        extends DefaultSimplePolicyValue
        implements RangePolicyValue {
     ...
     * @throws DeviceRepositoryException if the given value is not an
     * integer.
     */
