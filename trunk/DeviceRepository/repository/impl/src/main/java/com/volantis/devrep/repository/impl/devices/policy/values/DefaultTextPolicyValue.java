...
/**
 * This class provides the default implementation of a Text Policy Value.
 */
public class DefaultTextPolicyValue
        extends DefaultSimplePolicyValue
        implements TextPolicyValue {
     ...
     */
    DefaultTextPolicyValue(String value) {
        this.value = value;
    }
