...
/**
 * Configuration items for the e-mail sending part.
 */
public class EmailNotifierConfig {
    ...
    /**
     * E-mail sending period.
     */
    private EmailNotifierPeriodEnum period;

    public EmailNotifierConfig() {
    }
     ...
     * @return the period
     */
    public EmailNotifierPeriodEnum getPeriod() {
        return period;
    }
     ...
     */
    public void setPeriod(final EmailNotifierPeriodEnum period) {
        this.period = period;
    }
}
