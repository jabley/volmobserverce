...
/**
 * This interface represents an Ordered Set Policy Type.
 * 
 ...
 *
 * @deprecated An ordered set is a {@link ImmutableListType} that is
 * constrained to have unique members.
 */
public interface OrderedSetPolicyType extends SetPolicyType {
}
