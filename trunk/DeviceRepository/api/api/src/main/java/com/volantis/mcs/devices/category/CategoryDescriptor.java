...
public interface CategoryDescriptor {
    ...
    /**
     * Returns the descriptive name for the policy category name. This method
    ...
    /**
     * The string representation of the language of descriptive name.
     *
     ...
     *
     * @return the language used for descriptive name.
     */
