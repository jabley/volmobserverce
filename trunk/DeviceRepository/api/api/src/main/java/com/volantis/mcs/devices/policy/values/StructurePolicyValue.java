...
/**
 * This interface represents a Structure Policy Value.
 * 
 ...
 *
 * @deprecated Use {@link ImmutableStructureValue} instead.
 */
public interface StructurePolicyValue extends CompositePolicyValue {

    /**
     * Returns a Map keyed on field name containing the SimplePolicyValue's.
     *
     * @return an unmodifiable {@link Map} of field values. If a field value
     * is empty then an entry will exist in the map with a null value.
     */
