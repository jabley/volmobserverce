...
/**
 * This interface represents a Structure Policy Type.
 * 
 ...
 *
 * @deprecated Use {@link ImmutableStructureType} instead.
 */
public interface StructurePolicyType extends CompositePolicyType {

    /**
     * Returns a Map keyed on field name containing the PolicyType
     * representing the type of the field.
     * 
     * @return an unmodifiable Map of field types
     */
