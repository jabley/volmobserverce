...
public class GIFGreyscale4Writer extends DefaultGIFWriter {

    /**
     * Used for logging.
     */
    private static final LogDispatcher LOGGER =
        LocalizationFactory.createLogger(GIFGreyscale4Writer.class);
    ...
    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
        LocalizationFactory.createExceptionLocalizer(
            GIFGreyscale4Writer.class);

    /**
     * Attempts to output an image in 4 level grayscale, however if a maximum
            ...
            if (params.containsName(ParameterNames.MAX_IMAGE_SIZE) &&
                ...
                if ((sizeOfConvertedImage > maxImageSize) &&
                    ...
                    os = ImageWriterFactory.getInstance().
                        getWriter(OutputImageRules.GREYSCALEGIF1, params).process(ops, params, os);
                    if (LOGGER.isDebugEnabled()) {
                        LOGGER.debug("Changing the ImageWriter to 'gg1'");
                    }
                } else {
