 ...
 * format to another.
 */
public class PNGWatermarkingTestCase extends TestCaseAbstract {
     ...
     */
    private void doWatermarking(String rule, String image, String expected)
        throws Throwable {

        //it is necessary to set reload parameter into request to
        //make servlet reloading configuration since each test builds up
        //its ouwn configuration.
        ...
        RenderedOp img = JAI.create("ImageRead", stream);
     ...
     */
    public void testConvertWithWatermarkingTCtoTC()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingTCtoGrey4()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingTCtoGrey2()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingTCtoMonochrome()
        throws Throwable {
     ...
     */
    public void testConvertWithWatermarkingGreyToTC()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingGreyToIndexed()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingGreyToGrey8()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingGreyToGrey4()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingGreyToGrey2()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingGreyToMonochrome()
        throws Throwable {
     ...
     */
    public void testConvertWithWatermarkingIndexedToTC()
        throws Throwable {

        //doWatermarking(OutputImageRules.COLOURBMP24, "circusshow4256.bmp", "tc"); //JAI fails during outputting into BMP
    ...
    public void testConvertWithWatermarkingIndexedToIndexed()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingIndexedToGrey()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingIndexedToMonochrome()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingSVGToColourJPEG()
        throws Throwable {

        doWatermarking(OutputImageRules.COLOURJPEG24, "asf-logo.svg", "tc");
    }

    public void testConvertWithWatermarkingSVGToColourTIFF()
        throws Throwable {

        doWatermarking(OutputImageRules.COLOURTIFF24, "asf-logo.svg", "tc");
    }

    public void testConvertWithWatermarkingSVGToJPEGGreyscale()
        throws Throwable {
        doWatermarking(OutputImageRules.GREYSCALEJPEG8, "asf-logo.svg", "grey");
    }

    public void testConvertWithWatermarkingSVGToGifIndexed()
        throws Throwable {

        doWatermarking(OutputImageRules.COLOURGIF8, "asf-logo.svg", "indexed");
    }

    public void testConvertWithWatermarkingSVGToGifGreyscale()
        throws Throwable {

        doWatermarking(OutputImageRules.GREYSCALEGIF8, "asf-logo.svg", "grey");
    }

    public void testConvertWithWatermarkingSVGToGifGreyscale4()
        throws Throwable {

        doWatermarking(OutputImageRules.GREYSCALEGIF2, "asf-logo.svg", "grey2");
    }

    public void testConvertWithWatermarkingSVGToGifGreyscale16()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingSVGToGIFMonochrome()
        throws Throwable {

        doWatermarking(OutputImageRules.GREYSCALEGIF1, "asf-logo.svg", "mono");
    }

    public void testConvertWithWatermarkingSVGToPNGGreyscale()
        throws Throwable {

        doWatermarking(OutputImageRules.GRAYSCALEPNG8, "asf-logo.svg", "grey");
    }

    public void testConvertWithWatermarkingSVGToPNGGreyscale4()
        throws Throwable {
    ...
    public void testConvertWithWatermarkingSVGToPNGGreyscale16()
        throws Throwable {

        doWatermarking(OutputImageRules.GRAYSCALEPNG4, "asf-logo.svg", "grey");
    }

    public void testConvertWithWatermarkingSVGToPNGMonochrome()
        throws Throwable {

        doWatermarking(OutputImageRules.GRAYSCALEPNG1, "asf-logo.svg", "mono");
    }

    public void testConvertWithWatermarkingSVGToPNGIndexed()
        throws Throwable {

        doWatermarking(OutputImageRules.COLOURPNG8, "asf-logo.svg", "indexed");
    }

    public void testConvertWithWatermarkingSVGToPNGColour()
        throws Throwable {
