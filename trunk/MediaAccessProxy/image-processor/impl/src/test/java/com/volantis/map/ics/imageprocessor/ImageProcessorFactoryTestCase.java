...
public class ImageProcessorFactoryTestCase extends TestCase {

    public void testGetInstance() throws Exception {
        assertNotNull(ImageProcessorFactory.getInstance());
    }

    public void testCreateImageProcessor() throws Exception {
        ImageProcessor processor =
            ImageProcessorFactory.getInstance().createImageProcessor(
