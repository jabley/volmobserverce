...
public class DefaultConfiguration implements Configuration {
    ...
    /**
     * Whether the server is in Native or Transforce mode. true means we are in
     * Native mode.
     */
    ...
    public void setHostPort(String s) {
        try {
            setHostPort(Integer.parseInt(s));
    ...
    /**
     * Specifies whether we are in Native mode or Transforce emulation mode
     *
     * @param b true if we are in Native mode, false for Transforce mode
     */
    public void setNativeMode(boolean b) {
        nativeMode = b;
    }
    ...
    /**
     * Serialize the server mdoe
     *
     * @param mode the server mode to serialize
     * @return the string represenation of the server mode
     */
