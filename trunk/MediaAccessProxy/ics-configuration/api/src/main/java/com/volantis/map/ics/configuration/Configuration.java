...
public interface Configuration {
    ...
    /**
     * Returns whether or not we are running in native volantis mode. If not
     * then we are in transforce emulation mode.
     *
     * @return true if we are in native mode, false if we are in transforce
     *         mode.
     */
