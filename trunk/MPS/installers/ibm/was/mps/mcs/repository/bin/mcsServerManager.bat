...
rem The jdbc drivers are required in the users CLASSPATH

set TOOLS_LIB=..\lib
set TOOLS_JAR_PATH=%TOOLS_LIB%\log4j.jar
set TOOLS_JAR_PATH=%TOOLS_JAR_PATH%;%TOOLS_LIB%\mcs-api.jar
set TOOLS_JAR_PATH=%TOOLS_JAR_PATH%;%TOOLS_LIB%\volantis-mcs-cli.jar
...
java -classpath %TOOLS_JAR_PATH%;%CLASSPATH% com.volantis.mcs.cli.MarinerManager %*
