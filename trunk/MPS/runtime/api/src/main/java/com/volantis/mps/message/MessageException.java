...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/mps/com/volantis/mps/message/MessageException.java,v 1.2 2003/03/20 10:15:36 geoff Exp $
 * ----------------------------------------------------------------------------
...
/**
 * This exception encapsulates any error occurring during a message-related
 * operation.
 *
...
public class MessageException extends Exception {
    ...
    /**
     * Initializes the new instance without a detail message.
     */
     ...
     *
     * @return The root cause of this exception, or <code>null</code>.
     */
    ...
    /**
     * This prints the stack trace of this <code>MessageException</code>. If
