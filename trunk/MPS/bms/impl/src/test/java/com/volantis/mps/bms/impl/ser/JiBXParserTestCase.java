...
public class JiBXParserTestCase extends XMLTestCase {
    ...
    private static final String RECIPIENT_ALICE = "<recipient>"
            + "<address>alice@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>Nokia-6600</device-name>"
            + "</recipient>";

    private static final String RECIPIENT_ALICE_WITH_TYPE = "<recipient>"
            + "<address>alice@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>Nokia-6600</device-name>"
            + "<type>TO</type>"
    ...
    private static final String RECIPIENT_BOB = "<recipient>"
            + "<address>bob@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>Nokia-6800</device-name>"
            + "</recipient>";

    private static final String RECIPIENT_BOB_WITH_TYPE = "<recipient>"
            + "<address>bob@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>Nokia-6800</device-name>"
            + "<type>TO</type>"
    ...
    private static final String SEND_REQUEST_BASIC =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE
                    + "</recipients>"
                    + "<message>"
                    + "<subject>Hello</subject>"
                    + "<url>http://localhost:8080/volantis/welcome/welcome.xdime</url>"
                    + "</message>"
                    + "</send-request>";

    private static final String SEND_REQUEST_BASIC_EMBEDDED_CONTENT =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE
    ...
    private static final String SEND_REQUEST_BASIC_EMBEDDED_CONTENT_WITH_TYPE =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE_WITH_TYPE
                    + "</recipients>"
                    + "<message>"
                    + "<subject/>"
                    + "<content>" + MESSAGE + "</content>"
    ...
    private static final String SEND_REQUEST_BASIC_WITH_TYPE =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE_WITH_TYPE
    ...
    private static final String RECIPIENT_CAROL = "<recipient>"
            + "<address>carol@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>SonyEriccson-973i</device-name>"
            + "</recipient>";

    private static final String RECIPIENT_CAROL_WITH_TYPE = "<recipient>"
            + "<address>carol@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>SonyEriccson-973i</device-name>"
            + "<type>TO</type>"
    ...
    private static final String RECIPIENT_DAVE = "<recipient>"
            + "<address>dave@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>Samsung-D700</device-name>"
            + "</recipient>";

    private static final String RECIPIENT_DAVE_WITH_TYPE = "<recipient>"
            + "<address>dave@volantis.com</address>"
            + "<channel-name>smtp</channel-name>"
            + "<device-name>Samsung-D700</device-name>"
            + "<type>TO</type>"
    ...
    private static final String SENDER_EVE =
            "<sender>"
            +"<smtp-address>eve@volantis.com</smtp-address>"
            +"</sender>";

    private static final String SEND_REQUEST_MULTIPLE_RECIPIENT =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE
                    ...
                    + "<url>http://some.host.com:6000/volantis/welcome/welcome.xdime</url>"
                    + "</message>"
                    + "</send-request>";

    private static final String SEND_REQUEST_BASIC_WITH_SENDER =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE
    ...
    private static final String SEND_REQUEST_MULTIPLE_RECIPIENT_WITH_SENDER =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE
    ...
    private static final String SEND_REQUEST_MULTIPLE_RECIPIENT_WITH_SENDER_AND_TYPES =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<send-request xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + "<recipients>"
                    + RECIPIENT_ALICE_WITH_TYPE
                    + RECIPIENT_BOB_WITH_TYPE
                    + RECIPIENT_CAROL_WITH_TYPE
                    + RECIPIENT_DAVE_WITH_TYPE
                    + "</recipients>"
                    + "<message>"
                    + "<subject>Goodbye</subject>"
                    + "<url>http://some.host.com:6000/volantis/welcome/welcome.xdime</url>"
    ...
    private static final String FAILURES_BASIC =
            "<?xml version='1.0' encoding='UTF-8'?>"
                    + "<failures xmlns='http://www.volantis.com/xmlns/2006/11/mps/ws'>"
                    + RECIPIENT_ALICE_WITH_TYPE
                    + RECIPIENT_BOB_WITH_TYPE
                    + RECIPIENT_DAVE_WITH_TYPE
                    + "</failures>";
