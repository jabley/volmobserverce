...
/**
 * An interface to allow user code to provide custom content recogniser
 * implementations.
 * <p>
 * Implementations of this class may be passed to
 * {@link ResourceMigratorBuilder#addCustomContentRecogniser}.
 *
 * @mock.generate
 */
public interface ContentRecogniser {
    ...
    /**
     * Attempt to recognise the resource provided, returning true if it is
     * recognised and false if not.
     *
     * @param input the input stream to read the resource from.
     * @return true if recognised, false otherwise.
     */
    boolean recogniseContent(InputStream input)
