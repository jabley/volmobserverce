...
<!--
 ! This XSLT adds additional templates in order to allow the Table Module
 ! to be unit tested.
 !-->
<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="get-style" match="xh2:table[@class='my-table']">
        <css:style>
            <css:pane-name>table-pane</css:pane-name>
        </css:style>
    </xsl:template>

    <xsl:template mode="get-style" match="xh2:table/xh2:caption[@class='my-caption']">
        <css:style>
            <css:pane-name>caption-pane</css:pane-name>
        </css:style>
    </xsl:template>
...
<!--
 ...
 21-Jun-04	4645/8	pcameron	VBM:2004060306 Committed for integration
