...
/**
 * Define the RuleSet for the markup plugin argument.
 */
public class ArgumentRuleSet extends PrefixRuleSet {
    /**
    ...
    public ArgumentRuleSet(String prefix) {
        this.prefix = prefix;
    }

    // javadoc inherited
    public void addRuleInstances(Digester digester) {        
        final String pattern = prefix + "/argument";

        digester.addObjectCreate(pattern, ArgumentConfiguration.class);
        digester.addSetNext(pattern, "addArgument");
