...
public class StateFactoryImpl
    ...
    // Javadoc inherited.
    public MutableStateRegistry createStateRegistry() {
        return new MutableStateRegistryImpl();
    }

    // Javadoc inherited.
    public StateContainer createStateContainer(
            ImmutableStateRegistry registry) {
        ImmutableStateRegistryImpl impl = (ImmutableStateRegistryImpl) registry;
        return impl.createStateContainer();
    }
}
