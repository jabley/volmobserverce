...
/**
 * The arguments used by a function call.
 *
 * <p>
...
public interface Arguments {
    ...
    /**
     * Add a description of the arguments to the buffer.
     *
     * @param description The buffer to which the argument description should
     *                    be added.
     */
    void addDescription(StringBuffer description);
}
