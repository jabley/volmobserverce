...
public class StylingEngineImpl
     ...
     * @param container The container that was created for that style sheet.
     * @param depth
     */
    private void addEngineListeners(
            StyleSheetInternal styleSheet, final StateContainer container,
            final int depth) {
    ...
    public void pushStyleSheet(
        ...
        addEngineListeners(internalStyleSheet, stateContainer, depth);
    ...
    public void popStyleSheet(CompiledStyleSheet styleSheet) {
        ...
        for (Iterator i = listeners.iterator(); i.hasNext();) {
            EngineDepthChangeListener engineDepthChangeListener =
                    (EngineDepthChangeListener) i.next();
            if (engineDepthChangeListener.getDepth() == depth) {
                i.remove();
            }
        }
    }
