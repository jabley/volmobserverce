 ...
 * {@link DepthChangeListener#beforeStartElement(MatcherContext)} method.
 */
public class BeforeStartElementIteratee
     ...
     */
    public BeforeStartElementIteratee(MatcherContext matcherContext) {
    ...
    public IterationAction next(Listener listener) {
        ...
        dc.beforeStartElement(matcherContext);
