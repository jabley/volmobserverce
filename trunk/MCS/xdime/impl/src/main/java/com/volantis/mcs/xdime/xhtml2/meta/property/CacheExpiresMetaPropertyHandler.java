...
import com.volantis.mcs.xdime.xhtml2.meta.datatype.DateTimeContentProcessor;
...
/**
 * A property handler for mcs:cache-expires
 */

public class CacheExpiresMetaPropertyHandler extends AbstractMetaPropertyHandler {

    // javadoc inherited
    public DataType getDefaultDataType() {
        return DateTimeContentProcessor.DATE_TIME_TYPE;
    }
    ...
    protected void checkContent(final Object content,
        ...
        checkContentType(content, Time.class);
    }
