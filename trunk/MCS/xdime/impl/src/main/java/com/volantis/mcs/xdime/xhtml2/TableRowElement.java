...
/**
 * XHTML V2 TableRow element object.
 */
public class TableRowElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(TableRowElement.class);
    /**
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseTableRow((TableRowAttributes)protocolAttributes);
    }
