...
/**
 * XHTML V2 Preserve element object.
 */
public class PreserveElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(PreserveElement.class);
    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(PreserveElement.class);

    public PreserveElement(XDIMEContextInternal context) {
        super(XHTML2Elements.PRE, context);

        protocolAttributes = new PreAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenPre((PreAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeClosePre((PreAttributes)protocolAttributes);
    }
