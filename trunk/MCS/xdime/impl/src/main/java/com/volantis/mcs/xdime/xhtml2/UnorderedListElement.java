...
/**
 * XHTML V2 UnorderedList element object.
 */
public class UnorderedListElement extends GenericListElement {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(UnorderedListElement.class);
    /**
