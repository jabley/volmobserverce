...
/**
 * XHTML V2 Definition Term element object.
 */
public class DefinitionTermElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(DefinitionTermElement.class);
    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(
            DefinitionTermElement.class);

    public DefinitionTermElement(XDIMEContextInternal context) {
        super(XHTML2Elements.DT, context);

        protocolAttributes = new DefinitionTermAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenDefinitionTerm(
                (DefinitionTermAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseDefinitionTerm(
            (DefinitionTermAttributes)protocolAttributes);
    }
}
