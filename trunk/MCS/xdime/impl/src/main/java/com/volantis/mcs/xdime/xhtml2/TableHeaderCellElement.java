...
/**
 * XHTML V2 TableHeaderCell element object.
 */
public class TableHeaderCellElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(TableHeaderCellElement.class);
    /**
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseTableHeaderCell(
            (TableCellAttributes)protocolAttributes);
    }
