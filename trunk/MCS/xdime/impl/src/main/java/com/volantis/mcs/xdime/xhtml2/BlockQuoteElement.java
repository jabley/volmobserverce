...
/**
 * XHTML V2 BlockQuote element object.
 */
public class BlockQuoteElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(BlockQuoteElement.class);
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenBlockQuote(
                (BlockQuoteAttributes)protocolAttributes);
