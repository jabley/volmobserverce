 ...
 */
public class IconElement extends TickerResponseElement {

    public IconElement(XDIMEContextInternal context) {
        super(TickerResponseElements.ICON, context);
        
        protocolAttributes = new IconAttributes();
    }

    // Javadoc inherited
    public void callOpenOnModule(TickerResponseModule module) throws ProtocolException {
        module.openIcon((IconAttributes) protocolAttributes);
    }

    // Javadoc inherited
    public void callCloseOnModule(TickerResponseModule module) throws ProtocolException {
        module.closeIcon((IconAttributes) protocolAttributes);
    }
}
