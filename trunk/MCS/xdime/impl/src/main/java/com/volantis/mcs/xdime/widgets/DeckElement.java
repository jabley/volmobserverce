 ...
 * Deck XDIME element.
 */
public class DeckElement extends WidgetElement implements Loadable {
    /**
    ...
    public void setLoadAttributes(LoadAttributes loadAttributes) {
        getDeckAttributes().setLoadAttributes(loadAttributes);
    }
    
    public DeckAttributes getDeckAttributes() {
        return (DeckAttributes) protocolAttributes;
    }
}
