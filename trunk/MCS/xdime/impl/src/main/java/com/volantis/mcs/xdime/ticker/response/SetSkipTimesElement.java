 ...
 */
public class SetSkipTimesElement extends TickerResponseElement {

    public SetSkipTimesElement(XDIMEContextInternal context) {
        super(TickerResponseElements.SET_SKIP_TIMES, context);
        
        protocolAttributes = new SetSkipTimesAttributes();
    }

    // Javadoc inherited
    public void callOpenOnModule(TickerResponseModule module) throws ProtocolException {
        module.openSetSkipTimes((SetSkipTimesAttributes) protocolAttributes);
    }

    // Javadoc inherited
    public void callCloseOnModule(TickerResponseModule module) throws ProtocolException {
        module.closeSetSkipTimes((SetSkipTimesAttributes) protocolAttributes);
    }
}
