...
/**
 * XHTML V2 Heading6 element object.
 */
public class Heading6Element extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(Heading6Element.class);
    /**
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseHeading6((HeadingAttributes)protocolAttributes);
    }
