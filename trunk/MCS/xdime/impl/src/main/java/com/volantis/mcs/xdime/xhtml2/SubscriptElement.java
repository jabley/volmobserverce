...
/**
 * XHTML V2 Subscript element object.
 */
public class SubscriptElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(SubscriptElement.class);

    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(SubscriptElement.class);

    public SubscriptElement(XDIMEContextInternal context) {
        super(XHTML2Elements.SUB, context);

        protocolAttributes = new SubscriptAttributes();
    }
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseSubscript((SubscriptAttributes)protocolAttributes);
    }
}
