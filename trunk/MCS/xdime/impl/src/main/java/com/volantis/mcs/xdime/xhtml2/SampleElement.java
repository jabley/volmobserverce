...
/**
 * XHTML V2 Sample element object.
 */
public class SampleElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(SampleElement.class);

    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(SampleElement.class);

    public SampleElement(XDIMEContextInternal context) {
        super(XHTML2Elements.SAMP, context);

        protocolAttributes = new SampleAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenSample((SampleAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseSample((SampleAttributes)protocolAttributes);
    }
}
