...
/**
 * XHTML V2 Strong element object.
 */
public class StrongElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(StrongElement.class);

    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(StrongElement.class);

    public StrongElement(XDIMEContextInternal context) {
        super(XHTML2Elements.STRONG, context);

        protocolAttributes = new StrongAttributes();
    }
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseStrong((StrongAttributes)protocolAttributes);
    }
}
