...
/**
 * XHTML V2 Definition Data element object.
 */
public class DefinitionDataElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(DefinitionDataElement.class);
    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(
            DefinitionDataElement.class);

    public DefinitionDataElement(XDIMEContextInternal context) {
        super(XHTML2Elements.DD, context);

        protocolAttributes = new DefinitionDataAttributes();
    }
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseDefinitionData(
            (DefinitionDataAttributes)protocolAttributes);
    }
}
