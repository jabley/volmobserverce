...
/**
 * XHTML V2 Definition List element object.
 */
public class DefinitionListElement extends GenericListElement {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(DefinitionListElement.class);
    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(
            DefinitionListElement.class);

    public DefinitionListElement(XDIMEContextInternal context) {
        super(XHTML2Elements.DL, context);

        protocolAttributes = new DefinitionListAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenDefinitionList(
                (DefinitionListAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseDefinitionList(
            (DefinitionListAttributes)protocolAttributes);
    }
}
