...
public class ValidateElement extends WidgetElement {
    ...
    protected void initialiseElementSpecificAttributes(
        ...
        if (parent instanceof XFInputElementImpl) {
            ...
            // If the 'auto' flag is set, update the input element with 'onblur'
            // event, that will trigger the validate widget. This needs to be done
            // using timers, because without timers the autoFocus feature does not work.
