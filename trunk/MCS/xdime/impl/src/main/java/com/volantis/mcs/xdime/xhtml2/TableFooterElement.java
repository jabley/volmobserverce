...
/**
 * XHTML V2 TableFooter element object.
 */
public class TableFooterElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(TableFooterElement.class);
    
    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(TableHeaderElement.class);

    public TableFooterElement(XDIMEContextInternal context) {
        super(XHTML2Elements.TFOOT, context);

        protocolAttributes = new TableFooterAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenTableFooter((TableFooterAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseTableFooter((TableFooterAttributes)protocolAttributes);
    }
