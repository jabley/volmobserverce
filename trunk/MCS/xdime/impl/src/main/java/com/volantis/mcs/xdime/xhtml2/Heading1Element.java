...
/**
 * XHTML V2 Heading1 element object.
 */
public class Heading1Element extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(Heading1Element.class);
    /**
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseHeading1((HeadingAttributes)protocolAttributes);
    }
