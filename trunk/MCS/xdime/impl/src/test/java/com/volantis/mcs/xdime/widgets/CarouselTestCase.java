 ...
 */
public class CarouselTestCase extends WidgetElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(CarouselAttributes.class);
    }

    protected String getElementName() {
        return WidgetElements.CAROUSEL.getLocalName();
    }
