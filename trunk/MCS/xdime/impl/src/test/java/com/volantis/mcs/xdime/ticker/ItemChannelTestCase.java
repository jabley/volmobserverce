 ...
 */
public class ItemChannelTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(ItemChannelAttributes.class);
    }

    protected String getElementName() {
        return TickerElements.ITEM_CHANNEL.getLocalName();
    }
