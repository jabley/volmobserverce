 ...
 */
public class ItemsCountTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(ItemsCountAttributes.class);
        fakeFeedPoller();        
    }

    protected String getElementName() {
        return TickerElements.ITEMS_COUNT.getLocalName();
    }
