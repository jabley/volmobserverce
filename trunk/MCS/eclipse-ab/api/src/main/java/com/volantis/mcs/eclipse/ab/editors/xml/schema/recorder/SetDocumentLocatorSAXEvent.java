...
/**
 * This class is used to playback a SetDocumentLocator SAXEvent.
 */
class SetDocumentLocatorSAXEvent extends SAXEvent {

    /**
     * Construct a new SetDocumentLocatorSAXEvent
     * @param locator
     */
    public SetDocumentLocatorSAXEvent(Locator locator) {
        super(locator);
    }

    /**
     * 'Playback' the SetDocumentLocator SAXEvent by firing a
     * SetDocumentLocator event in the specified {@link ContentHandler}
     ...
     * a document location
     * @throws SAXException if one was thrown in firing the SetDocumentLocator
