...
public interface TypeDescriptor {
    /**
     * Get the class that this describes.
     *
     * @return The class described by this.
     */
    Class getTypeClass();

    /**
     * Invoke the appropriate visit method on the visitor for the type
     * descriptor.
     *
     * @param visitor The visitor to invoke.
     */
    void accept(TypeDescriptorVisitor visitor);
}
