...
/**
 * Create an object for building class descriptor objects.
 */
public interface BeanDescriptorBuilder {

    /**
     * Add a descriptor for a property with a specific type.
     *
     * @param identifier The identifier of the property.
     * @param descriptor A descriptor of the type of the property.
