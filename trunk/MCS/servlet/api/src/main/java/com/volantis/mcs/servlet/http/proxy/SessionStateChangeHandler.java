...
/**
 * An object that can accept notification of a change in the state of an
 ...
 */
public interface SessionStateChangeHandler {
    /**
     * Notifies of the change of the state of an object stored in the
     * session.
     *
