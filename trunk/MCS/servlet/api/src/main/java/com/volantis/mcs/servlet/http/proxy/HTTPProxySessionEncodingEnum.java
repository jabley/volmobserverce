...
/**
 * Provides enumerations of the different session handling mechanisms that
 * may be used. i.e Cookie, Path or Parameter.
 *
 * NOTE: This file has been copied from the DSB depot. Any changes required in
 * this file may also need to be made in DSB.
 */
public enum HTTPProxySessionEncodingEnum {
    PATH, PARAM, COOKIE
