...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/servlet/HttpStringResponse.java,v 1.3 2003/04/03 14:01:17 sfound Exp $
 * ----------------------------------------------------------------------------
 ...
 * ---------    --------------- -----------------------------------------------
 * 26 Sep 02    Steve           VBM:2002090204 HttpServletResponse implementation
 *                              that captures the response output into a String
 *                              for later retrieval.
 * 20-Mar-03    sumit           VBM:2003031809 - Wrapped logger.debug 
 *                              statements in if(logger.isDebugEnabled()) block
 * 31-Mar-03    Steve      		VBM:2002090204   Removed unused imports
 * ----------------------------------------------------------------------------
 */
...
public class HttpStringResponse implements HttpServletResponse {
    ...
    // Format for date header is "Sun, 06 Nov 1994 08:49:37 GMT"
    ...
    private static final LogDispatcher logger = 
            LocalizationFactory.createLogger(HttpStringResponse.class);
    ...
    public void sendError( int sc, String msg ) throws IOException {
        ...
        getWriter()
            .println( "<html><head><title>" + msg + "</title></head>" + 
                      "<body>" + msg + "</body></html>" );
    }
