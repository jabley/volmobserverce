...
import our.apache.commons.jxpath.ri.compiler.CoreOperationDivide;
import our.apache.commons.jxpath.ri.compiler.Expression;

/**
 * Provides a specialist 'div' operator that correctly handles the expression
 * framework's {@link com.volantis.xml.expression.Value} and java ("boxed")
 * types.
 */
public class JXPathOperationDivide extends CoreOperationDivide implements
        BinaryOperator {
    ...
    /**
     * Initializes a <code>JXPathOperationDivide</code> instance
     * 
     * @param left
     ...
     */
    public JXPathOperationDivide(Expression left, Expression right,
