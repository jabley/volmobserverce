...
import our.apache.commons.jxpath.ri.compiler.CoreOperationLessThanOrEqual;
import our.apache.commons.jxpath.ri.compiler.Expression;

/**
 * Provides a specialist LESS THAN OR EQUAL operator that correctly handles
 * the expression framework's {@link com.volantis.xml.expression.Value} and
 * java ("boxed") types.
 */
public class JXPathOperationLessThanOrEqual
        extends CoreOperationLessThanOrEqual
        implements ValueComparator {

    /**
     * Creates a new <code>JXPathOperationLessThanOrEqual</code> instance.
     * @param left the left operand
     * @param right the right operand
     */
    public JXPathOperationLessThanOrEqual(Expression left,
                                          Expression right) {
        super(left, right);
    }
