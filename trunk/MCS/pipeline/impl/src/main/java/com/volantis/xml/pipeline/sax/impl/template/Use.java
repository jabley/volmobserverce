...
/**
 * This typesafe enumeration defines whether a template parameter binding is
 * mandatory or optional.
 */
public class Use {
    /**
     * The set of all literals. Keyed on the internal string version of the
     * enumeration, mapping to the Use equivalent.
     * <p/>
    ...
    /**
     * A template parameter binding must always be supplied.
     */
    public static final Use REQUIRED = new Use("required");

    /**
     * A template parameter binding is optional.
     */
     ...
     *         not recognized
     */
    public static Use literal(String name) {
        return (Use) entries.get(name);
    }
}
