...
import our.apache.commons.jxpath.ri.compiler.CoreOperationGreaterThan;
import our.apache.commons.jxpath.ri.compiler.Expression;

/**
 * Provides a specialist GREATER THAN operator that correctly handles the
 * expression framework's {@link com.volantis.xml.expression.Value} and java
 * ("boxed") types.
 */
public class JXPathOperationGreaterThan
        extends CoreOperationGreaterThan
        implements ValueComparator {

    /**
     * Creates a new <code>JXPathOperationGreaterThan</code> instance.
     * @param left left operand
     * @param right right operand
     */
    public JXPathOperationGreaterThan(Expression left,
                                      Expression right) {
        super(left, right);
    }
    ...
    public boolean compare(NumericValue left, NumericValue right) {
        return PipelineExpressionHelper
                .compareNumeric(left, right) == CompareResult.LESS_THAN;
    }
