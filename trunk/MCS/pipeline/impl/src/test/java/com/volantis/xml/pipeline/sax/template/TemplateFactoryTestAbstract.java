...
/**
 * Test case for the {@link TemplateFactory} class
 */ 
public abstract class TemplateFactoryTestAbstract extends TestCaseAbstract {

    /**
     * Creates a new <code>TemplateFactoryTestAbstract</code> instance 
     * @param name the name of the test
     */ 
    public TemplateFactoryTestAbstract(String name) {
        super(name);
    }
    
    /**
     * Tests the {@link TemplateFactory#getDefaultInstance} method.
    ...
    public void testGetDefaultInstance() throws Exception {
        ...
        assertEquals("getDefaultInstance should return a " +
                     "TemplateFactoryImpl instance",
                     TemplateFactoryImpl.class,
                     factory.getClass());        
    }    
}
