...
/**
 * This class is used to test that the caching operation is correctly
 * configured when the nested configuration markup is used.
 */
public class NestedCacheConfigurationTestCase extends PipelineTestAbstract {
