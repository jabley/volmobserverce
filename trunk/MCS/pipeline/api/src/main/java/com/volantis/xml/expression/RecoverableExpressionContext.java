...
/**
 * This extension of the ExpressionContext interface provides a common set
 * of methods for those ExpressionContext which must be able to:
 * <ul>
 ...
 */
public interface RecoverableExpressionContext
        extends ExpressionContext, RecoverableTransaction {
}
