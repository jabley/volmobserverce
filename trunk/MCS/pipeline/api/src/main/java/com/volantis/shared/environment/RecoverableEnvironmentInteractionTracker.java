...
/**
 * This extension of the EnvironmentInteractionTracker interface provides a
 * common set of methods for those EnvironmentInteractionTracker which must be
 * able to:
 * <ul>
 ...
 * </ul>
 *
 * @see EnvironmentInteractionTracker
 * @see RecoverableTransaction
 */
public interface RecoverableEnvironmentInteractionTracker
        extends EnvironmentInteractionTracker, RecoverableTransaction {
}
