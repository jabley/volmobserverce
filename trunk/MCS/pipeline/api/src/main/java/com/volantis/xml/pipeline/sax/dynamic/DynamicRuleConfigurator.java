...
/**
 * Encapsulates a set of rules that should be added to the dynamic process
 * configuration.
 *
 ...
 */
public interface DynamicRuleConfigurator {

    /**
     * Add the contained rules to the configuration.
     * @param configuration
     */
