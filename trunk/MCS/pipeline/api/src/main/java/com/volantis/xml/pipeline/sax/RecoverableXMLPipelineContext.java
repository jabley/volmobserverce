...
/**
 * This extension of the XMLPipelineContext interface provides a common set of
 * methods for those XMLPipelineContext which must be able to:
 * <ul>
 * <li> Capture their state at a known instant.
 * <li> Restore the captured state under error conditions.
 * </ul>
 *
 * @see XMLPipelineContext
 * @see RecoverableTransaction
 */
public interface RecoverableXMLPipelineContext
        extends XMLPipelineContext, RecoverableTransaction {
}
