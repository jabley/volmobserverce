...
/**
 * A class for creating template model specific objects.
 *
...
public abstract class TemplateFactory {
    ...
    static {
        metaDefaultFactory =
                new MetaDefaultFactory(
                        "com.volantis.xml.pipeline.sax.impl.template.TemplateFactoryImpl",
     ...
     */
    public static TemplateFactory getDefaultInstance() {
        return (TemplateFactory) metaDefaultFactory.getDefaultFactoryInstance();
    }

    /**
     * Return an encapsulation of all the rules for using the template model in
     * a dynamic pipeline.
