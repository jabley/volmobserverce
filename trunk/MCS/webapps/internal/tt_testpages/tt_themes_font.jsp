...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Font">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_fonts.jsp" styleClass="menu2">Basic Fonts</vt:a><vt:br/>
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_font.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Font' Index page.
It contains links to test pages that cover the theme properties that are in the 'Font' tab in style properties window in the GUI. Properties are:<vt:br/>
- System Font<vt:br/>
- Font Family<vt:br/>
- Font Size<vt:br/>
- Font Style<vt:br/>
- Font Size Adjust<vt:br/>
- Font Weight<vt:br/>
- Font Strech<vt:br/>
- Font Variant<vt:br/>
