...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_list.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'List' Index page.
It contains links to test pages that cover the theme properties that are in the 'List' tab in style properties window in the GUI. Properties are:<vt:br/>
- List Style Image<vt:br/>
- List Style Type<vt:br/>
- List Style Position<vt:br/>
</vt:p>
</vt:pane>
