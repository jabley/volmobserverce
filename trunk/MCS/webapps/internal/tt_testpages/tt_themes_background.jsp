...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Background">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_bgcolor.jsp" styleClass="menu2">Background Colors</vt:a><vt:br/>
	<vt:a href="tt_bgcolor_input.jsp" styleClass="menu2">Input BG Color</vt:a><vt:br/>
	<vt:a href="tt_bgimage.jsp" styleClass="menu2">Background Images</vt:a><vt:br/>
	<vt:a href="tt_bgoffset.jsp" styleClass="menu2">BG Offset</vt:a><vt:br/>
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_background.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Background' Index page.
It contains links to test pages that cover the theme properties that are in the 'Background' tab in style properties window in the GUI. Properties are:<vt:br/>
- Background Color<vt:br/>
- Background Image<vt:br/>
- Background Dynamic Visual<vt:br/>
- Background Attachment<vt:br/>
- Background Position<vt:br/>
- Background Repeat<vt:br/>
</vt:p>
