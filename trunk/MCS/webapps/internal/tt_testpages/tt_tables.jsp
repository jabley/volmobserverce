...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Tables Index Page">
...
<vt:pane name="menu2">
	<vt:a href="tt_table1.jsp" styleClass="menu2">Simple Table Test</vt:a><vt:br/>
	<vt:a href="tt_table2.jsp" styleClass="menu2">Layout Table Test</vt:a><vt:br/>
	<vt:a href="tt_table3.jsp" styleClass="menu2">Table Align Test</vt:a><vt:br/>
	<vt:a href="index.jsp" styleClass="menu2">Main Index</vt:a><vt:br/>
</vt:pane>

<vt:pane name="info">
<vt:p>
	Filename: tt_tables.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This section will test all table related things.
</vt:p>
</vt:pane>
