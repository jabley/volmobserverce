...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Menus Index Page">
...
<vt:pane name="menu2">
	<vt:a href="tt_menu1.jsp" styleClass="menu2">Menu Page 1</vt:a><vt:br/>
	<vt:a href="tt_menu2.jsp" styleClass="menu2">Menu Page 2</vt:a><vt:br/>
	<vt:a href="tt_menu3.jsp" styleClass="menu2">Menu Page 3</vt:a><vt:br/>
	<vt:a href="index.jsp" styleClass="menu2">Main Index</vt:a><vt:br/>
</vt:pane>

<vt:pane name="info">
<vt:p>
	Filename: tt_menus.jsp <vt:br/>
