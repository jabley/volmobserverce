...
<vt:canvas theme="tt_overflow_3" layoutName="standard" pageTitle="Themes: Format" >

<vt:pane name="main2">
<vt:p>
filename: tt_overflow_3.jsp<vt:br/><vt:br/>
theme: tt_overflow_3<vt:br/>
...
Test: canvas {overflow: hidden}<vt:br/>
