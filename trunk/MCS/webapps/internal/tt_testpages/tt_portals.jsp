...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Charts Index Page">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_portal01.jsp" styleClass="menu2">Portal Whitespace</vt:a><vt:br/>
	<vt:a href="tt_portal02.jsp" styleClass="menu2">Canvas Type Test</vt:a><vt:br/>
	<vt:a href="tt_portal03.jsp" styleClass="menu2">Nested Region Test</vt:a><vt:br/>
	<vt:a href="tt_portal04.jsp" styleClass="menu2">Theme Inheritence</vt:a><vt:br/>
	<vt:a href="tt_portal05.jsp" styleClass="menu2">Portlet Alignment</vt:a><vt:br/>
	<vt:a href="index.jsp" styleClass="menu2">Main Index</vt:a><vt:br/>
</vt:pane>

<vt:pane name="info">
<vt:p>
	Filename: tt_portals.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This section will test portal and portlet issues such as theme inheritence.
</vt:p>
</vt:pane>
