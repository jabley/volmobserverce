...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Frame">
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_frame.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Frame' Index page. 
It contains links to test pages that cover the theme properties that are in the 'Frame' tab in style properties window in the GUI. Properties are:<vt:br/>
- Image Repeat Count<vt:br/>
- Image Frame Interval<vt:br/>
- Image Initial Frame<vt:br/>
</vt:p>
</vt:pane>
