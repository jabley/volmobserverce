...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Devices Index Page">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_protocol.jsp" styleClass="menu2">Device Recognition</vt:a><vt:br/>
	<vt:a href="../dc/index.jsp" styleClass="menu2">Device Capture URL</vt:a><vt:br/>
	<vt:a href="tt_accesskeys.jsp" styleClass="menu2">Access Keys</vt:a><vt:br/>
	<vt:a href="tt_tvmodesets.jsp" styleClass="menu2">Wap TV Modesets</vt:a><vt:br/>
	<vt:a href="tt_tvdynvis.jsp" styleClass="menu2">TV Dynvis Element</vt:a><vt:br/>
	<vt:a href="tt_tvlocalsrc.jsp" styleClass="menu2">Wap TV Localsrc</vt:a><vt:br/>

	<vt:a href="tt_cache1.jsp" styleClass="menu2">Page Cache</vt:a><vt:br/>
...
<vt:pane name="main">
<vt:p>
This section tests various device specific issues.
</vt:p>
</vt:pane>
