...
<vt:pane name="fileinfo">
  <vt:h1>Sample Element Test</vt:h1>
  <vt:p>Filename: tt_samp1.jsp<vt:br/>
...
<vt:pane name="header">
  <vt:h3>Purpose</vt:h3>
  <vt:p>This test is to ensure the vt:samp tag works.</vt:p>
  <vt:pre>
     samp
  </vt:pre>
  <vt:h3>Devices</vt:h3>
  ...
  <vt:p>A page should be created with some sample text. This is normally displayed in monospace font, but depends on browser. </vt:p>
</vt:pane>
