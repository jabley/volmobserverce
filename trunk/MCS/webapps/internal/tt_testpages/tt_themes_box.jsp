...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Box">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_margins.jsp" styleClass="menu2">Margins</vt:a><vt:br/>
	<vt:a href="tt_padding.jsp" styleClass="menu2">Padding</vt:a><vt:br/>
	<vt:a href="tt_display.jsp" styleClass="menu2">Display</vt:a><vt:br/>
	<vt:a href="tt_lineheight.jsp" styleClass="menu2">Line Height</vt:a><vt:br/>
	<vt:a href="tt_height.jsp" styleClass="menu2">Height</vt:a><vt:br/>
	<vt:a href="tt_width.jsp" styleClass="menu2">Width</vt:a><vt:br/>
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_box.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Box' Index page. 
It contains links to test pages that cover the theme properties that are in the 'Box' tab in style properties window in the GUI. Properties are:<vt:br/>
- Margin Width<vt:br/>
- Padding Width<vt:br/>
- Display<vt:br/>
- Line Height<vt:br/>
