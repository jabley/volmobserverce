...
-->
<%-- ==========================================================================
 % $Header: /src/voyager/webapp/internal/webtest/TextFormTags.jsp,v 1.1 2001/12/27 15:55:02 jason Exp $
 % ============================================================================
 ...
 % =========    =============== ===============================================
 % 08-Oct-01    Doug            VBM:2001091006 - Created to test the stylistic
 %                              tag attributes on classic forms.
 % ======================================================================= --%>
...
<vt:textarea rows="10" cols="20" pane="databasetypeentry" name="trivial1"></vt:textarea>

<vt:p pane="sourcelabel">Source label.</vt:p>

<vt:textinput size="20" pane="sourceentry" name="trivial">Source entry: </vt:textinput>

<vt:p pane="userlabel">User label.</vt:p>

<vt:textinput pane="userentry" name="username">Login username: </vt:textinput>

<vt:p pane="passwordlabel">Password label.</vt:p>

<vt:textinput size="10" pane="passwordentry" name="password" type="password">Please
