...
-->
<%-- ==========================================================================
 % $Header: /src/voyager/webapp/internal/webtest/papi/ImageTest1.jsp,v 1.1 2001/12/27 15:55:02 jason Exp $
 % ============================================================================
...
<%-- ==========================================================================
 % This page tests the image element works inside a paragraph.
 % ======================================================================= --%>
...
<%
  ...
  if (result == PAPIElement.PROCESS_ELEMENT_BODY) {
    paragraphElement.elementContent (ppc, paragraphAttributes,
                                     "Text in paragraph 1 before image. ");

    ImageAttributes imageAttributes = new ImageAttributes ();
    ImageElement imageElement = new ImageElement ();

    imageAttributes.setSrc ("stars0");
    imageAttributes.setAltText ("Alternate text");
    imageElement.elementStart (ppc, imageAttributes);
    imageElement.elementEnd (ppc, imageAttributes);
    imageElement.elementReset (ppc);

    imageAttributes.setSrc ("null");
    imageAttributes.setAltText ("Alternate text");
    imageElement.elementStart (ppc, imageAttributes);
    imageElement.elementEnd (ppc, imageAttributes);
    imageElement.elementReset (ppc);
