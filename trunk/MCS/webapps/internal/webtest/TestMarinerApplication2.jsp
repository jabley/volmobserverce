...
-->
<%-- ==========================================================================
 % $Header: /src/voyager/webapp/internal/webtest/TestMarinerApplication2.jsp,v 1.4 2002/11/22 23:48:17 pduffin Exp $
 % ============================================================================
...
<%-- ==========================================================================
 % This page tests that the MarinerServletApplication can be created before the
 % Volantis bean. It must be run in a newly started instance of the
...
<%-- Create the mariner servlet application first. --%>
...
<%-- Create the volantis bean second. --%>
