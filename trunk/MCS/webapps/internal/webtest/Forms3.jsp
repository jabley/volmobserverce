...
<vt:canvas layoutName="Forms2">

<vt:p pane="preamble"> Same page as Forms2.jsp but now with a submit image
stars </vt:p>
...
<vt:select multiple="true" menuStyle="true" labelPane="selectlabel1" entryPane="selectentry1"
                    name="select1" default="Unknown" label="Database Type:"><vt:option value="oracle">Oracle</vt:option>
