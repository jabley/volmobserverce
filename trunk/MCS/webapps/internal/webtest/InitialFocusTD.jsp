...
<%-- ==========================================================================
 ...
 % =========    =============== ===============================================
 % 21-May-03    Byron           VBM:2003051903 - Created this jsp page that
 %                              should test the intialFocus on a TD element.
 % ======================================================================= --%>
...
<do type='prev'>
 ...
 <%
     for (int i=1;i<=7;i++) {
         ...
         if (focused.equals(index) && !focusDone) {
             focusDone = true;
 %>
        <vt:td styleClass="calendar" tabindex="<%=index%>" id="<%=index%>">
            <vt:span styleClass="darkbluedarkpinkfocused"><%=index%></vt:span>
        </vt:td>
<%
         } else {
%>
        <vt:td styleClass="calendarGrey" tabindex="<%=index%>" id="<%=index%>">
           <vt:span styleClass="grey"><%=index%></vt:span>
        </vt:td>
