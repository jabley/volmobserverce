...
-->
<%-- ==========================================================================
 % $Header: /src/voyager/webapp/internal/webtest/MamlFragForm.jsp,v 1.1 2002/03/19 13:54:48 sfound Exp $
 % ----------------------------------------------------------------------------
...
<%
  ...
  parser.parse( "http://localhost:8080/volantis/maml/fragform.xml" );
 jspContext.release();
%>
