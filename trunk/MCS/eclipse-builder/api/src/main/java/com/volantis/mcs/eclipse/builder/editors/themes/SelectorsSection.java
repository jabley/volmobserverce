...
public class SelectorsSection extends FormSection implements InteractionFocussable {
    ...
    private static IStructuredContentProvider CONTENT_PROVIDER =
            new ListProxyContentProvider();

    private static final ObjectParser SELECTOR_PARSER =
    ...
    private static final CSSParser CSS_PARSER =
            CSS_PARSER_FACTORY.createLaxParser();

    private static final Image SELECTOR_IMAGE = EclipseCommonMessages.
            getPolicyIcon("sequenceSelector");
    ...
    public SelectorsSection(Composite composite, int i,
    ...
    private final InteractionChangeAdapter tableRefresher =
            new InteractionChangeAdapter() {
    ...
    private void createRuleTable(Composite parent) {
        ...
        // TODO later support multi-select
        Table table = new Table(tableComposite, SWT.SINGLE | SWT.H_SCROLL |
                SWT.V_SCROLL | SWT.FULL_SELECTION);
        data = new GridData(GridData.FILL_BOTH);
        data.heightHint = EditorMessages.getInteger(RESOURCE_PREFIX +
                "tableMinHeight").intValue();
        table.setLayoutData(data);
        final TableColumn sequenceColumn = new TableColumn(table, SWT.LEFT);
        sequenceColumn.setText(EditorMessages.getString(RESOURCE_PREFIX +
                "sequenceColumn.title"));

        final TableColumn orderColumn = new TableColumn(table, SWT.LEFT);
        orderColumn.setText(EditorMessages.getString(RESOURCE_PREFIX +
                "orderColumn.title"));
    ...
    private void createActions() {
        ...
        deleteAction.setText(EditorMessages.getString(
                RESOURCE_PREFIX + "deleteAction.text"));
    }
    ...
    private void createButtons(Composite parent) {
        ...
        buttonComposite.setBackground(getDisplay().
                getSystemColor(SWT.COLOR_LIST_BACKGROUND));
        buttonComposite.setLayoutData(new GridData(GridData.
    ...
    private void createContextMenu() {
        // TODO later create a context menu...
    }
...
/*
 ...
 31-Oct-05	9886/7	adrianj	VBM:2005101811 New themes GUI

 28-Oct-05	9886/5	adrianj	VBM:2005101811 New theme GUI
