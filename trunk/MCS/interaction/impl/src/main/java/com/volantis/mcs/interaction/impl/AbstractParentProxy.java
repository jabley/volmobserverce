...
public abstract class AbstractParentProxy
        extends AbstractProxy
        implements InternalParentProxy {

    protected AbstractParentProxy(InteractionModel interactionModel) {
        super(interactionModel);
    }

    public void buildPath(PathBuilder builder, Proxy childProxy) {
        if (parent != null) {
            parent.buildPath(builder, this);
        }

        addStepToPath(builder, childProxy);
    }

    protected abstract void addStepToPath(
            PathBuilder builder, Proxy childProxy);
}
