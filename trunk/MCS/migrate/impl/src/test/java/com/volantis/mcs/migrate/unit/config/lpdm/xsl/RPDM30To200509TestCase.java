 ...
 */
public class RPDM30To200509TestCase
        extends TestCaseAbstract {

    public static Test suite() {
        MigrationTestSuiteBuilder builder =
                new MigrationTestSuiteBuilder("/com/volantis/mcs/migrate/impl/config/lpdm/xsl/rpdm-v30-to-200509.xsl",
                "30_lpdm_files/", "200509_lpdm_files/");
