...
/**
 * Default implementation of {@link ResourceIdentifierBuilder}.
 */
public class DefaultResourceIdentifierBuilder
        implements ResourceIdentifierBuilder {

    /**
     * The resource identifier we are building.
     */
     ...
     * Initialise.
     */
    public DefaultResourceIdentifierBuilder() {

        resourceRecogniser = new DefaultResourceIdentifier();
    }

    // Javadoc inherited.
    public void addTypeIdentifier(TypeIdentifier type) {

        resourceRecogniser.addType(type);
    }

    // Javadoc inherited.
    public ResourceIdentifier getCompletedResourceIdentifier() {

        return resourceRecogniser;
    }
