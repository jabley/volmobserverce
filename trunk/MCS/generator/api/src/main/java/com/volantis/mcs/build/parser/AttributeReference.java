...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/build/parser/AttributeReference.java,v 1.2 2002/03/18 12:41:13 ianw Exp $
 * ----------------------------------------------------------------------------
...
/**
 * This class is a reference to a Attribute and once the schema has
 * been parsed behaves just like the attribute to which it refers. It is
 * not valid to call any of the SchemaAttribute methods until the
 * schema has been parsed as the attribute to which it refers may not
...
public class AttributeReference
  ...
  public AttributeDefinition getDefinition () {
    if (definition == null) {
      definition = enclosingScope.getAttributeDefinition (name);
    }
