...
/**
 * A container of value(s).
 */
public interface ValueContainer {

    /**
     * Add a value to the container.
     * <p>This will throw an exception if the value is not allowed, e.g. if you
     * try and add a value to a container that can only contain one item.</p>
     * @param value
     */
