...
/**
 * Implementation of a percentage value.
 */
public class PercentageValueImpl implements PercentageValue {
    /**
     * The percentage value for this instance.
     */
    ...
    public void writeConstructCode(String indent, PrintStream out) {
        out.print(indent);
        out.print("styleValueFactory.getPercentage(null, ");
