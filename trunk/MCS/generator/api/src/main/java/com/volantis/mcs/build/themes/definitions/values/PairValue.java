...
/**
 * Representation of a pair of values.
 */
public interface PairValue extends Value {

    /**
     * Sets the first child value.
     * @param newFirst The first child value
     */
    public void setFirst(Value newFirst);

    /**
     * Sets the second child value.
     * @param newSecond The second child value
     */
