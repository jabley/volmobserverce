...
/**
 * An implementation of an angle value.
 */
public class AngleValueImpl implements AngleValue {
    /**
     * The units property for the angle.
     */
    ...
    public void writeConstructCode(String indent, PrintStream out) {
        out.print(indent);
        out.print("styleValueFactory.getAngle(null, ");
        out.print(angle);
        out.print(", AngleUnit.");
