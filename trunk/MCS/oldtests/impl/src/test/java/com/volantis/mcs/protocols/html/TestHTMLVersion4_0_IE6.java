 ...
 */
public class TestHTMLVersion4_0_IE6 extends HTMLVersion4_0_IE6
        implements HTMLVersion4_0Testable {

    public TestHTMLVersion4_0_IE6(ProtocolSupportFactory supportFactory,
     ...
     */
    public void setUpCssEmulation(boolean emulate) {
        if (emulate) {
            // At the moment the only css property we need to emulate is
            // css2's border-spacing
