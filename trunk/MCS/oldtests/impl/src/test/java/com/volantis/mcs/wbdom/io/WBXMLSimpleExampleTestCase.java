...
/**
 * A {@link WBDOMWBSAXTestCaseAbstract} which uses the test data from 
 * {@link SimpleWBXMLExampleTestData}.
 */ 
public class WBXMLSimpleExampleTestCase extends WBDOMWBSAXTestCaseAbstract {
    ...
    public WBXMLSimpleExampleTestCase(String s) {
        super(s);
    }
