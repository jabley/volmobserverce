...
/**
 * Tests the holding of configuration information about style sheets.
 */
public class StyleSheetsConfigTestCase extends TestCaseAbstract {

    /**
     * Initialise a new instance of this test case.
     */
    public StyleSheetsConfigTestCase() {
    }
     ...
     */
    public StyleSheetsConfigTestCase(String s) {
        super(s);
    }

    /**
     * Test the set/get methods for the external cache configuration
     */
