...
/**
 * This class unit test the XHTMLBasic_Netfront3 protocol.
 */
public class XHTMLBasic_Netfront3TestCase
    extends XHTMLBasicTestCase {

    protected final static String PANE_CLASS = "VE-pane";

    private XHTMLBasic_Netfront3 protocol;
    private XHTMLBasicTestable testable;

    private TestMarinerPageContext context;
    
    public XHTMLBasic_Netfront3TestCase(String name) {
        super(name);
    }
