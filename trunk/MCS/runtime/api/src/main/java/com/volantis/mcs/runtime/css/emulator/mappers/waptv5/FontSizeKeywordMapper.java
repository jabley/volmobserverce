...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/css/emulator/mappers/waptv5/FontSizeKeywordMapper.java,v 1.2 2002/07/29 16:01:28 ianw Exp $
 * ----------------------------------------------------------------------------
...
public class FontSizeKeywordMapper
    ...
    protected FontSizeKeywordMapper() {
        addMapping(FontSizeKeywords.XX_SMALL, "6");
        addMapping(FontSizeKeywords.X_SMALL, "8");
        addMapping(FontSizeKeywords.SMALL, "10");
        addMapping(FontSizeKeywords.MEDIUM, "12");
        addMapping(FontSizeKeywords.LARGE, "14");
        addMapping(FontSizeKeywords.X_LARGE, "16");
        addMapping(FontSizeKeywords.XX_LARGE, "18");
