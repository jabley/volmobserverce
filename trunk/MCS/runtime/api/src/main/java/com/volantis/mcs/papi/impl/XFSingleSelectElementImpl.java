...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/papi/XFSingleSelectElement.java,v 1.4 2003/03/12 16:10:43 sfound Exp $
 * ----------------------------------------------------------------------------
...
/**
 * The xfsiselect element.
 */
public class XFSingleSelectElementImpl
        extends XFSelectElementImpl {

    /**
     * Create a new <code>XFSingleSelectElement</code>.
     */
    public XFSingleSelectElementImpl() {
        super(false);
    }
}
