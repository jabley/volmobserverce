...
/**
 * Holds properties specific to TickerTapeElement.
 */
public class TickerTapeAttributes extends WidgetAttributes {
    ...
    /**
     * Gets refresh attributes. If no refresh attributes are present, this
     * returns null.
     */
