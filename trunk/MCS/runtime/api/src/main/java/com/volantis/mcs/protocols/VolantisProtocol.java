...
//    this style then code from WMLRoot need to be pulled up.
    ...
    */
    ...
    /**
     * If form is fragmented then the action is intercepted and re-routed to
    ...
    protected String resolveFormAction(XFFormAttributes attributes) {
        ...
        if (attributes != null) {
            ...
            if (form != null && form.isFragmented()) {
                ...
                // use later.
                storeFragmentedFormURL(resolvedLink,
                        getFormSpecifier(attributes));
            } else {
    ...
    protected void storeFragmentedFormURL(String linkToTransform,
        ...
        // Get the context path URL which is environment dependent.
        final String contextPath = context.getEnvironmentContext().
                getContextPathURL().getExternalForm();
        ...
        if (urlToTransform.containsDocumentRelativePath()) {
            ...
            final String relativeURL = urlToTransform.getPath();
            if (relativeURL.startsWith(contextPath)) {
                transformedLink =
        ...
        SessionFormData sessionData = context.getFormDataManager().
