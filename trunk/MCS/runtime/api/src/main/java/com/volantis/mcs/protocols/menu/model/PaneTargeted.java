...
/**
 * Represents entities that can be (optionally) targeted at a pane.
 */ 
public interface PaneTargeted {
    /**
     * Returns the pane this menu entry is (optionally) targeted at.
     *
     * @return a pane reference or null if the menu entry is not explicitly
     *         targeted
     */
    FormatReference getPane();
}
