...
/**
 * This interface allows the dissector to access meta information about the
 * document that is not in the dissectable document.
 */
public interface DocumentInformation {
    ...
    /**
     * Get the location of this document, this is used to create the shard
     * links.
