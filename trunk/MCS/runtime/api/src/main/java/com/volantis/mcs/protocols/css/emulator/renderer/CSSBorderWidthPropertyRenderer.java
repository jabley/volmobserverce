...
/**
 * This class is responsible for providing a renderer for border-width
 * properties.
 */
public class CSSBorderWidthPropertyRenderer extends AbstractCSSPropertyRenderer {
     ...
     */
    public CSSBorderWidthPropertyRenderer(String propertyName) {
        super(propertyName);
    }
