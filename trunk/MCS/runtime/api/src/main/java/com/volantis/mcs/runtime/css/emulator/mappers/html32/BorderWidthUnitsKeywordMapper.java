...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/css/emulator/mappers/html32/BorderWidthUnitsKeywordMapper.java,v 1.3 2002/05/14 15:37:47 adrian Exp $
 * ----------------------------------------------------------------------------
 ...
 */
public class BorderWidthUnitsKeywordMapper
    ...
    static {
        ...
        singleton = new BorderWidthUnitsKeywordMapper();
    }
    ...
    protected BorderWidthUnitsKeywordMapper() {
        addMapping(BorderWidthKeywords.THIN, "1");
        addMapping(BorderWidthKeywords.MEDIUM, "2");
        addMapping(BorderWidthKeywords.THICK, "3");
    }
}
