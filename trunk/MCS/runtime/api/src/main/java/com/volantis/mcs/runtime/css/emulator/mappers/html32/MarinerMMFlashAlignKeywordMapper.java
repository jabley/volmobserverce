...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/css/emulator/mappers/html32/MarinerMMFlashAlignKeywordMapper.java,v 1.3 2002/05/14 15:37:47 adrian Exp $
 * ----------------------------------------------------------------------------
 ...
 *                              render Flash align values appropriate to the
...
import com.volantis.mcs.themes.properties.MCSMMFlashAlignKeywords;
 ...
 */
public class MarinerMMFlashAlignKeywordMapper
    ...
    static {
        ...
        singleton = new MarinerMMFlashAlignKeywordMapper();
    }
    ...
    protected MarinerMMFlashAlignKeywordMapper() {
        addMapping(MCSMMFlashAlignKeywords.BOTTOM, "b");
        addMapping(MCSMMFlashAlignKeywords.CENTER, "c");
        addMapping(MCSMMFlashAlignKeywords.LEFT, "l");
        addMapping(MCSMMFlashAlignKeywords.RIGHT, "r");
        addMapping(MCSMMFlashAlignKeywords.TOP, "t");
    }
}
