...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/text/TextOutputBuffer.java,v 1.3 2002/12/12 16:10:17 geoff Exp $
 * ----------------------------------------------------------------------------
 ...
 * ---------    --------------- -----------------------------------------------
 * 27-Nov-02    Geoff           VBM:2002103005 - Created from code refactored 
 *                              out of SMS.  
 * 12-Dec-02    Geoff           VBM:2002120903 - Fix bug with getLogicalWriter
 *                              where I forgot to allocate writers.
 * ----------------------------------------------------------------------------
 */
package com.volantis.mcs.protocols.text;

import com.volantis.mcs.protocols.StringOutputBuffer;

import java.io.Writer;

/**
 * An output buffer for text protocols. This deals with the fact that text 
 * protocols differ from markup protocols in that: 
 * <ul>
 *   <li>they need to remove a lot of excess whitespace from the original body 
 *      text of elements.
 *   <li>they need to add back whitespace to simulate the effects of markup
 *      elements.
 * </ul>
 * Note: we are subclassing the "deprecated" String version of OutputBuffer
 * because it suits our purpose. Possibly I should have cloned it, but I
 * think this can wait until we decide to remove the string protocol stuff; 
 * how to do it should be clearer then.
 * <p>
 * Note: a TextOutputBuffer operating in preformatted mode behaves just like
 * a StringOutputBuffer; but I haven't taken advantage of this fact because I'm
 ...
 * <p>
 * @todo all the writers should really be pooled, but I'm running out of time...
 */ 
public class TextOutputBuffer extends StringOutputBuffer {
