...
public abstract class AbstractDocumentVisitor
    ...
    public AbstractDocumentVisitor(DissectableDocument document) {
    ...
    protected abstract void visitDocumentImpl(DissectableDocument document)
        throws DissectionException;

    public void visitRootElement(DissectableDocument document)
        throws DissectionException {
