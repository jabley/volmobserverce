...
public class PaneRuleBuilder
        extends AbstractSimpleFormatRuleBuilder {

    public PaneRuleBuilder(
    ...
    protected void initialiseStyleProperties(
        ...
        // A pane is a CSS block.
        initialiseCommonProperties(styleProperties, format,
                DisplayKeywords.BLOCK);

        // Padding is common between panes and grids but is treated differently
        // on the two.
        setPadding(styleProperties, format);
    }
}
