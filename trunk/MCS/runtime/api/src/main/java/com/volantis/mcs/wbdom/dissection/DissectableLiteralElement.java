...
/**
 * A dissectable {@link LiteralNameElement}.
 * <p>
 ...
 * dissector.
 */ 
public class DissectableLiteralElement extends LiteralNameElement 
    ...
    public DissectableLiteralElement(StringReference reference) {
        super(reference);
    }

    // Inherit Javadoc.
    public boolean isAtomic() {
        // For now, we consider that literal elements can never be atomic.
        return false;
    }
