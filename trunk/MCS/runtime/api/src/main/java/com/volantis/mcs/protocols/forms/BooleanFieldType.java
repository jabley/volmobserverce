...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/forms/BooleanFieldType.java,v 1.4 2003/04/17 10:21:07 geoff Exp $
 * ----------------------------------------------------------------------------
 ...
 *                              type specific behaviour of a boolean field.
...
/**
 * This class defines the behaviour of boolean fields.
 */
public final class BooleanFieldType
        implements FieldType {

    /**
     * The reference to the single allowable instance of this class.
     */
    private static final BooleanFieldType singleton;

    // Initialise the static fields.
    static {
        // Always initialise to prevent a synchronization problem if we do it
        // lazily.
        singleton = new BooleanFieldType();
    }
     ...
     */
    public static BooleanFieldType getSingleton() {
        return singleton;
    }
    ...
    public void doField(
        ...
        protocol.doBooleanInput((XFBooleanAttributes) attributes);
    }
