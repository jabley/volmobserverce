...
/**
 * Renders a 'vertical-align' style value as one of the emulated attribute
 * values 'top', 'middle' or 'bottom'.
 * <p>
 * This class is suitable for use with both WML and HTML 3.2 as they share
 * the same values for vertical align.
 */
public class DefaultVerticalAlignEmulationAttributeValueRenderer
    ...
    public String render(StyleValue value) {
        ...
        String result = null;
        if (value == VerticalAlignKeywords.TOP ||
                value == VerticalAlignKeywords.MIDDLE ||
                value == VerticalAlignKeywords.BOTTOM) {
