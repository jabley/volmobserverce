...
/**
 * Locates project configuration files and loads them.
 *
 * @mock.generate
 */
public interface ProjectLoader {
    ...
    /**
     * Load the project that is contains the requested URL.
     * @param url
     * @param optimizer
     */
    RuntimeProjectConfiguration loadProjectConfiguration(
