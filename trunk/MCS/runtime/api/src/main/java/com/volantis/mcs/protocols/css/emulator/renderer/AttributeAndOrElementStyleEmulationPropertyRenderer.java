...
/**
 * This class is responisible for providing a wrapper for
 * {@link StyleEmulationPropertyRenderer} instances that wish to be
 * identified as renderers that use attributes and/or elements to achive
 * emulation of style properties.
 */
public class AttributeAndOrElementStyleEmulationPropertyRenderer
     ...
     */
    public AttributeAndOrElementStyleEmulationPropertyRenderer(
