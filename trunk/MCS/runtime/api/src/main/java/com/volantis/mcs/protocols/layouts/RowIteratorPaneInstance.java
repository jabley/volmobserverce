...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/RowIteratorPaneInstance.java,v 1.3 2002/03/18 12:41:17 ianw Exp $
 * ----------------------------------------------------------------------------
...
/**
 * Contains all the state associated with a RowIteratorPane in a particular
 * MarinerPageContext.
 *
 * @mock.generate base="IteratorPaneInstance"
 */
public class RowIteratorPaneInstance
        extends IteratorPaneInstance {

    /**
     * The attributes which are passed to the RowIteratorPane related
     * protocol methods.
     */
    private final RowIteratorPaneAttributes attributes;
    ...
    /**
     * Get the attributes which are passed to the RowIteratorPane related
     * protocol methods.
     * @return The attributes which are passed to the RowIteratorPane related
     * protocol methods.
     */
