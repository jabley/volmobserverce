...
/**
 * The default implementation of the {@link MenuModelBuilderFactory} that
 * creates default {@link MenuModelBuilder} implementation instances.
 */
public class ConcreteMenuModelBuilderFactory
    extends MenuModelBuilderFactory {
    // javadoc inherited
    public MenuModelBuilder createBuilder() {
