...
/**
 * An interface which all VDXML style values implement. For now just acts
 * as a marker interface apart from accepting the related visitor.
 */ 
public interface VDXMLStyleValue {

    /**
     * Accept the VDXML style visitor into this style value.
     * 
     * @param visitor the visitor to accept.
     */ 
    void accept(VDXMLStyleValueVisitor visitor);
}
