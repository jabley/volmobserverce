...
/**
 * This is the IE specialisation of the HTMLVersion4_0. It only needs to
 * set the CSS emulation properties up correctly.
 */
public class HTMLVersion4_0_IE extends HTMLVersion4_0 {

    public HTMLVersion4_0_IE(ProtocolSupportFactory supportFactory,
