...
/**
 * A {@link WBDOMElement} with a literal name.
 * <p>
 * This corresponds to a WBSAX element beginning with
 * {@link com.volantis.mcs.wbsax.GlobalToken#LITERAL}, etc.
 */ 
public class LiteralNameElement extends WBDOMElement
...
/**
     ...
     */ 
    public LiteralNameElement(StringReference name) {
        this.name = name;
    }
