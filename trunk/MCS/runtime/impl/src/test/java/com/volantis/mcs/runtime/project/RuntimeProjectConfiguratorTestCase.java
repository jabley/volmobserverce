 ...
 */
public class RuntimeProjectConfiguratorTestCase
    ...
    public void testGlobal() throws Exception {
        ...
        final RemotePolicySourceMock remotePolicySourceMock =
                new RemotePolicySourceMock("remotePolicySourceMock",
                        expectations);
        ...
        policySourceFactoryMock.expects.createRemotePolicySource("")
                .returns(remotePolicySourceMock);
    ...
    public void testBuildProject() throws Exception {
        ...
        final RuntimePolicySourceFactoryMock policySourceFactoryMock =
                new RuntimePolicySourceFactoryMock("policySourceFactoryMock",
                        expectations);
        ...
        urlMapperMock.expects
                .mapInternalURLToExternalPath(getClassRelativeResourceURLAsString(
                        "a/"))
                .returns("/project/a/mcs-project.xml");

        String directory = getClassRelativeResourceURLAsString("a/")
                .substring("file:".length());
        policySourceFactoryMock.expects.createXMLPolicySource(directory)
                .returns(xmlPolicySourceMock);
