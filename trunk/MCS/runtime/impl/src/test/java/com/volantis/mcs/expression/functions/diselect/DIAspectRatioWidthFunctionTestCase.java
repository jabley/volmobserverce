...
import com.volantis.mcs.expression.functions.diselect.DIAspectRatioWidthFunction;
import com.volantis.mcs.expression.functions.diselect.DIAspectRatioFunctionTestCase;

/**
 * Defines tests which should be run for {@link DIAspectRatioWidthFunction}
 */
public class DIAspectRatioWidthFunctionTestCase
   ...
   /**
    ...
    public DIAspectRatioFunction getFunction() {
        return new DIAspectRatioWidthFunction();
    }
}
