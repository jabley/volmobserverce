...
import com.volantis.mcs.expression.functions.diselect.DIColorIndexFunction;
...
/**
 * Defines tests which should be run for {@link DIColorIndexFunction}.
 */
public class DIColorIndexFunctionTestCase
