...
public class SummaryDefaultRenderer extends WidgetDefaultRenderer {
    ...
    public void doRenderOpen(VolantisProtocol protocol,
        ...
        StyleValue markerValue = getFoldedMarkerValue(protocol, attributes);
        String foldedMarkerId = renderFoldedMarker(protocol, 
        		markerValue != null ? markerValue : foldingItemContext.getFoldedMarkerValue()
        				, DEFAULT_FOLDED_MARKER); 

        // the same scenario for unfolded
        StyleValue unfoldedMarkerValue = getUnfoldedMarkerValue(protocol, attributes);
        String unfoldedMarkerId = renderUnfoldedMarker(protocol, 
        		markerValue != null ? unfoldedMarkerValue : foldingItemContext.getUnfoldedMarkerValue()
        				, DEFAULT_UNFOLDED_MARKER); 
