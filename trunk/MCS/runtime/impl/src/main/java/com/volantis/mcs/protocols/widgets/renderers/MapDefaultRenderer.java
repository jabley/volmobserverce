...
public class MapDefaultRenderer extends WidgetDefaultRenderer
     ...
     */
    private static final String GOOGLE_PHOTO_HOST = "kh1.google.com";
     ...
     */
    private static final String GOOGLE_MAP_PARAMETERS = "mt?v=w2.52";

    /**
     * mandatory part of sattelite image request
     */
    private static final String GOOGLE_PHOTO_PARAMETERS = "kh?v=18";
