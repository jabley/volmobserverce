...
/**
 * Encapsulates those properties of a ScriptAsset which uniquely identify it.
 ...
 */
public class ScriptAssetIdentity
  ...
  /**
   * Create a new <code>ScriptAssetIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ScriptAssetIdentity (Project project,
                              String name,
                              String deviceName) {
    super(project, name);
   ...
   * @param name  The name of the object.
   */
  public ScriptAssetIdentity (String name,
                              String deviceName) {
    super(null, name);
  ...
  public boolean equals (Object object) {
    ...
    ScriptAssetIdentity identity = (ScriptAssetIdentity) object;
