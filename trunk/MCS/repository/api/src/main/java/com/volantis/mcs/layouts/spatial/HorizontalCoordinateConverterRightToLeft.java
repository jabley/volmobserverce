...
/**
 * A {@link CoordinateConverter} that traverses horizontally, right to left,
 * first and then vertically.
 */
public class HorizontalCoordinateConverterRightToLeft
     ...
     */
    public HorizontalCoordinateConverterRightToLeft(int width, int height) {
        super(width, height);
    }
