 ...
 * @see PolicyFactory#createCategoryReference(String)
 * @since 3.5.1
 */
public interface CategoryReference {

    /**
     * Get the name of the category being referenced.
     *
     * @return The name of the category being referenced.
     */
    String getCategoryName();

    /**
     * Two category references are equal if the contained category names are
     * equal.
     */
    boolean equals(Object object);

    /**
     * The hash code of the category reference is the hash code of the category
     * name.
     */
    int hashCode();
}
