...
/**
 */
public interface SelectionBuilderVisitor {

    void visit(DefaultSelectionBuilder selection);

    void visit(EncodingSelectionBuilder selection);

    void visit(GenericImageSelectionBuilder selection);

    void visit(TargetedSelectionBuilder selection);
}
