...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/repository/WrappedRepositoryConnection.java,v 1.1 2002/09/10 09:37:17 mat Exp $
 * ----------------------------------------------------------------------------
 ...
 * ---------    --------------- -----------------------------------------------
 * 10-Jul-02    Mat             VBM:2002040825 - An interface for repository
 *                              connections that wrap other repository
 *                              connections
 * ----------------------------------------------------------------------------
 */
...
public interface WrappedRepositoryConnection {
     ...
     */
    public RepositoryConnection getWrappedRepositoryConnection()
