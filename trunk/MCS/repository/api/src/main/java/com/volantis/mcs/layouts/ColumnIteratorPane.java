...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/layouts/ColumnIteratorPane.java,v 1.41 2003/04/17 10:21:06 geoff Exp $
 * ----------------------------------------------------------------------------
 ...
 * normal Pane, a ColumnIteratorPane holds its content as a set of elements.
 * These are written out as the columns in a table. ColumnIteratorPanes allow
 * support where the exact number of output elements is not known prior to run
 * time but where row formatting is required on each element.
 *
 * @mock.generate base="IteratorPane"
 */
public class ColumnIteratorPane
  extends IteratorPane {

  /**
   * Create a new column iterator pane
   * @param canvasLayout The Layout to which this pane belongs
   */
  public ColumnIteratorPane (CanvasLayout canvasLayout) {
    super (canvasLayout);
  }

  public FormatType getFormatType () {
    return FormatType.COLUMN_ITERATOR_PANE;
  }
