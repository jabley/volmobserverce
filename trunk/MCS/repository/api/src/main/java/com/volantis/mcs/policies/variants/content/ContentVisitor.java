...
public interface ContentVisitor {
    ...
    void visit(AutoURLSequence content);

    void visit(EmbeddedContent content);

    void visit(LayoutContent content);

    void visit(ThemeContent content);

    void visit(URLContent content);
}
