...
/**
 * Encapsulates those properties of a RolloverImageComponent which uniquely
 * identify it.
 ...
 */
public class RolloverImageComponentIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>RolloverImageComponentIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public RolloverImageComponentIdentity (Project project,
                                         String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public RolloverImageComponentIdentity (String name) {
    super(null, name);
  }

  // Javadoc inherited from super class.
  public Class getObjectClass () {
    return RolloverImageComponent.class;
  }
}
