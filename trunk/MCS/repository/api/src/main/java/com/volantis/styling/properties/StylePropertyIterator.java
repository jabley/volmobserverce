...
/**
 * Iterates over a contained sequence of {@link StyleProperty}s.
 */
public interface StylePropertyIterator {

    /**
     * Iterate over the contained sequence of {@link StyleProperty}.
     *
     * @param iteratee The object that will be invoked for each
     * {@link StyleProperty}.
     */
    IterationAction iterateStyleProperties(StylePropertyIteratee iteratee);

    /**
     * Get an external iterator over the contained sequence of
     * {@link StyleProperty}s.
     *
     * @return An iterator over a sequence of {@link StyleProperty}.
     */
    Iterator stylePropertyIterator();
}
