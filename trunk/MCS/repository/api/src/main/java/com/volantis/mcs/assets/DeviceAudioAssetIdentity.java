...
/**
 * Encapsulates those properties of a DeviceAudioAsset which uniquely identify
 * it.
 ...
 */
public class DeviceAudioAssetIdentity
  extends AbstractRepositoryObjectIdentity
  implements RepositoryObjectDeviceIdentity {

  /**
   * the deviceName of this asset.
   */
  private String deviceName;

  /**
   * Create a new <code>DeviceAudioAssetIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public DeviceAudioAssetIdentity (Project project,
                                   String name,
                                   String deviceName) {
    super(project, name);
   ...
   * @param name  The name of the object.
   */
  public DeviceAudioAssetIdentity (String name,
                                   String deviceName) {
    super(null, name);
  ...
  public boolean equals (Object object) {
    ...
    DeviceAudioAssetIdentity identity = (DeviceAudioAssetIdentity) object;
