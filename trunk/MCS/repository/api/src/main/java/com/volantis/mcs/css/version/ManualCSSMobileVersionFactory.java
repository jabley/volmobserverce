...
/**
 * Creates a correct definition of CSS Mobile by using the generated CSS Mobile
 ...
 */
public class ManualCSSMobileVersionFactory
    ...
    public DefaultCSSVersion createCSSVersion() {
        ...
        DefaultCSSVersion version =
                new CSSMobileVersionFactory().createCSSVersion();

        // These values cobbled from the old CSSMobile PseudoSelectorRenderer
        // I have checked them against http://www.w3.org/TR/css-mobile.
        version.addPseudoSelectorId( new String[] {
                "active", "focus", "link", "visited"
        });

        // CSSMobile doesn't have any restricted shorthand properties.
        // I have checked this against http://www.w3.org/TR/css-mobile.
