 ...
 */
public interface StylePropertyIteratee {

    /**
     * Called for each {@link StyleProperty} in the sequence being iterated.
     *
     * @param property The {@link StyleProperty} to process.
     *
     * @return A value that determines whether the iteration stops or continues
     * onto the next {@link StyleProperty}.
     */
    IterationAction next(StyleProperty property);
}
