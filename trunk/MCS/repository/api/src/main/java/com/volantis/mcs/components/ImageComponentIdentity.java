...
/**
 * Encapsulates those properties of a ImageComponent which uniquely identify
 * it.
 ...
 */
public class ImageComponentIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>ImageComponentIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ImageComponentIdentity (Project project,
                                 String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public ImageComponentIdentity (String name) {
    super(null, name);
  }
