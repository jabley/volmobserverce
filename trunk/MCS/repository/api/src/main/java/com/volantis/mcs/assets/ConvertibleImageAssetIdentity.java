...
/**
 * Encapsulates those properties of a ConvertibleImageAsset which uniquely
 * identify it.
 ...
 */
public class ConvertibleImageAssetIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>ConvertibleImageAssetIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ConvertibleImageAssetIdentity (Project project,
                                        String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public ConvertibleImageAssetIdentity (String name) {
    super(null, name);
  }

  // Javadoc inherited from super class.
  public Class getObjectClass () {
    return ConvertibleImageAsset.class;
  }
}
