...
public class StyleIntegerTypeImpl
        extends AbstractSingleStyleType
    implements StyleIntegerType {

    public StyleIntegerTypeImpl() {
        super(StyleValueType.INTEGER);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleIntegerType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleInteger integer = (StyleInteger) value;
