...
/**
 * Represents an invalid pseudo class selector.
 */
public class DefaultInvalidPseudoClassSelector
        extends DefaultPseudoClassSelector {

    /**
     * Initialize a new instance.
     */
    public DefaultInvalidPseudoClassSelector() {
        super(PseudoClassTypeEnum.INVALID);
    }

    // Javadoc inherited.
    protected PseudoClassSelector copyImpl() {
        return new DefaultInvalidPseudoClassSelector();
    }
}
