...
/**
 * Base class for {@link PolicySource}.
 */
public abstract class AbstractPolicySource
        implements PolicySource {

    /**
     * The reader to use for accessing policies in this source.
     */
    private final PolicyBuilderReader reader;
     ...
     */
    public AbstractPolicySource(PolicyBuilderReader reader) {
        this.reader = reader;
    }
