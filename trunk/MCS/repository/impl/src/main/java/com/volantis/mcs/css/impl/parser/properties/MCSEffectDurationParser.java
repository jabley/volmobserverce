...
/**
 * Parser for the mcs-effect-duration property.
 */
public class MCSEffectDurationParser
    ...
    static {
        ...
        supportedTypes.add(StyleValueType.TIME);
     ...
     * Initialise.
     */
    public MCSEffectDurationParser(PropertyParserFactory factory) {
        super(StylePropertyDetails.MCS_EFFECT_DURATION, ITEM_CONVERTER, true);
    }
