...
/**
 * Parser for the border-color shorthand property.
 */
public class BorderColorParser
    extends GenericAllEdgeParser {
     ...
     *                properties.
     */
    public BorderColorParser(PropertyParserFactory factory) {
        super(factory.getValueConverter(StylePropertyDetails.BORDER_TOP_COLOR),
