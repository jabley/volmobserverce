...
/**
 * Represents a pseudo class selector of the form :after
 */
public class DefaultAfterSelector extends DefaultPseudoElementSelector {

    /**
     * Initialize a new instance.
     */
    public DefaultAfterSelector() {
        super(PseudoElementTypeEnum.AFTER);
    }

    // Javadoc inherited.
    protected PseudoElementSelector copyImpl() {
        return new DefaultAfterSelector();
    }
}
