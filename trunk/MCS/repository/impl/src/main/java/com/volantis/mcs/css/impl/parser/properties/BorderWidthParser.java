...
/**
 * Parser for the border-width shorthand property.
 */
public class BorderWidthParser
     ...
     *                properties.
     */
    public BorderWidthParser(PropertyParserFactory factory) {
        super(factory.getValueConverter(StylePropertyDetails.BORDER_TOP_WIDTH),
