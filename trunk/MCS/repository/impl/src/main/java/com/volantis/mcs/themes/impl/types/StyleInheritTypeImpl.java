...
public class StyleInheritTypeImpl
        extends AbstractSingleStyleType
    implements StyleInheritType {

    public StyleInheritTypeImpl() {
        super(StyleValueType.INHERIT);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleInheritType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleInherit inherit = (StyleInherit) value;
