...
/**
 * Represents a pseudo class selector of the form :before
 */
public class DefaultBeforeSelector extends DefaultPseudoElementSelector {

    /**
     * Initialize a new instance.
     */
    public DefaultBeforeSelector() {
        super(PseudoElementTypeEnum.BEFORE);
    }

    // Javadoc inherited.
    protected PseudoElementSelector copyImpl() {
        return new DefaultBeforeSelector();
    }
}
