...
/**
 * Test the parser for border-style.
 */
public class BorderStyleParserTestCase
        extends GenericAllEdgeTestCaseAbstract {

    /**
     * Initialise.
     */
    public BorderStyleParserTestCase() {
        super("border-style",
              new String[] {"dashed", "dotted", "double", "groove"},
              new StyleValue[] {
                  BorderStyleKeywords.DASHED,
                  BorderStyleKeywords.DOTTED,
                  BorderStyleKeywords.DOUBLE,
                  BorderStyleKeywords.GROOVE,
              },
