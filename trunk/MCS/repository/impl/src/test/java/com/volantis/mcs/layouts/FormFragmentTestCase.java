...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/testsuite/unit/com/volantis/mcs/layouts/FormFragmentTestCase.java,v 1.2 2003/03/26 15:32:13 aboyd Exp $
 * ----------------------------------------------------------------------------
 ...
 * ---------    --------------- -----------------------------------------------
 * 20-Feb-03    Allan           VBM:2003021803 - A testcase for FormFragment. 
 ...
 */
public class FormFragmentTestCase 
    extends FormatTestAbstract {

    // javadoc inherited
    protected Format createTestableFormat() {
        return new FormFragment(new CanvasLayout());
    }
}
