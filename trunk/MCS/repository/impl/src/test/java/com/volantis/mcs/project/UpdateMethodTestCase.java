 ...
 */
public class UpdateMethodTestCase
    ...
    protected void invokeFailingMethod(
        ...
        accessor.updatePolicyBuilder(connectionMock, projectMock,
                policyBuilderMock);
    }
    ...
    protected void invokeOkMethod(
        ...
        accessorMock.expects
                .updatePolicyBuilder(connectionMock, projectMock,
                        policyBuilderMock).returns(true);

        // =====================================================================
        //   Test Expectations
        // =====================================================================

        boolean updated = accessor.updatePolicyBuilder(connectionMock,
                projectMock, policyBuilderMock);
        assertTrue(updated);
    }
}
