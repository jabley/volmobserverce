...
/**
 * Test the parser for border-color.
 */
public class BorderColorParserTestCase
        extends GenericAllEdgeTestCaseAbstract {

    /**
     * Initialise.
     */
    public BorderColorParserTestCase() {
        super("border-color", new String[] {"red", "green", "blue", "yellow"},
              new StyleValue[] {
                  StyleColorNames.RED,
                  StyleColorNames.GREEN,
                  StyleColorNames.BLUE,
                  StyleColorNames.YELLOW,
              },
