...
import com.volantis.shared.metadata.type.immutable.ImmutableCollectionType;

/**
 * This interface represents a Unordered Set Policy Type.
 * 
 ...
 *
 * @deprecated Use {@link ImmutableCollectionType} instead.
 */
public interface SetPolicyType extends CompositePolicyType {
    
    /**
     * This method returns the {@link PolicyType} of the contained
     * Policies of the Set.
     * 
     * @return The {@link PolicyType} of the memebers.
     */
