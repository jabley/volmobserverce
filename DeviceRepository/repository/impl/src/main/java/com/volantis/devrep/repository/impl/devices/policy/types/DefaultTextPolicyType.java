...
/**
 * Default implementation of {@link com.volantis.mcs.devices.policy.types.TextPolicyType}.
 */ 
public class DefaultTextPolicyType
        extends DefaultPolicyType
        implements TextPolicyType {
     ...
     */
    private static final ImmutableStringType DEFAULT_STRING_TYPE;

    // Initialise the default meta data type.
    static {
        MutableStringType type = TYPE_FACTORY.createStringType();
        DEFAULT_STRING_TYPE = (ImmutableStringType) type.createImmutable();
    }
