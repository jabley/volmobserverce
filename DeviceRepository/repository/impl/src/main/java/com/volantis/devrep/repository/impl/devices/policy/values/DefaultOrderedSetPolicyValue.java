...
/**
 * This class provides the default implementation of an Ordered Set Policy
 * Value.
 */
public class DefaultOrderedSetPolicyValue
        extends DefaultSetPolicyValue
        implements OrderedSetPolicyValue {
     ...
     */
    public DefaultOrderedSetPolicyValue(PolicyType memberType,
                                        String valueString)
