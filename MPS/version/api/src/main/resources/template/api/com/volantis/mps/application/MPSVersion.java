...
public class MPSVersion {
     ...
     */
    private static final int versionMajor = @major.version@;

    /**
     * Part of the current version number.
     */
    private static final int versionMinor = @minor.version@;

    /**
     * Part of the current version number.
     */
    private static final int versionRevision = @revision.version@;

    /**
     * Part of the current version number.
     */
    private static final String versionPatchLevel = "@patch.version@";

    /**
     * The product name.
     */
    private static final String PRODUCT_NAME = "@short.product.name@";

    /**
     * Part of the version number for the minimum required version of MCS.
     */
    private static final int MCSMinimumVersionMajor = @mcs.major.version@;

    /**
     * Part of the version number for the minimum required version of MCS.
     */
    private static final int MCSMinimumVersionMinor = @mcs.minor.version@;

    /**
     * Part of the version number for the minimum required version of MCS.
     */
    private static final int MCSMinimumVersionRevision = @mcs.revision.version@;
