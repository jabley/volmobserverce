...
public class RemoteMessageService implements MessageService {
    ...
    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
            LocalizationFactory
                    .createExceptionLocalizer(RemoteMessageService.class);
     ...
     */
    private InputStream getObjectsAsXMLInputStream(
            ModelParser parser, SendRequest sendRequest) {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        parser.write(sendRequest, new BufferedOutputStream(out));
        final ByteArrayInputStream result =
     ...
     * @throws MessageServiceException if there was a problem.
     */
    private void doPOST(HttpURLConnection connection, InputStream inputXML)
            throws MessageServiceException {
        try {
