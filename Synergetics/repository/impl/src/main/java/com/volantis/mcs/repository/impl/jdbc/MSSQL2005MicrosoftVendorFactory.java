...
public class MSSQL2005MicrosoftVendorFactory
        extends AbstractVendorFactory {

    public MSSQL2005MicrosoftVendorFactory() {
        super(JDBCRepositoryType.MSSQL_2005);
    }
    ...
    public String getDriverSpecificURL(MCSDriverConfiguration configuration)
        ...
        url = "jdbc:" + JDBCRepositoryType.MSSQL_2005.getSubProtocol() +
                ":sqlserver://" + host + ":" + port +
                ";DatabaseName=" + source + ";SelectMethod=cursor";
