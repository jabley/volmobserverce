...
public class BinaryContentInput implements ContentInput {
    private final InputStream inputStream;

    public BinaryContentInput(InputStream inputStream) {
    ...
    public Reader getReader() {
        throw new IllegalStateException("Binary content has no reader.");
    }
}
