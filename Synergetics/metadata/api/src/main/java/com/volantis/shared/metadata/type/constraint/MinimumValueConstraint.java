...
/**
 * Constrains the minimum value of a {@link NumberType} value.
 *
 * <p>If this is inclusive then the meta data value must be greater than or
 * equal to the value of this constraint, otherwise it must be greater than
 * this constraint.</p>
 *
 * <p>
 ...
 */
public interface MinimumValueConstraint
