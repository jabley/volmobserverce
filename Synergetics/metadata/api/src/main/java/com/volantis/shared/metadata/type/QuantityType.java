 ...
 * A quantity type.
 *
 * <p>A quantity consists of a magnitude (number) and a unit. A quantity type
 * can restrict both the allowable values for the magnitude and the unit.</p>
 *
 * <p>
...
public interface QuantityType
    ...
    /**
     * Get the type of the magnitude.
     *
     * @return The type of the magnitude.
     */
