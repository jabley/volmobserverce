...
/**
 * Implementation of {@link MutableTestInhibitor}. 
 */
final class MutableTestInhibitorImpl
        extends TestInhibitorImpl
        implements MutableTestInhibitor {
     ...
     */
    public MutableTestInhibitorImpl(TestInhibitor value) {
        super(value);
    }
     ...
     */
    public MutableTestInhibitorImpl() {
    }
}
