...
/**
 * Implementation of {@link ImmutableChoiceValue}.
 */
final class ImmutableChoiceValueImpl
        extends ChoiceValueImpl
        implements ImmutableChoiceValue, Serializable,
     ...
     */
    public ImmutableChoiceValueImpl(ChoiceValue value) {
        super(value);
    }
     ...
     */
    protected ImmutableChoiceValueImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_CHOICE_VALUE;
    }
