...
/**
 * Implementation of {@link MutableQuantityType}.
 */
class MutableQuantityTypeImpl
        extends QuantityTypeImpl
        implements MutableQuantityType {
     ...
     */
    public MutableQuantityTypeImpl(QuantityType type) {
        super(type);
    }
     ...
     */
    public MutableQuantityTypeImpl() {
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.MUTABLE_QUANTITY_TYPE;
    }
}
