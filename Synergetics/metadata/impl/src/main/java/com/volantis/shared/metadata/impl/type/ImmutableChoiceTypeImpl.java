...
/**
 * Implementation of {@link ImmutableChoiceType}.
 */
final class ImmutableChoiceTypeImpl
        extends ChoiceTypeImpl
        implements ImmutableChoiceType, Serializable,
     ...
     */
    public ImmutableChoiceTypeImpl(ChoiceType type) {
        super(type);
    }
     ...
     */
    protected ImmutableChoiceTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_CHOICE_TYPE;
    }
}
