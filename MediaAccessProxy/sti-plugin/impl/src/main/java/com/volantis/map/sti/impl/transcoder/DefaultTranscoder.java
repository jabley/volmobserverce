        ...
        try {
            ...
            if (responseBody.hasFault()) {
                ...
                throw new TranscoderException("soap-response-with-fault",
                        new Object[]{
                                fault.getFaultCodeAsName(), fault.getFaultString()},
                        null);
                ...
                if (!transcodingRequest.getOperationID().equals(
                    ...
                    LOGGER.error("invalid-operationID", new Object[]{
                            transcodingResponse.getOperationID(),
...
//                            inputStream = new BufferedInputStream(inputStream);
                            ...
                            try {
                                ...
                                if (LOGGER.isDebugEnabled()) LOGGER.debug("unexpected-ioexception", e);
