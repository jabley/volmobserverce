 ...
 */
public class DefaultAgentParameters implements MutableParameters {
    private final Properties params;

    public DefaultAgentParameters() {
    ...
    public boolean getBoolean(final String name) throws MissingParameterException {
        checkParameter(name);
        return Boolean.valueOf(params.getProperty(name)).booleanValue();
    }
