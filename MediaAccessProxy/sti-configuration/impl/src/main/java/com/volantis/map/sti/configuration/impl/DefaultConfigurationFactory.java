...
/**
 * Default implementation of ConfigurationFactory.
 * <p>
 * Reads all configuration values from system properties.
 */
public class DefaultConfigurationFactory extends ConfigurationFactory {
    // Javadoc inherited.
    public Configuration createConfiguration(Dictionary config) {
