 ...
 */
public class TitleElement extends TickerResponseElement {

    public TitleElement(XDIMEContextInternal context) {
        super(TickerResponseElements.TITLE, context);
        
        protocolAttributes = new TitleAttributes();
    }

    // Javadoc inherited
    public void callOpenOnModule(TickerResponseModule module) throws ProtocolException {
        module.openTitle((TitleAttributes) protocolAttributes);
    }

    // Javadoc inherited
    public void callCloseOnModule(TickerResponseModule module) throws ProtocolException {
        module.closeTitle((TitleAttributes) protocolAttributes);
    }
}
