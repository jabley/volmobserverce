...
public class SetPollingIntervalElement extends TickerResponseElement {
    ...
    public void callOpenOnModule(TickerResponseModule module) throws ProtocolException {
        module.openSetPollingInterval((SetPollingIntervalAttributes) protocolAttributes);
    }

    // Javadoc inherited
    public void callCloseOnModule(TickerResponseModule module) throws ProtocolException {
        module.closeSetPollingInterval((SetPollingIntervalAttributes) protocolAttributes);
    }
}
