...
/**
 * XHTML V2 Cite element object.
 */
public class CiteElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(CiteElement.class);

    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(CiteElement.class);


    public CiteElement(XDIMEContextInternal context) {
        super(XHTML2Elements.CITE, context);

        protocolAttributes = new CiteAttributes();
    }
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseCite((CiteAttributes)protocolAttributes);
    }
}
