...
/**
 * XHTML V2 Address element object.
 */
public class AddressElement extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(AddressElement.class);
    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(AddressElement.class);

    public AddressElement(XDIMEContextInternal context) {
        super(XHTML2Elements.ADDRESS, context);

        protocolAttributes = new AddressAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenAddress((AddressAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseAddress((AddressAttributes)protocolAttributes);
    }
