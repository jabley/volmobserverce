 ...
 */
public class ItemDisplayTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(ItemDisplayAttributes.class);
    }

    protected String getElementName() {
        return TickerElements.ITEM_DISPLAY.getLocalName();
    }
