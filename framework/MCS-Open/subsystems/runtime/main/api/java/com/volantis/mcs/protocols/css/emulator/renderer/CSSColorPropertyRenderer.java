...
/**
 * This class is responsible for providing a renderer for border-color
 * properties.
 */
public class CSSColorPropertyRenderer extends AbstractCSSPropertyRenderer {
     ...
     */
    public CSSColorPropertyRenderer(String propertyName) {
        super(propertyName);
    }

    // Javadoc inherited.
    protected void setKeywordMapper(RendererContext renderContext) {
        // No keyword mapper necessary for color.
    }
}
