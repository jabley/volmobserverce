...
/**
 * A VDXML style property for background color (attribute "CF").
 */ 
public class VDXMLBackgroundColorProperty 
     ...
     */ 
    public VDXMLBackgroundColorProperty(VDXMLColorValue value) {
        initialise("CF", value);
    }
}
