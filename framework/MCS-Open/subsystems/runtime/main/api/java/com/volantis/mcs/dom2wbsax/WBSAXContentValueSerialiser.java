 ...
 * ---------    --------------- -----------------------------------------------
 * 30-May-03    Mat             VBM:2003042911 - Created to add content
...
/**
 * A value serialiser for element content.
 */
public class WBSAXContentValueSerialiser extends WBSAXValueSerialiser {
     ...
     */ 
    public WBSAXContentValueSerialiser(WBSAXProcessorContext context) {
        super(context);
    }
    ...
    public void addString(char[] chars, int offset, int length)
        ...
        context.getContentHandler().addContentValue(
    ...
    public void addEntity(char c)
        ...
        context.getContentHandler().addContentValueEntity(new EntityCode(c));
    ...
    public void addExtensionString(Extension code, char[] chars, int offset,
        ...
        context.getContentHandler().addContentValueExtension(code,
                context.getStrings().create(chars, offset, length));
