...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/css/emulator/mappers/html32/MarinerMMFlashYScaledAlignKeywordMapper.java,v 1.1 2002/05/14 09:03:31 adrian Exp $
 * ----------------------------------------------------------------------------
 ...
 */
public class MarinerMMFlashYScaledAlignKeywordMapper
    ...
    static {
        ...
        singleton = new MarinerMMFlashYScaledAlignKeywordMapper();
    }
    ...
    protected MarinerMMFlashYScaledAlignKeywordMapper() {
        addMapping(MCSMMFlashYScaledAlignKeywords.TOP, "t");
        addMapping(MCSMMFlashYScaledAlignKeywords.CENTER, "center");
        addMapping(MCSMMFlashYScaledAlignKeywords.BOTTOM, "b");
    }
}
