...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/html/xhtmltransitional/XHTMLTransitionalTransVisitor.java,v 1.2 2003/01/15 12:42:10 philws Exp $
 * ----------------------------------------------------------------------------
...
import com.volantis.mcs.protocols.html.xhtmlfull.XHTMLFullTransVisitor;
 ...
 */
public class XHTMLTransitionalTransVisitor extends XHTMLFullTransVisitor {

    protected XHTMLTransitionalTransVisitor(DOMProtocol protocol,
    ...
    protected String[] getPromotePreserveStyleAttributes() {
        ...
        final String[] attributes =
            {"align", "bgcolor", "border", "cellpadding", "cellspacing", "dir",
