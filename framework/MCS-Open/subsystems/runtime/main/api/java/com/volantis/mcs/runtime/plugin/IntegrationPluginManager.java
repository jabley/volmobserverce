...
/**
 * Base interface for classes that manager integration plugins.
 */
public interface IntegrationPluginManager {

    /**
     * Create the plugins that are part of the application scope.
     */
