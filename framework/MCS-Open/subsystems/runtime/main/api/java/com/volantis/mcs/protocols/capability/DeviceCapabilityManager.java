...
public class DeviceCapabilityManager {
     ...
     * CSS capabilities
     */
    private final DeviceCSSCapability cssCapability = new DeviceCSSCapability();
     ...
     * element. Will return null if there are no capabilities for given element.
     */
    public DeviceElementCapability getDeviceElementCapability(String element) {
        return getDeviceElementCapability(element, false);
    }
    ...
    /**
     * Get the device CSS capabilities
     * @return the device CSS capabilities.
     */
    public DeviceCSSCapability getDeviceCSSCapability() {
        return cssCapability;
    }
