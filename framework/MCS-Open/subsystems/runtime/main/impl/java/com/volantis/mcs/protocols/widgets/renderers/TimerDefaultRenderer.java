...
public class TimerDefaultRenderer extends ClockDefaultRenderer {
    ...
    public static final ScriptModule WIDGET_TIMER = createAndRegisterWidgetClock();

    private static ScriptModule createAndRegisterWidgetClock() {
        Set dependencies = new HashSet();
        dependencies.add(WIDGET_CLOCK_COMMON);
        ScriptModule module = new ScriptModule("/vfc-timer.mscr", dependencies,
                5400, true);
	...
	protected void doRenderOpen(VolantisProtocol protocol,
        ...
        require(WIDGET_TIMER, protocol, attributes);
