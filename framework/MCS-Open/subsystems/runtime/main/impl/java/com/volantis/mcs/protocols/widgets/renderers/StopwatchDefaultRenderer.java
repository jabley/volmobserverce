...
public class StopwatchDefaultRenderer extends ClockDefaultRenderer {
    ...
    public static final ScriptModule WIDGET_STOPWATCH = createAndRegisterWidgetClock();

    private static ScriptModule createAndRegisterWidgetClock() {
        Set dependencies = new HashSet();
        dependencies.add(WIDGET_CLOCK_COMMON);
        ScriptModule module = new ScriptModule("/vfc-stopwatch.mscr", dependencies,
                5400, true);
	...
	protected void doRenderOpen(VolantisProtocol protocol,
        ...
        require(WIDGET_STOPWATCH, protocol, attributes);
