...
public class PolicyEditorContext extends EditorContext {
    ...
    /**
     * Carry out any processing to be carried out on a loaded policy before it
     * is wrapped by the proxy and registered for validation.
     *
    ...
    protected PolicyBuilder preProcessPolicy(PolicyBuilder loadedPolicy) {
        // By default no processing is required, so we simply return the
        // original policy
        return loadedPolicy;
    }
