...
public interface Listeners {
    ...
    /**
     * Create an immutable {@link Listeners}.
     */
    public ImmutableListeners createImmutableListeners();

    /**
     * Create a mutable {@link Listeners}.
     *
    ...
    /**
     * Iterate over the container listeners.
     *
     * @param iteratee The object to invoke for each listener.
     */
    void iterate(ListenerIteratee iteratee);
}
