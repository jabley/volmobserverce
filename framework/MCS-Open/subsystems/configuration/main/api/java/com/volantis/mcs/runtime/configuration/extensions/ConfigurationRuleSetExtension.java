...
/**
 * Implement this interface to allow custom modifications to the mcs
 * configuration file.
 */
public interface ConfigurationRuleSetExtension extends Extension {

    /**
     * Add new rules (digester) to the mcs-config process configuration
     * section
     */
