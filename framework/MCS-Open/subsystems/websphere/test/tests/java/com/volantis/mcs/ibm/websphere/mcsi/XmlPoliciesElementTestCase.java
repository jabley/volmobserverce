 ...
 */
public class XmlPoliciesElementTestCase
    ...
    public void testElement() throws Exception {
        ...
        attrs.setDirectory(POLICY_SOURCE);
        ...
        String policySource =
                ((XMLPolicySource) parent.getPolicySource()).getDirectory();
        assertEquals("BaseUrl has unexpected value", POLICY_SOURCE,
                policySource);
    }
}
