 ...
 */
public class TestXHTMLMobile1_0 extends XHTMLMobile1_0
        implements XHTMLBasicTestable {

    public TestXHTMLMobile1_0(ProtocolSupportFactory supportFactory,
    ...
    public void renderMenuItemSeparator(DOMOutputBuffer dom, String separatorCharacters,
                                        int separatorRepeat) {
