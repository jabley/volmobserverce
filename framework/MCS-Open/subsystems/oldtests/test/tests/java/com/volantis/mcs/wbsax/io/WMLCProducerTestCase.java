 ...
 * ---------    --------------- -----------------------------------------------
 * 20-May-03    Steve           VBM:2003042908 - Created
 ...
 * based on test data provided by {@link WMLCExampleTestData}.
 */ 
public class WMLCProducerTestCase extends WBXMLExpandedProducerTestCase {
    ...
    public WMLCProducerTestCase(String s) {
        super(s);
    }
