...
public interface TypeDescriptorVisitor {
    ...
    void visit(BeanClassDescriptor descriptor);

    void visit(ListClassDescriptor descriptor);

    void visit(BaseClassDescriptor descriptor);

    void visit(OpaqueClassDescriptor descriptor);
}
