...
/**
 * Fired when a proxy item is removed from a list proxy.
 */
public class RemovedFromListEvent
        extends ListRangeEvent {
     ...
     */
    public RemovedFromListEvent(ListProxy listProxy,
                                int firstItemIndex,
                                int lastItemIndex,
                                boolean originator) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof RemovedFromListEvent);
    }
}
