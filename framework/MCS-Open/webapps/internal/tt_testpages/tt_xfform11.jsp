...
<!--  *************************************************************************
	...
	Name  	Date  		Comment
	MJ	03/03/2002	Created this file
...
<vt:pane name="fileinfo">
  <vt:h1>Xfform Menu Theme Test</vt:h1>
  <vt:p>Filename: tt_xfform11.jsp<vt:br/>
...
<vt:pane name="header">
  <vt:h3>Purpose</vt:h3>
  <vt:p>This test is to ensure menu fields can utilise theme styles.
  </vt:p>
<vt:pre>
     xfform       name, action, prompt
     xfsiselect   name, caption, captionPane, entryPane, help, prompt, (style alteredmenufont)
     xfmuselect   name, caption, captionPane, entryPane, help, prompt, (style alteredmenufont)
  ...
  <vt:p>The fields should have font styles applied to them. 
  </vt:p>
