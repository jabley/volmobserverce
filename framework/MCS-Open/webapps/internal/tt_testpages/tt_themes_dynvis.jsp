...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Dyn Vis">
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_dynvis.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Dyn Vis' Index page.
It contains links to test pages that cover the theme properties that are in the 'Dyn Vis' tab in style properties window in the GUI. Properties are:<vt:br/>
</vt:p>
