...
<!--
 ! This XSLT adds additional templates in order to allows the diselect Module
 ! to be unit tested.
 !-->
<xsl:stylesheet version="1.0"
    ...
    <xsl:include href="../diselect-module.xsl"/>

    <xsl:template mode="get-style" match="xh2:div">
        <css:style>
