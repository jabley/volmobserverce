...
/**
 * Constrains the maximum value of a {@link NumberType} value.
 *
 * <p>If this is inclusive then the meta data value must be less than or equal
 * to the value of this constraint, otherwise it must be less than this
 * constraint.</p>
 *
 * <p>
 ...
 */
public interface MaximumValueConstraint
