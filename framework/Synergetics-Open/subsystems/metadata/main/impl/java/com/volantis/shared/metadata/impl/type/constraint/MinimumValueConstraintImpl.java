...
/**
 * Implementation of {@link MinimumValueConstraint}.
 */
abstract class MinimumValueConstraintImpl
        extends RangeConstraintImpl
        implements MinimumValueConstraint {
     ...
     */
    protected MinimumValueConstraintImpl(MinimumValueConstraint constraint) {
        super(constraint);
    }
     ...
     */
    protected MinimumValueConstraintImpl() {
        super();
    }

    public ImmutableInhibitor createImmutable() {
        return new ImmutableMinimumValueConstraintImpl(this);
    }

    public MutableInhibitor createMutable() {
        return new MutableMinimumValueConstraintImpl(this);
    }

    // Javadoc inherited.
    public boolean equals(Object other) {
        return (other instanceof MinimumValueConstraint)
                ? equalsRangeConstraint((MinimumValueConstraint) other)
                : false;
    }
}
