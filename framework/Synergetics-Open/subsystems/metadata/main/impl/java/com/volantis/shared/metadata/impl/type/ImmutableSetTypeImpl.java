...
/**
 * Implementation of {@link ImmutableSetType}.
 */
final class ImmutableSetTypeImpl
        extends SetTypeImpl
        implements ImmutableSetType, Serializable,
        ImmutableMetaDataTypeVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = 8606753671471508626L;
     ...
     */
    public ImmutableSetTypeImpl(SetType value) {
        super(value);
    }
     ...
     */
    protected ImmutableSetTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_SET_TYPE;
    }
}
