...
/**
 * Matches if all the contained values match.
 *
 * <p>This is equivalent to the && operator in that it fails as soon as the
 * first contained value fails, otherwise it succeeds. It always succeeds if it
 * is empty.</p>
 */
public class AllExpectedValues
