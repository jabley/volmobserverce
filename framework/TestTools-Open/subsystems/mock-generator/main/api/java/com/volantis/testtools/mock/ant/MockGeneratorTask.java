...
//        this.uptodateFile = uptodateFile;
    }
...
//                // Create the file beforehand, as otherwise it doesn't prevent
//                // targets being rebuilt.
//                long time = System.currentTimeMillis();
//                if (uptodateFile.exists()) {
//                    uptodateFile.setLastModified(time);
//                } else {
//                    FileUtils.getFileUtils().createNewFile(uptodateFile, true);
//                }
