...
/**
 * Exception which indicates a problem with the supplied {@link Address}.
 *
...
public class MalformedAddressException extends Exception {
    ...
    /**
     * Constructs a new MalformedAddressException with null as its detail
    ...
    /**
     * Constructs a new MalformedAddressException with the specified detail
     * message. The cause is not initialized and may be subsequently be
     * initialized with a call to {@link #initCause(Throwable)}
     *
    ...
    /**
     * Constructs a new MalformedAddressException with the specified cause and
    ...
    /**
     * <p>Constructs a new MalformedAddressException with the specified detail
     * message and cause.</p>
