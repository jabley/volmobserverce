...
/**
 * Used to indicate that the external ID was not found
 */
public class ResourceDescriptorNotFoundException extends Exception {
    ...
    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
        LocalizationFactory.createExceptionLocalizer(
            ResourceDescriptorNotFoundException.class);
     ...
     */
    public ResourceDescriptorNotFoundException(
     ...
     * @param t
     */
    public ResourceDescriptorNotFoundException(Throwable t) {
        super(t);
    }
