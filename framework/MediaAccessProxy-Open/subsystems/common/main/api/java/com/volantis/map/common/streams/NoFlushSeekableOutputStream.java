 ...
 */
public class NoFlushSeekableOutputStream implements SeekableOutputStream {

    /**
     * Used to localize the messages in exceptions
     */
    private static final ExceptionLocalizer EXCEPTION_LOCALIZER =
        LocalizationFactory.createExceptionLocalizer(NoFlushSeekableOutputStream.class);
    ...
    /**
     * The ImageOutputStream to delegate to
     * @param ios
     */
    public NoFlushSeekableOutputStream(OutputStream ios) throws IOException {
        if (null == ios) {
            throw new IllegalArgumentException(
                EXCEPTION_LOCALIZER.format("argument-is-null", "ios"));
        }

        outputStream =ImageIO.createImageOutputStream(ios);
    ...
    /**
     * Flush the underlying delegate
     * @throws IOException
     */
    public void flushDelegate() throws IOException {
        this.outputStream.flushBefore(getFlushedPosition());
    }
