...
/**
 * Integration Test for the <code>ExpressionProcess</code> class.
 */
public class ExpressionProcessIntegrationTestCase
     ...
     * @param name the name.
     */
    public ExpressionProcessIntegrationTestCase(String name) {
        super(name);
...
/*
 ...
 16-Jun-05	8751/4	schaloner	VBM:2005060711 Added AttributeNormalizingContentHandler to the testtools jar file list
