 ...
 * ---------    --------------- -----------------------------------------------
 * 31-03-03     Doug            VBM:2002091803 - Created. Error class used to
 *                              indicate that including a given resource will
 *                              result in an Inclusion Loop.
 * ----------------------------------------------------------------------------
 */

/**
 * Error class used to  indicate that including a given resource will
 * result in an Inclusion Loop or Cycle.
 */
...
public class CyclicInclusionException extends XMLProcessingException {
    ...
    /**
     * Construct a new CyclicInclusionException instance
     * @param message The error or warning message, or null to use the
     * message from the embedded exception.
     * @param locator The locator object for the error or warning
     * (may be null).
     */
    public CyclicInclusionException(String message, Locator locator) {
     ...
     * the error or warning.
     */
    public CyclicInclusionException(String message, String publicId, String systemId,
