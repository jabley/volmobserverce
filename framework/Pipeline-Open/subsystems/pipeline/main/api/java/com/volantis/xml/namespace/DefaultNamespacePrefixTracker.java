...
public class DefaultNamespacePrefixTracker
    ...
    // javadoc inherited
    public String[] getNamespacePrefixes(String namespaceURI) {
        //noinspection unchecked
        Enumeration<String> theEnum = namespaceSupport.getPrefixes(namespaceURI);
    ...
    public String[] getPrefixes() {
        //noinspection unchecked
        Enumeration<String> theEnum = namespaceSupport.getPrefixes();
        List<String> result = new ArrayList<String>();
    ...
    public ExpandedName resolveQName(QName name, String defaultNamespaceURI) {
        ...
        return new ImmutableExpandedName(uri, name.getLocalName());
    }
    ...
    private class State {
        ...
        public void commitTransaction() {
            if (!states.isEmpty()) {
                Integer integer = states.pop();
                pushed = pushed + integer;
            }
        }
