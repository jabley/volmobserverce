 ...
 * DateValue.
 */
public interface DateValueOperations extends DateValue {
     ...
     * @return true if this is less than the provided value
     */
    boolean lessThan(DateValue value);
     ...
     * @return true if this is greater than the provided value
     */
    boolean greaterThan(DateValue value);
     ...
     *         dateTimeValues
     */
    DurationValue subtract(DateValue value);
