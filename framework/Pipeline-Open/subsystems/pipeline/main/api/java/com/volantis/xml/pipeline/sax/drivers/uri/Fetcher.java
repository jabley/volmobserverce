...
public class Fetcher {
    ...
    /**
     * Operation id for error reporting
     */
    private String id;
    ...
    /**
     * Sets the is attribute needed when reporting errors
     *
     * @param id
     */
     ...
     * this operation and generates fatal error if not.
     *
     * This method forwards fataError down the pipeline which may result
     * in exception.
     *
    ...
    public void doInclude() throws SAXException {
        ...
        // Don't start transaction if not needed. Note that
        // a problem detected in validateAttributes is forwarded
