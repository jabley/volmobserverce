...
public interface NamespacePrefixTracker {
    ...
    /**
     * Get the prefixes associated with the specified namespace URI.
     * @param namespaceURI The namespace URI.
     * @return The prefixes associated with the specified namespace URI, will
     * be empty if no such mapping exists.
     */
