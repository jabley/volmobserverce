...
import com.volantis.styling.impl.state.StateContainerMock;
...
public class EngineStylerImplTestCase
    ...
    public void test() throws Exception {
        ...
        final StylerMock stylerMock =
                new StylerMock("stylerMock", expectations);

        final StateContainerMock stateContainerMock =
                new StateContainerMock("stateContainerMock", expectations);
        ...
        expectations.add(new OrderedExpectations() {
            public void add() {
                ...
                matcherContextMock.expects.setContainer(stateContainerMock);
