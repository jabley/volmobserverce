...
/**
 * A utility class to transform CSS into a compiled style sheet.
 * <p>
 * Note that the this class may not be thread safe.
 */
public interface CSSCompiler {
     ...
     */
    CompiledStyleSheet compile(Reader input, String url);
