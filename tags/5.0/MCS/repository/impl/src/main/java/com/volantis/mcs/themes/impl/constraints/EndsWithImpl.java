...
/**
 * Test whether the attribute value ends with the supplied value.
 */
public class EndsWithImpl extends ConstraintImpl implements EndsWith {

    // Javadoc inherited.
    public boolean evaluate(String actualValue) {
        return actualValue != null && actualValue.endsWith(value);
    }
