...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/testsuite/unit/com/volantis/mcs/layouts/ReplicaTestCase.java,v 1.3 2003/04/01 16:35:10 chrisw Exp $
 * ----------------------------------------------------------------------------
 ...
 * ---------    --------------- -----------------------------------------------
 * 20-Feb-03    Allan           VBM:2003021803 - A testcase for Replica. 
...
public class ReplicaTestCase 
    ...
    protected Format createTestableFormat() {
        return new Replica(new CanvasLayout());
    }
