 ...
 * </p>
 */
public interface MetaDataBuilderVisitor {

    void visit(AudioMetaDataBuilder metaData);

    void visit(ChartMetaDataBuilder metaData);

    void visit(ImageMetaDataBuilder metaData);

    void visit(ScriptMetaDataBuilder metaData);

    void visit(TextMetaDataBuilder metaData);

    void visit(VideoMetaDataBuilder metaData);
}
