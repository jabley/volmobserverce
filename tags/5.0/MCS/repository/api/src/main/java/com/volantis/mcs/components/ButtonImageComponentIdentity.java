...
/**
 * Encapsulates those properties of a ButtonImageComponent which uniquely
 * identify it.
 ...
 */
public class ButtonImageComponentIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>ButtonImageComponentIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ButtonImageComponentIdentity (Project project,
                                       String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public ButtonImageComponentIdentity (String name) {
    super(null, name);
  }

  // Javadoc inherited from super class.
  public Class getObjectClass () {
    return ButtonImageComponent.class;
  }
}
