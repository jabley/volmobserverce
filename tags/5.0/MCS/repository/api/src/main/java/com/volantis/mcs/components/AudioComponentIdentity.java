...
/**
 * Encapsulates those properties of a AudioComponent which uniquely identify
 * it.
 ...
 */
public class AudioComponentIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>AudioComponentIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public AudioComponentIdentity (Project project,
                                 String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public AudioComponentIdentity (String name) {
    super(null, name);
  }

  // Javadoc inherited from super class.
  public Class getObjectClass () {
    return AudioComponent.class;
  }
}
