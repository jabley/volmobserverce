...
// http://www.w3.org/TR/xhtml-modularization/abstract_modules.html#s_legacymodule:
...
<xsl:stylesheet version="1.0" 
	...
	<!--
	// conversion to ul tag, added pane selector
	-->
	<xsl:template match="xh:menu|xh:dir">
		<xsl:element name="ul">
	...
	-->
	<xsl:template match="xh:s|xh:strike">
	...
	<!-- 
	// ignores tag, processes content
	-->
	<xsl:template match="xh:center|xh:font">
		<xsl:apply-templates/>
	</xsl:template>	
	...
	-->	
	<xsl:template match="xh:isindex|xh:basefont">
	</xsl:template>
	
	
	<!--
	// conversion to pre tag, added pane selector
	-->
	<xsl:template match="xh:xmp">
