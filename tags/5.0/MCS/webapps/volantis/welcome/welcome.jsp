...
<canvas layoutName="/welcome.mlyt"
    ...
    <pane name="background" >
      ...
      <p>
        The Volantis Mobility Server provides a comprehensive, standards-based,
    ...
    <pane name="congratulations" >
        ...
        <p>
          You have successfully installed and configured The Volantis Mobility Server 
          Community Edition<sup>TM</sup>.
        </p>
    </pane>
