...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Text">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_text.jsp" styleClass="menu2">Basic Text Properties</vt:a><vt:br/>
	<vt:a href="tt_textalign.jsp" styleClass="menu2">Text Align</vt:a><vt:br/>
	<vt:a href="tt_whitespace.jsp" styleClass="menu2">Whitespace</vt:a><vt:br/>
	<vt:a href="index.jsp" styleClass="menu2">Main Index</vt:a><vt:br/>
</vt:pane>

<vt:pane name="info">
<vt:p>
	Filename: tt_themes_text.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Text' Index page.
It contains links to test pages that cover the theme properties that are in the 'Text' tab in style properties window in the GUI. Properties are:<vt:br/>
- Text Indent<vt:br/>
- Text Align<vt:br/>
- Text Decoration<vt:br/>
- Text Transform<vt:br/>
- Letter Spacing<vt:br/>
- Word Spacing<vt:br/>
- White Space<vt:br/>
</vt:p>
</vt:pane>
