...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Layouts Index Page">
...
<vt:pane name="menu2">
	<vt:a href="tt_incomplete.jsp" styleClass="menu2">Incomplete Layout</vt:a><vt:br/>
	<vt:a href="tt_nestedpanes.jsp" styleClass="menu2">Nested Panes</vt:a><vt:br/>
	<vt:a href="tt_dissecting.jsp" styleClass="menu2">Dissecting Panes</vt:a><vt:br/>
	<vt:a href="tt_layoutprops.jsp" styleClass="menu2">Grid and Pane Properties</vt:a><vt:br/>
	<vt:a href="tt_iterated.jsp" styleClass="menu2">Row Iterator Panes</vt:a><vt:br/>
	<vt:a href="tt_iterated2.jsp" styleClass="menu2">Column Iterator Panes</vt:a><vt:br/>
	<vt:a href="tt_fragments.jsp" styleClass="menu2">Fragments</vt:a><vt:br/>
	<vt:a href="tt_montage.jsp" styleClass="menu2">Montages</vt:a><vt:br/>
	<vt:a href="tt_layout1.jsp" styleClass="menu2">Layout Width Test 1</vt:a><vt:br/>
	<vt:a href="tt_layout2.jsp" styleClass="menu2">Layout Width Test 2</vt:a><vt:br/>
	<vt:a href="tt_table2.jsp" styleClass="menu2">Layout Table</vt:a><vt:br/>
	<vt:a href="index.jsp" styleClass="menu2">Main Index</vt:a><vt:br/>
</vt:pane>

<vt:pane name="info">
<vt:p>
	Filename: tt_layouts.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This section will test pane properties and all things to do with layouts.
</vt:p>
</vt:pane>
