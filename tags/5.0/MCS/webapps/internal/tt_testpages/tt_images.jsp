...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Images Index Page">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_gridimage.jsp" styleClass="menu2">Grid Image</vt:a><vt:br/>
	<vt:a href="tt_image4.jsp" styleClass="menu2">Volantis Images</vt:a><vt:br/>
	<vt:a href="tt_image1.jsp" styleClass="menu2">Image Asset Fallback</vt:a><vt:br/>

	<vt:a href="tt_image2.jsp" styleClass="menu2">Image Fallback</vt:a><vt:br/>
	<vt:a href="tt_image3.jsp" styleClass="menu2">Repeating Background Image</vt:a><vt:br/>
	<vt:a href="tt_chart.jsp" styleClass="menu2">Chart Test 1</vt:a><vt:br/>
...
<vt:pane name="main">
<vt:p>
This section tests use of regular images and image fallback.
</vt:p>
</vt:pane>
