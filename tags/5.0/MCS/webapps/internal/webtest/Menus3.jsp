...
<vt:pane name="M1">
 <vt:p> This example is a horizontal plaintext menu.</vt:p>
</vt:pane>

<vt:menu pane="M1" type="plaintext" styleClass="someClass">
 <vt:menuitem href="AllForms.jsp" text="Forms Test Pages"/>
