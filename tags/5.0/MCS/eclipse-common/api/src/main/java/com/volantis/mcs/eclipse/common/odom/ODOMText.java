...
/**
 * This is an observable implementation of the JDOM Text.
 */
public class ODOMText extends Text implements ODOMObservable {
    /**
     * Used for logging
     */
    private static final LogDispatcher logger =
            LocalizationFactory.createLogger(ODOMText.class);
    ...
    public String getName() {
        throw new UnsupportedOperationException(
                "ODOMText has no name."); //$NON-NLS-1$
    }
    ...
    //-------------------------------------------------------------------------
    // Text method augmentation to trigger change events
    //-------------------------------------------------------------------------

    /**
     * Augments {@link Text#setText} to ensure that a {@link
    ...
    /**
     * Augments {@link Text#setParent} to ensure that a {@link
    ...
    /**
     * Augments {@link Text#append(String)} to ensure that a {@link
     * com.volantis.mcs.eclipse.common.odom.ChangeQualifier#TEXT} change event
     * is fired.
     *
    ...
    /**
     * Augments {@link Text#append(Text)} to ensure that a {@link
     * com.volantis.mcs.eclipse.common.odom.ChangeQualifier#TEXT} change event
     * is fired.
     *
