 ...
 */
public class ItemIconTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(ItemIconAttributes.class);
        fakeFeedPoller();
    }

    protected String getElementName() {
        return TickerElements.ITEM_ICON.getLocalName();
    }
