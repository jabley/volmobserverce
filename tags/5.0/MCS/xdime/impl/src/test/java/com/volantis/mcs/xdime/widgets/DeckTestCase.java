...
public class DeckTestCase extends WidgetElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(DeckAttributes.class);
    }


    protected String getElementName() {
        return WidgetElements.DECK.getLocalName();
    }

    protected List /*of ElementType*/ getChildElements() {
        ElementType[] myContent = {
                WidgetElements.DECK_PAGE,
                WidgetElements.DECK_PAGE,
                WidgetElements.DECK_PAGE,
            };
