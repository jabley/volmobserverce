...
public interface ListAccessor {
    ...
    int size(Object modelList);

    void insert(Object modelList, int index, Object value);

    Object remove(Object modelList, int index);

    Object get(Object modelList, int index);

    void set(Object modelList, int index, Object value);
}
