 ...
 * {@link com.volantis.mcs.dom2theme.impl.model.PseudoStylePath#iterate}.
 */
public abstract class PseudoStylePathIterateMethodAction
        implements MethodAction {

    // Javadoc inherited.
    public Object perform(MethodActionEvent event) throws Throwable {

        PseudoStyleEntityIteratee iteratee = (PseudoStyleEntityIteratee)
                event.getArgument(PseudoStyleEntityIteratee.class);
     ...
     *
     * @param iteratee the iteratee to process each mocked entity.
     */
    public abstract void iterate(PseudoStyleEntityIteratee iteratee);
}
