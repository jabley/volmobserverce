 ...
 * @mock.generate
 */
public interface StylesClassRuleExtractorFactory {

    /**
     *
     * @param styleSheet the style sheet that the rules will be added to.
     * @return
     */
    StylesClassRuleExtractor create(StyleSheet styleSheet);
}
