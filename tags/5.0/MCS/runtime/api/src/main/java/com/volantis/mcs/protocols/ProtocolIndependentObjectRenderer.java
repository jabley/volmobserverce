...
public class ProtocolIndependentObjectRenderer {
     ...
     */
    MCSAttributes markupSpecificAttributes;
     ...
     * @return
     */
    private ElementFinalizer createWrappingFinalizer(final MCSAttributes markupSpecificAttributes,
        ...
        finalizer = new ElementFinalizerWrapper(internalFinalizer){
            protected MCSAttributes getMarkupSpecificAttributes() {
    ...
    private void writeCloseMarkup(ObjectAttribute originalAttributes,
        ...
        if (objectType == ObjectType.OBJECT){
            ...
            if(null != externalLabelObject){
                ...
                //TODO: should exception be thrown if there is no mcs-external-label ?
                throw new ProtocolException("mandatory param mcs-external-label inside object not exists");
            }
     ...
     */
    public MCSAttributes createMarkupSpecificAttributes(ObjectAttribute attributes,
                                                 ObjectType objectType){
        MCSAttributes newAttributes = null;
    ...
    public void updateMarkupSpecificAttributes(ObjectAttribute attributes,
            MCSAttributes objectSpecificAttributes) {
    ...
    private abstract class ElementFinalizerWrapper implements ElementFinalizer {
        ...
        public void finalizeElement(MCSAttributes attributes) throws ProtocolException {
            MCSAttributes markupSpecificAttributes = getMarkupSpecificAttributes();
        ...
        abstract protected  MCSAttributes getMarkupSpecificAttributes();
    };
}
