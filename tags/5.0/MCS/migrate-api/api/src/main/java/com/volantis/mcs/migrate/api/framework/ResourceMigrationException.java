...
/**
 * An exception for resource migration errors.
 */
public class ResourceMigrationException extends ExtendedException {

    /**
     * Initialise.
     */
    public ResourceMigrationException() {
    }
     ...
     * Initialise.
     */
    public ResourceMigrationException(Throwable cause) {
        super(cause);
    }
