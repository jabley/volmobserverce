...
/**
 * Implementation of a fraction value.
 */
public class FractionValueImpl implements FractionValue {
    ...
    public void writeConstructCode(String indent, PrintStream out) {
        out.print(indent);
        out.print("styleValueFactory.getFraction(");
        numerator.writeConstructCode("", out);
        out.print(", ");
        denominator.writeConstructCode("", out);
        out.print(")");
    }
}
