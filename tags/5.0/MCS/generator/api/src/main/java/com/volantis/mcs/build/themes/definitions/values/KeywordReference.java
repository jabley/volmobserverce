...
/**
 * Represents a resolved reference to a keyword.
 */
public interface KeywordReference
    extends Value {

    /**
     * Set the keyword that this object references.
     * @param keyword The keyword that this object references.
     */
