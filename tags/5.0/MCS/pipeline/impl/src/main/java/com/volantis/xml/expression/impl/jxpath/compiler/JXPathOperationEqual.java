...
import our.apache.commons.jxpath.ri.compiler.CoreOperationEqual;
 ...
 * ("boxed") types.
 */
public class JXPathOperationEqual
     ...
     */
    public JXPathOperationEqual(Expression left, Expression right) {
        super(left, right);
    }
