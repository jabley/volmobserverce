...
import our.apache.commons.jxpath.ri.compiler.CoreOperationMod;
import our.apache.commons.jxpath.ri.compiler.Expression;

/**
 * Provides a specialist 'mod' operator that correctly handles the expression
 * framework's {@link com.volantis.xml.expression.Value} and java ("boxed")
 * types.
 */
public class JXPathOperationMod extends CoreOperationMod implements
        BinaryOperator {
    ...
    /**
     * Initializes a <code>JXPathOperationMod</code> instance
     * 
     * @param left
     ...
     */
    public JXPathOperationMod(Expression left, Expression right,
