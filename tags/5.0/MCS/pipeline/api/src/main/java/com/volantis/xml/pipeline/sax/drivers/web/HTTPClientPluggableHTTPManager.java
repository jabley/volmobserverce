...
import our.apache.commons.httpclient.cookie.CookiePolicy;
...
import our.apache.commons.httpclient.util.URIUtil;
...
public class HTTPClientPluggableHTTPManager
    ...
    public HTTPRequestExecutor createHTTPRequestExecutor(
        ...
        return new HTTPRequestExecutor() {
            ...
            public void addRequestCookie(Cookie cookie) {
                ...
                our.apache.commons.httpclient.Cookie httpClientCookie =
    ...
    private HttpMethod createPostMethod(String url, List requestParameters) throws HTTPException {
        ...
        Set queryParametersName = new HashSet();
        ...
        MarinerURL newUrl = new MarinerURL(url);
        Enumeration enumeration = newUrl.getParameterNames();
        while(enumeration.hasMoreElements()) {
            // Get the name of the current parameter.
            String currentName = (String) enumeration.nextElement();
            // add the name of the parameter to the query parameter names
            queryParametersName.add(currentName);
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("Leaving parameter with the name: '" + 
                        currentName + "' in the query string.");
            }
        }
     ...
     * @return The our.apache.commons.httpclient.Cookie version of the given
     * Volantis Cookie.
     */
    private our.apache.commons.httpclient.Cookie
    ...
    private void addHttpClientHeaderToWebDriverHeaders(
            our.apache.commons.httpclient.Header httpClientHeader,
    ...
    private void addHttpClientCookiesToWebDriverCookies(
            our.apache.commons.httpclient.Cookie httpClientCookies [],
    ...
    private class HTTPClientResponseAccessor
        ...
        private void populateMessageEntities() throws HttpException {
            ...
            if (method != null) {
                our.apache.commons.httpclient.Header responseHeaders [] =
                        method.getResponseHeaders();
                if (responseHeaders != null && responseHeaders.length > 0) {

                    for (int i = 0; i < responseHeaders.length; i++) {
                        our.apache.commons.httpclient.Header header =
                                responseHeaders[i];
                        if (COOKIE_HEADER.equalsIgnoreCase(header.getName())) {
                            our.apache.commons.httpclient.Cookie httpCookies []
