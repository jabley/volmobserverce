...
public class JDBCDriverConfigurationImpl
        implements JDBCDriverConfiguration {

    private Properties driverProperties;

    private String driverClassName;

    private String driverSpecificDatabaseURL;
    ...
    public String getDriverSpecificDatabaseURL() {
        return driverSpecificDatabaseURL;
    }

    public void setDriverSpecificDatabaseURL(String driverSpecificDatabaseURL) {
        this.driverSpecificDatabaseURL = driverSpecificDatabaseURL;
    }
