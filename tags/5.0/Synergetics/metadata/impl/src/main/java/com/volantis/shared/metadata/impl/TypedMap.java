...
public class TypedMap
    ...
    protected Object checkValue(Object value) {
        if (value == null) {
            ...
            throw new IllegalArgumentException("value: " + value + " is Not "
                    + getAllowableValueClass().getName());
        }
    ...
    private class EntrySet extends AbstractSet {
        ...
        // Override to ensure that the object is of the correct type
