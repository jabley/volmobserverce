...
/**
 * Implementation of {@link ImmutableBooleanType}.
 */
final class ImmutableBooleanTypeImpl
        extends BooleanTypeImpl
        implements ImmutableBooleanType, Serializable,
        ImmutableMetaDataTypeVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -3286647170951708467L;
     ...
     */
    public ImmutableBooleanTypeImpl(BooleanType type) {
        super(type);
    }
     ...
     */
    protected ImmutableBooleanTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_BOOLEAN_TYPE;
    }
