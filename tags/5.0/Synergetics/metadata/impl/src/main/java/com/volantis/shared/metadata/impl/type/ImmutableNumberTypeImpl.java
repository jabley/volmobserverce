...
/**
 * Implementation of {@link ImmutableNumberType}.
 */
final class ImmutableNumberTypeImpl
        extends NumberTypeImpl
        implements ImmutableNumberType, Serializable,
        ImmutableMetaDataTypeVisitee {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -7168998731959759357L;
     ...
     */
    public ImmutableNumberTypeImpl(NumberType type) {
        super(type);
    }
     ...
     */
    protected ImmutableNumberTypeImpl() {
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_NUMBER_TYPE;
    }
}
