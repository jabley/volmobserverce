...
/**
 * Implementation of {@link ImmutableMinimumValueConstraintImpl}.
 */
public final class ImmutableMinimumValueConstraintImpl
        extends MinimumValueConstraintImpl
        implements ImmutableMinimumValueConstraint, Serializable {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -2383313547629066955L;
     ...
     */
    public ImmutableMinimumValueConstraintImpl(MinimumValueConstraint constraint) {
        super(constraint);
    }
     ...
     */
    protected ImmutableMinimumValueConstraintImpl() {
        super();
    }
    ...
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_MINIMUM_VALUE_CONSTRAINT;
    }
