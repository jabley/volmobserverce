...
/**
 * Implementation of {@link MutableChoiceType}.
 */
final class MutableChoiceTypeImpl
        extends ChoiceTypeImpl
        implements MutableChoiceType {
     ...
     */
    public MutableChoiceTypeImpl(ChoiceType type) {
        super(type);
    }
     ...
     */
    public MutableChoiceTypeImpl() {
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.MUTABLE_CHOICE_TYPE;
    }
}
