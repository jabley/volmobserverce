...
/**
 * Implementation of {@link com.volantis.shared.metadata.type.constraint.immutable.ImmutableEnumeratedConstraint}.
 */
public final class ImmutableEnumeratedConstraintImpl extends EnumeratedConstraintImpl
        implements ImmutableEnumeratedConstraint, Serializable {

    /**
     * The Serial Version UID.
     */
    static final long serialVersionUID = -3121336598707951094L;
     ...
     */
    public ImmutableEnumeratedConstraintImpl(EnumeratedConstraint constraint) {
        super(constraint);
    }
     ...
     */
    protected ImmutableEnumeratedConstraintImpl() {
    }
     ...
     * @note Added for JiBX only.
     */
    public static ImmutableEnumeratedConstraint deserializer(
            final String constraint) {
        return
            constraint == null? null: new ImmutableEnumeratedConstraintImpl();
    }

    // Javadoc inherited
    public MetadataClassMapper getClassMapper() {
        return MetadataClassMapper.IMMUTABLE_ENUMERATED_CONSTRAINT;
    }
