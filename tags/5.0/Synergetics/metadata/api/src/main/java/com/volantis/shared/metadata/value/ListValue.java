...
/**
 * This interface represents a value of a ListType.
 *
 * <p>
...
public interface ListValue
    ...
    /**
     * Get the contained values as a List.
     *
     * <p>This returns the same object as is returned by
     * {@link #getContentsAsCollection}.</p>
     *
     * <p><strong>Note</strong>: Although the returned list is not itself
     * immutable if this method is called on a mutable instance then it is
     * possible that the underlying list may be changed through a mutable
     * representation of the list.</p>
     *
     * @return An unmodifiable List of {@link MetaDataValue}'s.
     */
