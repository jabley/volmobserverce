...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/testsuite/unit/com/volantis/mcs/protocols/html/xhtmltransitional/XHTMLTransitionalUnabridgedTransformerTestCase.java,v 1.2 2003/01/15 12:42:10 philws Exp $
 * ----------------------------------------------------------------------------
 ...
 *                              XHTMLTransitionalUnabridgedTransformer.
 * ----------------------------------------------------------------------------
 */
...
/**
 * Tests the XHTMLTransitionalUnabridgedTransformer.
 */
public class XHTMLTransitionalUnabridgedTransformerTestCase
    extends XHTMLFullUnabridgedTransformerTestCase {

    protected DOMTransformer getTransformer() {
        return new XHTMLTransitionalUnabridgedTransformer(null);
    }
}
