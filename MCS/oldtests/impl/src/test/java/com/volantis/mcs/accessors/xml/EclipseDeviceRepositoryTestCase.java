        ...
        manager.executeWith(new TemporaryFileExecutor() {
            public void execute(File repository) throws Exception {
                ...
                try {
                    ...
                    System.out.println("== testWriteDeviceElementsBlahBlahBlah ==");
                    System.out.println(JDOMUtils.convertToString(device));
                    System.out.println("== testWriteDeviceElementsBlahBlahBlah ==");
    ...
    protected Element retrievePolicy(Element deviceElement, String policyName)
        ...
        while (iterator.hasNext() && policy == null) {
            ...
            String policyElementName =
                    policyElement.getAttributeValue(XMLAccessorConstants.
