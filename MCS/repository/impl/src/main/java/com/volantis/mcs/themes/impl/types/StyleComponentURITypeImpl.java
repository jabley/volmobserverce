...
public class StyleComponentURITypeImpl
        extends AbstractSingleStyleType
    implements StyleComponentURIType {

    public StyleComponentURITypeImpl() {
        super(StyleValueType.COMPONENT_URI);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleComponentURIType(this);
    }
