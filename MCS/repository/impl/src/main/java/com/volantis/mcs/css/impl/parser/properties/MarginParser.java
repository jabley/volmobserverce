...
/**
 * Parser for the margin shorthand property.
 */
public class MarginParser
     ...
     *                properties.
     */
    public MarginParser(PropertyParserFactory factory) {
        super(factory.getValueConverter(StylePropertyDetails.MARGIN_TOP),
