...
/**
 * Parser for the padding shorthand property.
 */
public class PaddingParser
     ...
     *                properties.
     */
    public PaddingParser(PropertyParserFactory factory) {
        super(factory.getValueConverter(StylePropertyDetails.PADDING_TOP),
