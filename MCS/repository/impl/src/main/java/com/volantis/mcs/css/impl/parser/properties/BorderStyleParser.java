...
/**
 * Parser for the border-style shorthand property.
 */
public class BorderStyleParser
     ...
     *                properties.
     */
    public BorderStyleParser(PropertyParserFactory factory) {
        super(factory.getValueConverter(StylePropertyDetails.BORDER_TOP_STYLE),
