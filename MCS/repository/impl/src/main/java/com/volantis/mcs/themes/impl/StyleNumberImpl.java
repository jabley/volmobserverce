...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/themes/StyleNumber.java,v 1.3 2002/06/29 01:04:52 pduffin Exp $
 * ----------------------------------------------------------------------------
...
/**
 */
public final class StyleNumberImpl
        extends StyleValueImpl implements StyleNumber {
     ...
     */
    public StyleNumberImpl(double number) {
        this(null, number);
    }
     ...
     * @param number   The number value.
     */
    public StyleNumberImpl(SourceLocation location, double number) {
        super(location);
    ...
    protected boolean equalsImpl(Object o) {
        if (!(o instanceof StyleNumberImpl)) {
            return false;
        }

        StyleNumberImpl other = (StyleNumberImpl) o;
    ...
    protected int hashCodeImpl() {
        int result = 0;
        long bits = Double.doubleToLongBits(getNumber());
        result = 37 * result + (int) (bits ^ (bits >>> 32));
        return result;
    }

    public String getStandardCSS() {
        return convertDoubleToText(number);
    }
}
