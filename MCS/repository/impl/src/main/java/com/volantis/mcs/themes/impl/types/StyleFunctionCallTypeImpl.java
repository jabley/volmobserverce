...
public class StyleFunctionCallTypeImpl
        extends AbstractSingleStyleType
    implements StyleFunctionCallType {

    public StyleFunctionCallTypeImpl() {
        super(StyleValueType.FUNCTION_CALL);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleFunctionCallType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleFunctionCall functionCall = (StyleFunctionCall) value;
