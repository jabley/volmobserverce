...
public class StyleURITypeImpl 
        extends AbstractSingleStyleType
    implements StyleURIType {

    public StyleURITypeImpl() {
        super(StyleValueType.URI);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleURIType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleURI uri = (StyleURI) value;
