...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/themes/StyleInteger.java,v 1.4 2002/06/29 01:04:52 pduffin Exp $
 * ----------------------------------------------------------------------------
...
/**
 */
public final class StyleIntegerImpl
        extends StyleValueImpl implements StyleInteger {
    ...
    /**
     * Create a new <code>StyleInteger</code>.
     *
     * @param integer The integer value.
     */
    public StyleIntegerImpl(int integer) {
        this.integer = integer;
    }

    // Javadoc inherited.
    public StyleValueType getStyleValueType() {
        return StyleValueType.INTEGER;
    }
    ...
    protected boolean equalsImpl(Object o) {
        if (!(o instanceof StyleIntegerImpl)) {
            return false;
        }

        StyleIntegerImpl other = (StyleIntegerImpl) o;
