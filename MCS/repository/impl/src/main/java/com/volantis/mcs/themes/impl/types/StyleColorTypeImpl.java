...
public class StyleColorTypeImpl
        extends AbstractSingleStyleType
    implements StyleColorType {

    public StyleColorTypeImpl() {
        super(StyleValueType.COLOR);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleColorType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleColor color = (StyleColor) value;
