...
public class StyleIdentifierTypeImpl
        extends AbstractSingleStyleType
    implements StyleIdentifierType {

    public StyleIdentifierTypeImpl() {
        super(StyleValueType.IDENTIFIER);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleIdentifierType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleIdentifier identifier = (StyleIdentifier) value;
