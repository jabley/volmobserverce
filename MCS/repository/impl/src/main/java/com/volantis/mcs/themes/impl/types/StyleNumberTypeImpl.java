...
public class StyleNumberTypeImpl 
        extends AbstractSingleStyleType
    implements StyleNumberType {

    public StyleNumberTypeImpl() {
        super(StyleValueType.NUMBER);
    }

    public void accept(StyleTypeVisitor visitor) {
        visitor.visitStyleNumberType(this);
    }

    protected void validateSupportedValue(
            ValidationContext context, StyleValue value) {

        StyleNumber number = (StyleNumber) value;
