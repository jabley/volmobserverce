...
/**
 * Test {@link VariableIteratorSizeConstraint}.
 */
public class VariableConstraintTestCase
        extends AbstractConstraintTestAbstract {

    // Javadoc inherited.
    protected IteratorSizeConstraint createConstraint(int maxInclusive) {
        return new VariableIteratorSizeConstraint(maxInclusive);
    }
    ...
    public void testCreation() {
        ...
        assertEquals("Fixed", false, constraint.isFixed());
