...
/**
 * Test for border-spacing.
 */
public class BorderSpacingParserTestCase
    ...
    public void testSingleValue() throws Exception {
        ...
        StyleValue expected = STYLE_VALUE_FACTORY.getPair(
                LENGTH_1PX, LENGTH_1PX);

        expectSetProperty(StylePropertyDetails.BORDER_SPACING, expected);

        parseDeclarations("border-spacing: 1px");
    }
    ...
    public void testTwoValues() throws Exception {
        ...
        parseDeclarations("border-spacing: 1px 2cm");
    }
}
