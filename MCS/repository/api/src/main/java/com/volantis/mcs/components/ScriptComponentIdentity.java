...
/**
 * Encapsulates those properties of a ScriptComponent which uniquely identify
 * it.
 ...
 */
public class ScriptComponentIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>ScriptComponentIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ScriptComponentIdentity (Project project,
                                  String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public ScriptComponentIdentity (String name) {
    super(null, name);
  }
