...
/**
 * Encapsulates those properties of a ChartComponent which uniquely identify
 * it.
 ...
 */
public class ChartComponentIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>ChartComponentIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ChartComponentIdentity (Project project,
                                 String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public ChartComponentIdentity (String name) {
    super(null, name);
  }
