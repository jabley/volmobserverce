...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/css/renderer/css2/UniversalSelectorRenderer.java,v 1.1 2002/04/27 18:26:15 aboyd Exp $
 * ----------------------------------------------------------------------------
...
/**
 * A renderer for CSS Universal selectors.
 */
public class UniversalSelectorRenderer implements SelectorRenderer {
    /**
    ...
    public void render(Selector selector,
        ...
        // Check the selector class with a cast
        UniversalSelector universal = (UniversalSelector) selector;
        String namespacePrefix = universal.getNamespacePrefix();
