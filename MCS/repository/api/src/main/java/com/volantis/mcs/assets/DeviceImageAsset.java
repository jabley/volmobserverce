...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/assets/DeviceImageAsset.java,v 1.17 2003/03/24 16:35:25 sfound Exp $
 * ----------------------------------------------------------------------------
 ...
 * 29-May-02    Paul            VBM:2002050301 - Removed debugging print.
...
/**
 * The DeviceImageAsset represents an image asset associated with a specific 
 * device. Each DeviceImageAsset references one image. This might be a JPEG 
 * file, for example. The combination of the name of the asset and the name
 * of the device to which it applies is unique.
 *
 ...
 * @mariner-object-required-field widthHint
 * @mariner-object-required-field localSrc
...
public class DeviceImageAsset
  ...
  /** Constructor
   */  
  public DeviceImageAsset () {
  }
   
  /** Constructor
   * @param name The name of the asset
   */  
  public DeviceImageAsset (String name) {
    setName (name);
   ...
   * @param deviceName The name of the device for which this image is targeted
   ...
   * @param name The name of the asset
   */  
  public DeviceImageAsset (String name, int pixelsX, int pixelsY,
                           int pixelDepth, int rendering, int encoding,
                           String deviceName, String assetGroupName, String value) {
    setName(name);
    setPixelsX(pixelsX);
    setPixelsY(pixelsY);
  ...
  /**
   * Create a new <code>DeviceImageAsset</code>.
   * @param identity The identity of the <code>DeviceImageAsset</code>.
   */
  public DeviceImageAsset (DeviceImageAssetIdentity identity) {
    super (identity);
  ...
  protected RepositoryObjectIdentity createIdentity () {
    return new DeviceImageAssetIdentity(getProject(), getName(),
                                        getDeviceName ());
  }
  ...
  public boolean equals (Object object) {
    if (object instanceof DeviceImageAsset) {
      DeviceImageAsset o = (DeviceImageAsset) object;
