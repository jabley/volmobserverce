...
/**
 * Encapsulates those properties of a TextAsset which uniquely identify it.
 ...
 */
public class TextAssetIdentity
  extends AbstractRepositoryObjectIdentity
  implements RepositoryObjectDeviceIdentity {

  /**
   * The name of the device associated with the asset
   */
  private String deviceName;

  /**
   * The language associated with the asset
   */
  private String language;

  /**
   * Create a new <code>TextAssetIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public TextAssetIdentity (Project project,
                            String name,
                            String deviceName,
                            String language) {
    super(project, name);
   ...
   * @param name  The name of the object.
   */
  public TextAssetIdentity (String name,
                            String deviceName,
                            String language) {
    super(null, name);
  ...
  public boolean equals (Object object) {
    ...
    TextAssetIdentity identity = (TextAssetIdentity) object;
    return equals (deviceName, identity.deviceName)
      && equals (language, identity.language);
  }
...
;
  ...
  public int compareTo (Object object) {
    ...
    if ((result = compare (language, identity.language)) != 0) {
      return result;
    }
