...
/**
 * Encapsulates those properties of a ChartAsset which uniquely identify it.
 ...
 */
public class ChartAssetIdentity
  extends AbstractRepositoryObjectIdentity {

  /**
   * Create a new <code>ChartAssetIdentity</code>.
   * @param project  The project used with this object.   A null value is
   * possible if it
   * has not been set.
   * @param name  The name of the object.
   */
  public ChartAssetIdentity (Project project,
                             String name) {
    super(project, name);
  }
   ...
   * @param name  The name of the object.
   */
  public ChartAssetIdentity (String name) {
    super(null, name);
  }

  // Javadoc inherited from super class.
  public Class getObjectClass () {
    return ChartAsset.class;
  }
}
