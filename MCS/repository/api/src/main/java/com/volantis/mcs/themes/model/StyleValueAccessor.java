...
public class StyleValueAccessor
        extends AbstractPropertyAccessor {

    private final StyleProperty property;

    public StyleValueAccessor(StyleProperty property) {
        this.property = property;
    }

    public Object get(Object object) {
        MutableStyleProperties properties = (MutableStyleProperties) object;
        return properties.getStyleValue(property);
    }

    public void set(Object object, Object value) {
        MutableStyleProperties properties = (MutableStyleProperties) object;
        properties.setStyleValue(property, (StyleValue) value);
    }
}
