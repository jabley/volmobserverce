...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="html">
		<canvas layoutName="/BasicTranscoderForm.mlyt" type="inclusion">
			<pane name="Pane">
				<xsl:apply-templates/>
            		</pane>
		</canvas>            
	...
	<xsl:template match="img">
		<xsl:choose>
			<xsl:when test="@height &lt; 10 or @width &lt; 10"/>
			<xsl:otherwise>
		<xsl:copy>
			<xsl:call-template name="copyStandardAttrs"/>
...
<!--
 ...
 02-Dec-03	2039/1	mat	VBM:2003112606 Change the inner classes to be private and added XHTML transcoder
