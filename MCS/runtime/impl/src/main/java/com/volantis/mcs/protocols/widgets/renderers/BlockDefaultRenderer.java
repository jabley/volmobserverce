    ...
    public void doRenderClose(VolantisProtocol protocol,
        ...
        if(((BlockAttributes)attributes).getFetchAttributes() != null) {
            ...
            if(fetchAttrs.getTransformation() != null) {
                ...
                String requestFileString = marinerURL.getFile();
                ...
                String requestPathString = requestFile.getPath();
                
                // save path without file name
                marinerURL.setPath(requestPathString);
