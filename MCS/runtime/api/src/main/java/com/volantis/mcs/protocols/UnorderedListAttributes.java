...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/UnorderedListAttributes.java,v 1.2 2002/03/18 12:41:17 ianw Exp $
 * ----------------------------------------------------------------------------
 ...
 * 22-Jan-02    Doug            VBM:2002011003 - Removed the start property
 *                              and the associated getters and setters. 
 *                              Start is not a valid attribute for unordered
 *                              lists. The attribute was never set or used.
 * 28-Feb-02    Paul            VBM:2002022804 - Renamed from
...
public class UnorderedListAttributes
     ...
     */
    public UnorderedListAttributes() {
        initialise();
    }
