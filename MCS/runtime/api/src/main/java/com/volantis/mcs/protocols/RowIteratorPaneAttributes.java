...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/RowIteratorPaneAttributes.java,v 1.13 2002/09/17 16:24:14 sfound Exp $
 * ----------------------------------------------------------------------------
 ...
 * 18-Mar-02    Ian             VBM:2002031203 Changed log4j Category from class
                                to string.
 * 11-Sep-02    Steve           VBM:2002040809 - Set the tagname to Pane
 * ----------------------------------------------------------------------------
 */
...
/**
 * @mock.generate base="PaneAttributes"
 */
public class RowIteratorPaneAttributes
        extends PaneAttributes {
     ...
     */
    public RowIteratorPaneAttributes() {
        initialise();
    }
