...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/html/xhtmltransitional/XHTMLTransitionalUnabridgedTransformer.java,v 1.2 2003/01/15 12:42:10 philws Exp $
 * ----------------------------------------------------------------------------
 ...
 */
public class XHTMLTransitionalUnabridgedTransformer
    extends UnabridgedTransformer {
     ...
     *                      transforming
     */
    public XHTMLTransitionalUnabridgedTransformer(
            TransformationConfiguration configuration) {
        super(new XHTMLTransitionalTransFactory(configuration));
    }
}
