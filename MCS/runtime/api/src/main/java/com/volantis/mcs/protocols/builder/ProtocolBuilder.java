...
public final class ProtocolBuilder {
    ...
    private void initialiseDeviceProtocolConfiguration(
        ...
        try {
            ...
            config.setDevicePixelsY(devicePixelsX);
        ...
        // Framework Client installer support configuration
        config.setFrameworkClientInstallerSupported(configurePolicyValue(
                device,
                DevicePolicyConstants.SUPPORTS_VFC_INSTALLER,
                DevicePolicyConstants.SUPPORTS_VFC_INSTALLER_DEFAULT,
                config.isFrameworkClientInstallerSupported()));
