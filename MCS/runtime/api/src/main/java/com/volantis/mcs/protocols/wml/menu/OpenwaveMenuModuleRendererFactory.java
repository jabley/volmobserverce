...
public class OpenwaveMenuModuleRendererFactory
        extends DefaultMenuModuleRendererFactory {

    public OpenwaveMenuModuleRendererFactory(
    ...
    /**
     * Create an Openwave specific menu item renderer factory that will render
     * option elements.
     *
     * @return
     */
    public MenuItemRendererFactory createMenuItemRendererFactory() {
        return new OpenwaveMenuItemRendererFactory(context, outputLocator);
    }
