...
/**
 * Creates policy sources for use by the runtime.
 *
 * <p>
 ...
 * @mock.generate
 */
public interface RuntimePolicySourceFactory {

    /**
     * Create a {@link XMLPolicySource} for an XML repository.
     *
     * @return The {@link XMLPolicySource}.
     */
    XMLPolicySource createXMLPolicySource(String directory);
     ...
     */
    JDBCPolicySource createJDBCPolicySource(String projectName);
     ...
     */
    RemotePolicySource createRemotePolicySource(String baseURL);
}
