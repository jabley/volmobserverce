 ...
 */
public class DefaultComponentLinkAssetReference
     ...
     * @param urlType
     */
    public DefaultComponentLinkAssetReference(
    ...
    public String getURL() {
        ...
        return assetResolver.rewriteURLWithPageURLRewriter(url, urlType);
    }
