...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/TableBodyAttributes.java,v 1.10 2002/06/14 10:13:12 adrian Exp $
 * ----------------------------------------------------------------------------
 ...
 *                              class to string.
 * 05-Jun-02    Adrian          VBM:2002021103 - Added keeptogether member
 *                              variable and get/set methods.
...
public class TableBodyAttributes
        extends MCSAttributes {

    private String keepTogether;
     ...
     *
     * @param keepTogether The new value of the keepTogether property.
     */
    ...
    /**
     * Get the value of the keepTogether property.
     *
     * @return The value of the keepTogether property.
     */
