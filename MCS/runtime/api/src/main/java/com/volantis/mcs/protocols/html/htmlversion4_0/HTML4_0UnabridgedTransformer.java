...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/mcs/protocols/html/htmlversion4_0/HTML4_0UnabridgedTransformer.java,v 1.2 2003/01/15 12:42:10 philws Exp $
 * ----------------------------------------------------------------------------
...
/**
 * Provides HTML 4.0 protocol-specific DOM table optimization.
 */
public class HTML4_0UnabridgedTransformer extends UnabridgedTransformer {
     ...
     *                      transforming
     */
    public HTML4_0UnabridgedTransformer(
            TransformationConfiguration configuration) {
        super(new HTML4_0TransFactory(configuration));
    }
}
/*
 ===========================================================================
