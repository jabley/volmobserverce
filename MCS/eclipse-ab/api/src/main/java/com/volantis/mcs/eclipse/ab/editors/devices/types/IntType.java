 ...
 * The Int policy type.
 */
final class IntType extends PolicyType {

    /**
     * Creates a new IntType. Package local so that only PolicyType
    ...
    /**
     * Creates the PolicyValueModifier used to modify values of int
     * policy types.
     * @param dram This is not used for int policy types.
     *             Can be null.
     */
