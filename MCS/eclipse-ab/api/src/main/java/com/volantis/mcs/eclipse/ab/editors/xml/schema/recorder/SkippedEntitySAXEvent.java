...
/**
 * This class is used to playback a SkippedEntity SAXEvent.
 */
class SkippedEntitySAXEvent extends SAXEvent {

    /**
     * The prefix parameter of the SkippedEntity SAXEvent that we are
     * storing for later playback.
     */
    protected String name;

    /**
     * Construct a new SkippedEntitySAXEvent
     * @param locator
     */
    public SkippedEntitySAXEvent(Locator locator, String name) {
        super(locator);
        this.name = name;
    }

    /**
     * 'Playback' the SkippedEntity SAXEvent by firing a SkippedEntity event in
     ...
     * a document location
     * @throws SAXException if one was thrown in firing the SkippedEntity
