 ...
 */
final class TextType extends PolicyType {

    /**
     * Creates a new TextType. Package local so that only PolicyType
     ...
     * text policy types.
     * @param dram This is not used for text policy types. Can be
     *             null.
     */
    ...
    public void addPolicyTypeElementImpl(Element parent,
        ...
        Element textElement =
                ...
                POLICY_DEFINITION_TEXT_ELEMENT_NAME, parent.getNamespace());
