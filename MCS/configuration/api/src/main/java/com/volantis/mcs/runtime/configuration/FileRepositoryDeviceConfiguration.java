 ...
 * <p>
 * This corresponds to the mcs-config/devices/{custom|standard}/file-repository
 * element.
 */
public class FileRepositoryDeviceConfiguration extends RepositoryDeviceConfiguration {
    ...
    /**
     * The location of the device repository file.
     */ 
    private String location;

    /**
     * Returns the location of the device repository file.
     */ 
    ...
    /**
     * Sets the location of the device repository file.
     */ 
