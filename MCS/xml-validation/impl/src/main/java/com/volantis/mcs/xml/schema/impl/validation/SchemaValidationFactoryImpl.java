...
public class SchemaValidationFactoryImpl
    extends SchemaValidationFactory {

    public DocumentValidator createDocumentValidator(CompiledSchema schema) {
        return new DocumentValidatorImpl((CompiledSchemaInternal) schema);
    }
}
