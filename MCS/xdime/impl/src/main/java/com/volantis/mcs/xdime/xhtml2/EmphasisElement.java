...
/**
 * XHTML V2 Emphasis element object.
 */
public class EmphasisElement extends XHTML2Element {
    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(EmphasisElement.class);

    /**
     * Used to retrieve localized exception messages.
     */
    private static final ExceptionLocalizer exceptionLocalizer =
        LocalizationFactory.createExceptionLocalizer(EmphasisElement.class);

    public EmphasisElement(XDIMEContextInternal context) {
        super(XHTML2Elements.EM, context);

        protocolAttributes = new EmphasisAttributes();
    }
    ...
    protected XDIMEResult callOpenOnProtocol(
        ...
        try {
            protocol.writeOpenEmphasis((EmphasisAttributes)protocolAttributes);
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseEmphasis((EmphasisAttributes)protocolAttributes);
    }
}
