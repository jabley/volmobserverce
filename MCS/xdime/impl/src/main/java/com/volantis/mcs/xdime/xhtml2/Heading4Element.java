...
/**
 * XHTML V2 Heading4 element object.
 */
public class Heading4Element extends XHTML2Element {

    /**
     * Used for logging.
     */
    private static final LogDispatcher logger =
        LocalizationFactory.createLogger(Heading4Element.class);
    /**
    ...
    protected void callCloseOnProtocol(XDIMEContextInternal context) {
        ...
        protocol.writeCloseHeading4((HeadingAttributes)protocolAttributes);
    }
