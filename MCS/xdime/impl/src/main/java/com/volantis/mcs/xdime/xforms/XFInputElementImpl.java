...
/**
 * Processes the xforms input element.
 */
public class XFInputElementImpl extends XFormsControlElement {
    ...
    protected void initialiseElementSpecificAttributes(XDIMEContextInternal context,
        ...
        // set the type of the XFTextInput to text
        final String textType = "text";
        ((XFTextInputAttributes)protocolAttributes).setType(textType);

//        // Set the shortcut if present
//        String shortCut = attributes.getValue("",
//                XDIMEAttribute.ACCESS.toString());
//        if (shortCut!= null) {
//            ((XFTextInputAttributes)protocolAttributes).setShortcut(shortCut);
//        }
    }
