...
public abstract class StylableXDIMEElement extends XDIMEElementImpl {
    ...
    protected boolean evaluateExpression(XDIMEContextInternal context,
            XDIMEAttributes attributes) throws XDIMEException {
        return evaluateExpression(context, getAttribute(XDIMEAttribute.EXPR,
                attributes, XDIMESchemata.DISELECT_NAMESPACE));
    }    
     ...
     * <li>qualified diselect attributes - expr and selid</li>
     * </ul>
     * <P/>
     * However:
     * <ul>
     ...
     * </li>The expr attribute will have been evaluated by this point, and so
     * does not need to be propagated through to the protocol attributes.</li>
     * <li>Any selid attributes recieved will have been converted to id
     * attributes when creating the XDIMEAttributes.</li>
     * </ul>
     *
     * @param context
