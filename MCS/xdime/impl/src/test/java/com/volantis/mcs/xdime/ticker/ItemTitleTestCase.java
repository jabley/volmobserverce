 ...
 */
public class ItemTitleTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(ItemTitleAttributes.class);
    }

    protected String getElementName() {
        return TickerElements.ITEM_TITLE.getLocalName();
    }
