 ...
 */
public class UpdateStatusTestCase extends TickerElementTestCaseAbstract {
    ...
    protected void setUp() throws Exception {
        ...
        addDefaultElementExpectations(UpdateStatusAttributes.class);
        fakeFeedPoller();
    }

    protected String getElementName() {
        return TickerElements.UPDATE_STATUS.getLocalName();
    }
