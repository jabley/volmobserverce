...
*/
/* ----------------------------------------------------------------------------
 * $Header: /src/voyager/com/volantis/testtools/io/ReplayInputStream.java,v 1.2 2003/03/20 15:15:34 sumit Exp $
 * ----------------------------------------------------------------------------
 ...
 *                              continuosly 'replays' its contents. When read()
 *                              returns -1, a subsequent read will start the
 *                              stream again.
...
public class ReplayInputStream extends AbstractReusableInputStream {
    /** Creates a new instance of ReusableInputStream */
    public ReplayInputStream(InputStream is) {
        super(is);
    }
