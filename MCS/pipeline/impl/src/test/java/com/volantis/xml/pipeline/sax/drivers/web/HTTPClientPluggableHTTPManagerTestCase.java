...
public class HTTPClientPluggableHTTPManagerTestCase
    ...
    public void testCreateCookieArray() throws Throwable {
        ...
        Class paramTypes [] = {our.apache.commons.httpclient.HttpMethod.class,
                               our.apache.commons.httpclient.Header.class};
        Object args [] = {httpMethod, header};

        our.apache.commons.httpclient.Cookie cookies [] =
                    (our.apache.commons.httpclient.Cookie[])
    ...
    public void testAddHttpClientCookiesToWebDriverCookies() throws Throwable {
        ...
        our.apache.commons.httpclient.Cookie[] cookiesArray =
        ...
        Class paramTypes [] = {our.apache.commons.httpclient.Cookie[].class,
    ...
    private void addHeaderTestImpl(String headerName, String headerValue,
        ...
        final our.apache.commons.httpclient.Header header =
                    new our.apache.commons.httpclient.Header();
        ...
        Class paramTypes [] = {our.apache.commons.httpclient.Header.class,
                               HTTPMessageEntities.class,
                               boolean.class };
