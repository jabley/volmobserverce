...
-->
<%-- ==========================================================================
 % $Header: /src/voyager/webapp/internal/webtest/TVsoftKeys.jsp,v 1.2 2002/02/12 12:17:28 pduffin Exp $
 % ============================================================================
...
<vt:p>
	filename: TVsoftKeys.jsp<vt:br/>
	purpose: soft keys, key mappings<vt:br/>
	devices: Sky, Bush, Lib, Net<vt:br/>
	layout: iDTV1<vt:br/>
	theme: iDTV<vt:br/>
</vt:p>
