...
-->
<%
// The following code is used to validate tag attributes.
// Make sure that you free the connection in your code.
 String msg = null;
	...
	if (tag == null || UI == null || helptext == null
    ...
    if  (new StringTokenizer(tag).countTokens() > 1 ) {
		msg = "Error - tag name must be only one word";
    } 
