...
<vt:pane name="fileinfo">
  <vt:h1>Image Asset Fallback Test</vt:h1>
  <vt:p>Filename: tt_image1.jsp<vt:br/>
...
<vt:pane name="header">
  <vt:h3>Purpose</vt:h3>
  <vt:p>To confirm that the img 
	tag will display an image asset or the appropriate fallback asset.
...
<vt:pane name="test">
  <vt:p>
    ...
    <vt:img src="tt_masterimage" altText="The alt text"/>
  </vt:p>
  <vt:p>
    2. Valid image component with valid asset, 
    but the image file doesn't exist (expect ALT):
    <vt:img src="tt_imgcompwinvalidasset" altText="The alt text"/>
  </vt:p>
  <vt:p>
    3. Valid image component with no image assets (expect ALT)
    <vt:img src="tt_imgcompwnoassets" altText="The alt text"/>
  </vt:p>
  <vt:p>
    4. Valid image component with no image assets, 
    but valid image fallback (expect fallback IMG):
    <vt:img src="tt_imgcompwimgfallback" altText="The alt text"/>
  </vt:p>
  <vt:p>
    5. Valid image component with no valid image asset, or alt text,
    but valid text fallback (expect fallback TXT):
    <vt:img src="tt_imgcompwtextfallback"/>
  </vt:p>
  <vt:p>
    6. Image component that doesn't exist (expect ALT):
    <vt:img src="thisimagedoesnotexist" altText="The alt text"/>
  </vt:p>
</vt:pane>
