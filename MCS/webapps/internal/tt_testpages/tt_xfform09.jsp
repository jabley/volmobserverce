...
<vt:pane name="fileinfo">
  <vt:h1>Radio / Checkbox Horiz Theme Test</vt:h1>
  <vt:p>Filename: tt_xfform09.jsp<vt:br/>
...
<vt:pane name="header">
  <vt:h3>Purpose</vt:h3>
  <vt:p>This test is to ensure radio buttons and
	checkbox fields can be set to horizontal orientation and altered theme fonts.
  </vt:p>
<vt:pre>
     xfform       name, action, prompt
     xfsiselect   name, caption, captionPane, entryPane, help, prompt, (style radioformat)
     xfmuselect   name, caption, captionPane, entryPane, help, prompt, (style checkboxformat)
  ...
  <vt:p>The Drinks field should be presented as radio buttons. 
	...
	The options should appear horizontal in altered fonts.
  </vt:p>
...
<vt:xfmuselect
	styleClass="checkboxformathoriz"
        name="papers"
