...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Scripts Index Page">
...
<vt:tr>
 ...
 <vt:pane name="menu2">
	<vt:a href="tt_script1.jsp" styleClass="menu2">Script Element Test 1</vt:a><vt:br/>
	<vt:a href="tt_events1.jsp" styleClass="menu2">Primary Event Handlers</vt:a><vt:br/>
	<vt:a href="tt_events2.jsp" styleClass="menu2">Form Event Handlers</vt:a><vt:br/>
	<vt:a href="tt_events3.jsp" styleClass="menu2">Text Format Event Handlers</vt:a><vt:br/>

	<vt:a href="tt_events4.jsp" styleClass="menu2">Table Event Handlers</vt:a><vt:br/>
	<vt:a href="tt_events5.jsp" styleClass="menu2">Menu/List/Def Event Handlers</vt:a><vt:br/>
	<vt:a href="tt_events6.jsp" styleClass="menu2">Image/Dynvis Event Handlers</vt:a><vt:br/>
...
<vt:pane name="main">
<vt:p>
This section tests use of scripts and event handlers.
</vt:p>
</vt:pane>
