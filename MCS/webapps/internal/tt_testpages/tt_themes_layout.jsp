...
<vt:canvas layoutName="standard" theme="standard" pageTitle="Themes: Layout">
...
<vt:pane name="info">
<vt:p>
	Filename: tt_themes_layout.jsp <vt:br/>
...
<vt:pane name="main">
<vt:p>
This is the 'Layout' Index page.
It contains links to test pages that cover the theme properties that are in the 'Layout' tab in style properties window in the GUI. Properties are:<vt:br/>
- Fragment List Orientation<vt:br/>
- Fragment List Position<vt:br/>
- Link Media<vt:br/>
- Link Style<vt:br/>
- Menu Orientation<vt:br/>
</vt:p>
