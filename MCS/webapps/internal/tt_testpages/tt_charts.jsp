...
<vt:td styleClass="menu1"><vt:a href="tt_layouts.jsp" styleClass="menu1">LAYOUTS</vt:a></vt:td>
	...
	<vt:td styleClass="menu1"><vt:a href="tt_tags.jsp" styleClass="menu1">TAGS</vt:a></vt:td>
...
<vt:pane name="main">
<vt:p>
This section tests charts (only one page at the mo, could be overkill).
</vt:p>
</vt:pane>
