...
<vt:pane name="header">
  <vt:h3>Purpose</vt:h3>
  <vt:p>This test is to ensure the vt:hr tag works.</vt:p>
  <vt:pre>
     hr
  </vt:pre>
  <vt:h3>Devices</vt:h3>
...
<vt:pane name="test">
  ...
  <vt:p>About to test vt:hr inside vt:p tags. About to test vt:hr inside vt:p tags. About to test vt:hr inside vt:p tags. About to test vt:hr inside vt:p tags. About to test vt:hr inside vt:p tags. Should be a line below this text.
