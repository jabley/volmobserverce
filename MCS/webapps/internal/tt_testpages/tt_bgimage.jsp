...
<vt:canvas theme="tt_bgimage" layoutName="standard" pageTitle="Themes: background" >

<vt:pane name="main2">
<vt:p>
filename: tt_bgimage.jsp<vt:br/>
theme: tt_bgimage<vt:br/>
...
Test:<vt:br/>
canvas{background:right top fixed stars no-repeat #ccf}<vt:br/>
.background1{background-image:stars}<vt:br/>
.background2{background-image:blue_button}<vt:br/>
<vt:br/>
...
Div<vt:br/>
<vt:div styleClass="background1">
This div tag has styleClass="background1" 
